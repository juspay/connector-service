...
let config = ConnectorConfig {
    connector_config: Some(ConnectorSpecificConfig {
        config: Some(connector_specific_config::Config::Redsys(RedsysConfig {
                ...
                terminal_id: Some(Secret::new("YOUR_TERMINAL_ID".to_string())),
                sha256_pwd: Some(Secret::new("YOUR_SHA256_PWD".to_string())),
            ..Default::default()
        })),
    }),
...
**Examples:** [Python](../../examples/redsys/python/redsys.py) · [JavaScript](../../examples/redsys/javascript/redsys.ts) · [Kotlin](../../examples/redsys/kotlin/redsys.kt) · [Rust](../../examples/redsys/rust/redsys.rs#L52)
