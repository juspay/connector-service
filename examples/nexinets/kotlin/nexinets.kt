...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "refund" -> refund(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processCheckoutWallet, processRefund, processGetPayment, authorize, get, proxyAuthorize, refund")
    }
}
