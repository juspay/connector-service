...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutCard, processCheckoutAutocapture, processRefund, processRecurring, processVoidPayment, processGetPayment, authorize, capture, get, recurringCharge, refund, setupRecurring, void")
    }
}
