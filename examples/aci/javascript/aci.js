...
// Run a scenario:  node aci.js checkout_card
'use strict';
...
// _defaultConfig.auth = { aci: { apiKey: { value: 'YOUR_API_KEY' } } };
...
module.exports = { processCheckoutCard, processCheckoutAutocapture, processRefund, processRecurring, processVoidPayment, processGetPayment, authorize, capture, get, recurringCharge, setupRecurring, voidPayment };
