...
//     noon: { apiKey: { value: 'YOUR_API_KEY' } }
// };
...
function _buildProxySetupRecurringRequest(): PaymentServiceProxySetupRecurringRequest {
    return {
        ...
        "metadata": {"value": "{\"order_category\":\"mobile\",\"description\":\"purchase desc\"}"},
        "customerAcceptance": {
...
export {
    processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, processGetPayment, authorize, capture, createOrder, get, handleEvent, proxyAuthorize, proxySetupRecurring, recurringCharge, recurringRevoke, refund, refundGet, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildCreateOrderRequest, _buildGetRequest, _buildHandleEventRequest, _buildProxyAuthorizeRequest, _buildProxySetupRecurringRequest, _buildRecurringChargeRequest, _buildRecurringRevokeRequest, _buildRefundRequest, _buildRefundGetRequest, _buildVoidRequest
};
