...
async function recurringRevoke(merchantTransactionId: string, config: ConnectorConfig = _defaultConfig): Promise<any> {
...
export {
    processCheckoutAutocapture, processCheckoutCard, processRefund, processVoidPayment, processGetPayment, authorize, capture, get, handleEvent, proxyAuthorize, proxySetupRecurring, recurringCharge, recurringRevoke, refund, refundGet, voidPayment
};
