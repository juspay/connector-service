...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "get" -> get(txnId)
        "refund" -> refund(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutCard, processCheckoutAutocapture, processRefund, processGetPayment, authorize, capture, create_order, get, refund")
    }
}
