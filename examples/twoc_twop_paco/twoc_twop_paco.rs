...
// Run a scenario:  cargo run --example twoc_twop_paco -- process_checkout_card
...
#[allow(dead_code)]
pub const SUPPORTED_FLOWS: &[&str] = &["authorize", "get", "capture", "void", "reverse", "refund", "refund_get", "post_authenticate"];
...
pub fn build_authorize_request(capture_method: &str) -> PaymentServiceAuthorizeRequest {
    PaymentServiceAuthorizeRequest {
        ...
        amount: Some(Money {  // The amount for the payment.
            ...
            currency: Currency::Php.into(),  // ISO 4217 currency code (e.g., "USD", "EUR").
        }),
        payment_method: Some(PaymentMethod {  // Payment method to be used.
            payment_method: Some(payment_method::PaymentMethod::Card(CardDetails {
                ...
                card_exp_year: Some(Secret::new("2027".to_string())),
                card_cvc: Some(Secret::new("123".to_string())),
                card_holder_name: Some(Secret::new("Test Customer".to_string())),  // Cardholder Information.
        ...
        address: Some(PaymentAddress {  // Address Information.
            billing_address: Some(Address {
                country_alpha2_code: Some(CountryAlpha2::Ph.into()),
                ..Default::default()
            }),
            ..Default::default()
        }),
...
pub fn build_refund_request(connector_transaction_id: &str) -> PaymentServiceRefundRequest {
    PaymentServiceRefundRequest {
        ...
        reason: Some("customer request".to_string()),  // Reason for the refund.
        refund_metadata: Some(Secret::new("{\"original_order_no\":\"probe_txn_001\"}".to_string())),  // Metadata specific to the refund.
        ..Default::default()
    }
}
...
async fn main() {
    ...
    let result: Result<String, Box<dyn std::error::Error>> = match flow.as_str() {
        ...
        _ => { eprintln!("Unknown flow: {}. Available: process_checkout_autocapture, process_checkout_card, process_refund, process_authorize, process_get, process_capture, process_void, process_reverse, process_refund_get, process_post_authenticate", flow); return; }
    };
    match result {
        Ok(msg) => println!("✓ {msg}"),
        Err(e) => eprintln!("✗ {e}"),
