...
// _defaultConfig.auth = { cybersource: { apiKey: { value: 'YOUR_API_KEY' } } };
...
module.exports = { processCheckoutCard, processCheckoutAutocapture, processCheckoutWallet, processRefund, processRecurring, processVoidPayment, processGetPayment, authorize, capture, get, recurringCharge, setupRecurring, voidPayment };
