...
// Run a scenario:  node cybersource.js checkout_card
'use strict';

const { PaymentClient, RecurringPaymentClient, PaymentMethodAuthenticationClient } = require('hyperswitch-prism');
...
//     cybersource: { apiKey: { value: 'YOUR_API_KEY' } }
// });
...
function _buildPreAuthenticateRequest() {
    return {
        "amount": {  // Amount Information
            "minorAmount": 1000,  // Amount in minor units (e.g., 1000 = $10.00)
            "currency": "USD"  // ISO 4217 currency code (e.g., "USD", "EUR")
...
function _buildSetupRecurringRequest() {
    return {
        ...
        "metadata": {"value": "{\"reference_id\":\"probe_ref_001\",\"connector_request_id\":\"probe_req_001\",\"transaction_id\":\"probe_txn_001\"}"},  // Additional metadata for the connector
...
async function preAuthenticate(merchantTransactionId, config = _defaultConfig) {
...
module.exports = { processCheckoutCard, processCheckoutAutocapture, processCheckoutWallet, processRefund, processRecurring, processVoidPayment, processGetPayment, authorize, capture, get, preAuthenticate, proxyAuthorize, recurringCharge, refund, setupRecurring, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildGetRequest, _buildPreAuthenticateRequest, _buildRecurringChargeRequest, _buildRefundRequest, _buildSetupRecurringRequest, _buildVoidRequest };
