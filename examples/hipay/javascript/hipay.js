...
async function tokenAuthorize(merchantTransactionId, config = _defaultConfig) {
...
module.exports = { processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, processTokenize, authorize, capture, get, proxyAuthorize, refund, tokenAuthorize, tokenize, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildGetRequest, _buildRefundRequest, _buildTokenizeRequest, _buildVoidRequest };
