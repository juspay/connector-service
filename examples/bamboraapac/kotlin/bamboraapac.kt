...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutCard, processCheckoutAutocapture, processRefund, processRecurring, processGetPayment, authorize, capture, get, recurringCharge, refund, setupRecurring")
    }
}
