...
async function setupRecurring(merchantTransactionId) {
    ...
    return { status: setupResponse.status, mandateId: setupResponse.connector_transaction_id };
}

setupRecurring("order_001").catch(console.error);
