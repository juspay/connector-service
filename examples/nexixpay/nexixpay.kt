...
val SUPPORTED_FLOWS = listOf<String>("capture", "get", "pre_authenticate", "refund", "refund_get", "reverse", "void")
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: capture, get, preAuthenticate, refund, refundGet, reverse, void")
    }
}
