...
private fun buildAuthorizeRequest(captureMethodStr: String): PaymentServiceAuthorizeRequest {
    return PaymentServiceAuthorizeRequest.newBuilder().apply {
        ...
        authType = AuthenticationType.THREE_DS  // Authentication Details
        authenticationDataBuilder.apply {
            ...
            threedsServerTransactionId = "probe_3ds_txn_id"  // 3DS Server Transaction ID.
            messageVersion = "2.1.0"  // 3DS Message Version (e.g., "2.1.0", "2.2.0").
            dsTransactionId = "probe_ds_txn_id"  // Directory Server Transaction ID (DS Trans ID).
            acsTransactionId = "probe_acs_txn_id"  // ACS Transaction ID (ACS Trans ID).
            connectorTransactionId = "probe_connector_txn_id"  // Transaction identifier generated by the 3DS system.
        }
    }.build()
}
...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "refund" -> refund(txnId)
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutCard, processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, capture, get, preAuthenticate, refund, void")
    }
}
