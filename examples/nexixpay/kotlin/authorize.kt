...
fun main() {
    ...
    val request = PaymentServiceAuthorizeRequest.newBuilder().apply {
        ...
        authTypeBuilder.value = "THREE_DS"  // Authentication Details
        authenticationDataBuilder.apply {
            eciBuilder.value = "05"  // Electronic Commerce Indicator (ECI) from 3DS.
            cavvBuilder.value = "AAAAAA=="  // Cardholder Authentication Verification Value (CAVV).
            threedsServerTransactionIdBuilder.value = "probe_3ds_txn_id"  // 3DS Server Transaction ID.
            messageVersionBuilder.value = "2.1.0"  // 3DS Message Version (e.g., "2.1.0", "2.2.0").
            dsTransactionIdBuilder.value = "probe_ds_txn_id"  // Directory Server Transaction ID (DS Trans ID).
            acsTransactionIdBuilder.value = "probe_acs_txn_id"  // ACS Transaction ID (ACS Trans ID).
            connectorTransactionIdBuilder.value = "probe_connector_txn_id"  // Transaction identifier generated by the 3DS system.
        }
