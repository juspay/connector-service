...
async fn main() {
    ...
    auth_type: Some("THREE_DS".to_string()),  // Authentication Details
    authentication_data: Some(AuthenticationData {
        eci: Some("05".to_string()),  // Electronic Commerce Indicator (ECI) from 3DS.
        cavv: Some("AAAAAA==".to_string()),  // Cardholder Authentication Verification Value (CAVV).
        threeds_server_transaction_id: Some("probe_3ds_txn_id".to_string()),  // 3DS Server Transaction ID.
        message_version: Some("2.1.0".to_string()),  // 3DS Message Version (e.g., "2.1.0", "2.2.0").
        ds_transaction_id: Some("probe_ds_txn_id".to_string()),  // Directory Server Transaction ID (DS Trans ID).
        acs_transaction_id: Some("probe_acs_txn_id".to_string()),  // ACS Transaction ID (ACS Trans ID).
        connector_transaction_id: Some("probe_connector_txn_id".to_string()),  // Transaction identifier generated by the 3DS system.
        ..Default::default()
    }),
