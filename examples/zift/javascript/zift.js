...
// Run a scenario:  node zift.js checkout_card
'use strict';
...
// _defaultConfig.auth = { zift: { apiKey: { value: 'YOUR_API_KEY' } } };
...
module.exports = { processCheckoutAutocapture, processRefund, authorize, setupRecurring };
