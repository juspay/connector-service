...
fun processCheckoutCard(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result2 = directPaymentClient.capture(PaymentServiceCaptureRequest.newBuilder().setMerchantCaptureId("probe_capture_001").setConnectorTransactionId("12345").setAmountToCapture(Money.newBuilder().setMinorAmount(1000).setCurrency(Currency.USD).build()).build())
...
fun processRefund(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result2 = directPaymentClient.refund(PaymentServiceRefundRequest.newBuilder().setMerchantRefundId("probe_refund_001").setConnectorTransactionId("12345").setPaymentAmount(1000).setRefundAmount(Money.newBuilder().setMinorAmount(1000).setCurrency(Currency.USD).build()).setReason("customer_request").build())
...
fun processVoidPayment(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result2 = directPaymentClient.void(PaymentServiceVoidRequest.newBuilder().setMerchantVoidId("probe_void_001").setConnectorTransactionId("12345").build())
...
fun processGetPayment(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result2 = directPaymentClient.get(PaymentServiceGetRequest.newBuilder().setMerchantTransactionId("probe_merchant_txn_001").setConnectorTransactionId("12345").setAmount(Money.newBuilder().setMinorAmount(1000).setCurrency(Currency.USD).build()).build())
...
fun capture(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result = directPaymentClient.capture(PaymentServiceCaptureRequest.newBuilder().setMerchantCaptureId("probe_capture_001").setConnectorTransactionId("12345").setAmountToCapture(Money.newBuilder().setMinorAmount(1000).setCurrency(Currency.USD).build()).build())
    return mapOf("status" to "ok")
}
fun get(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result = directPaymentClient.get(PaymentServiceGetRequest.newBuilder().setMerchantTransactionId("probe_merchant_txn_001").setConnectorTransactionId("12345").setAmount(Money.newBuilder().setMinorAmount(1000).setCurrency(Currency.USD).build()).build())
    return mapOf("status" to "ok")
}
fun refund(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result = directPaymentClient.refund(PaymentServiceRefundRequest.newBuilder().setMerchantRefundId("probe_refund_001").setConnectorTransactionId("12345").setPaymentAmount(1000).setRefundAmount(Money.newBuilder().setMinorAmount(1000).setCurrency(Currency.USD).build()).setReason("customer_request").build())
    return mapOf("status" to "ok")
}
...
fun void(txnId: String, config: ConnectorConfig): Map<String, Any?> {
    ...
    val result = directPaymentClient.void(PaymentServiceVoidRequest.newBuilder().setMerchantVoidId("probe_void_001").setConnectorTransactionId("12345").build())
    return mapOf("status" to "ok")
}