...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, authorize, refund, setup_recurring")
    }
}
