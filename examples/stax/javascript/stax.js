...
// Run a scenario:  node stax.js checkout_card
'use strict';
...
// _defaultConfig.auth = { stax: { apiKey: { value: 'YOUR_API_KEY' } } };
...
module.exports = { processCheckoutCard, processCheckoutAutocapture, processCheckoutBank, processRefund, processVoidPayment, processGetPayment, processCreateCustomer, processTokenize, authorize, capture, get, voidPayment };
