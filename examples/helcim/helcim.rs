...
fn build_client() -> ConnectorClient {
    // Set connector_config to authenticate: use ConnectorSpecificConfig with your HelcimConfig
...
pub fn build_capture_request(connector_transaction_id: &str) -> PaymentServiceCaptureRequest {
    PaymentServiceCaptureRequest {
        ...
        browser_info: Some(BrowserInformation {  // Browser Information.
...
pub fn build_refund_request(connector_transaction_id: &str) -> PaymentServiceRefundRequest {
    PaymentServiceRefundRequest {
        ...
        browser_info: Some(BrowserInformation {  // Browser information, if relevant.
            ip_address: Some("1.2.3.4".to_string()),  // Device Information.
            ..Default::default()
        }),
        ..Default::default()
