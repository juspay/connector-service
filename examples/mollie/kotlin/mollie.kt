...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "refund" -> refund(txnId)
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processRefund, processVoidPayment, processGetPayment, authorize, get, refund, void")
    }
}
