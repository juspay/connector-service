...
// Regenerate: python3 scripts/generate-connector-docs.py dummy
//
// Dummy — all scenarios and flows in one file.
// Run a scenario:  ./gradlew run --args="dummy processCheckoutCard"
...
val SUPPORTED_FLOWS = listOf<String>("authorize", "capture", "create_client_authentication_token", "create_customer", "get", "incremental_authorization", "parse_event", "proxy_authorize", "proxy_setup_recurring", "recurring_charge", "refund", "refund_get", "setup_recurring", "token_authorize", "tokenize", "void")

val _defaultConfig: ConnectorConfig = ConnectorConfig.newBuilder()
    .setOptions(SdkOptions.newBuilder().setEnvironment(Environment.SANDBOX).build())
    // .setConnectorConfig(...) — set your Dummy credentials here
    .build()
...
fun handleEvent(txnId: String, config: ConnectorConfig = _defaultConfig) {
    ...
    val request = EventServiceHandleRequest.newBuilder().apply {
        ...
        requestDetailsBuilder.apply {
            ...
            body = com.google.protobuf.ByteString.copyFromUtf8("{\"event\":\"payment_succeeded\",\"payment_id\":\"DUMMY-probe-001\",\"merchant_reference_id\":\"probe-ref-001\"}")  // Body of the HTTP request.
        }
    }.build()
