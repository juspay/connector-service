...
use grpc_api_types::payments::{Connector, ConnectorConfig, Environment, PaymentMethodServiceTokenizeRequest};
...
async fn main() {
    ...
    let response = client.tokenize(request).await.unwrap();
