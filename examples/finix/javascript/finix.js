...
// Run a scenario:  node finix.js checkout_card
'use strict';

const { PaymentClient, CustomerClient, PaymentMethodClient } = require('hyperswitch-prism');
...
//     finix: { apiKey: { value: 'YOUR_API_KEY' } }
// });
...
module.exports = { processCheckoutCard, processCheckoutAutocapture, processCheckoutWallet, processCheckoutBank, processRefund, processVoidPayment, processGetPayment, processCreateCustomer, processTokenize, authorize, capture, createCustomer, get, refund, tokenize, voidPayment, _buildAuthorizeRequest, _buildCaptureRequest, _buildCreateCustomerRequest, _buildGetRequest, _buildRefundRequest, _buildTokenizeRequest, _buildVoidRequest };
