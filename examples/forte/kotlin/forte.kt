...
fun main(args: Array<String>) {
    ...
    when (flow) {
        ...
        "get" -> get(txnId)
        "void" -> void(txnId)
        else -> System.err.println("Unknown flow: $flow. Available: processCheckoutAutocapture, processCheckoutBank, processVoidPayment, processGetPayment, authorize, get, void")
    }
}
