...
- read the referenced family reviewer prompt in `pr-reviewer/reviewers/`
- read the companion files required by the classifier
- return structured findings only

The family reviewers in `pr-reviewer/reviewers/` remain reusable deep-dive lenses. The scenario subagents in this folder are the primary dispatch targets.
