...
- `pr-reviewer/subagents/README.md`
...
Use `pr-reviewer/prompts/classifier.md` to determine:
...
Spawn one subagent per matched scenario using the subagent prompt listed in `pr-reviewer/config/path-rules.yaml`.

The preferred dispatch unit is the scenario subagent in `pr-reviewer/subagents/`. The family reviewers in `pr-reviewer/reviewers/` are fallback deep-dive lenses when a scenario lacks a dedicated subagent or when the PR needs extra escalation.
...
- `pr-reviewer/subagents/connector-new-integration.md`
- `pr-reviewer/subagents/connector-flow-addition.md`
- `pr-reviewer/subagents/connector-payment-method-addition.md`
- `pr-reviewer/subagents/connector-bugfix-webhook.md`
- `pr-reviewer/subagents/connector-shared-plumbing.md`
- `pr-reviewer/subagents/core-flow-framework.md`
- `pr-reviewer/subagents/proto-api-contract.md`
- `pr-reviewer/subagents/server-composite.md`
- `pr-reviewer/subagents/sdk-ffi-codegen.md`
- `pr-reviewer/subagents/tests-specs-docs.md`
- `pr-reviewer/subagents/ci-config-security.md`
- `pr-reviewer/subagents/grace-tooling.md`
- `pr-reviewer/subagents/grace-generated-pr.md`

If subagents are unavailable, run the same reviewer prompts serially yourself.

### Phase 4: Aggregate findings

Use `pr-reviewer/prompts/aggregator.md`.
...
- follow `pr-reviewer/config/output-template.md`
