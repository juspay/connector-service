...
## [2025-01-XX] - TPSL Connector Addition
...
- `src/types.rs` - Added connector to factory
- `backend/domain_types/src/connector_types.rs` - Added to ConnectorEnum
- `backend/grpc-api-types/proto/payment.proto` - Added TPSL to proto enum
...
- Supports UPI payment flows with dynamic request/response handling
