...
class CustomerClient(
    ...
    defaults: ConfigOptions = ConfigOptions.getDefaultInstance(),
    libPath: String? = null
    ...
    fun create(request: CustomerServiceCreateRequest, metadata: Map<String, String>, options: ConfigOptions? = null): CustomerServiceCreateResponse =
...
class EventClient(
    ...
    fun handle_event(request: EventServiceHandleRequest, metadata: Map<String, String>, options: ConfigOptions? = null): EventServiceHandleResponse =
...
class MerchantAuthenticationClient(
    ...
    fun create_access_token(request: MerchantAuthenticationServiceCreateAccessTokenRequest, metadata: Map<String, String>, options: ConfigOptions? = null): MerchantAuthenticationServiceCreateAccessTokenResponse =
    ...
    fun create_session_token(request: MerchantAuthenticationServiceCreateSessionTokenRequest, metadata: Map<String, String>, options: ConfigOptions? = null): MerchantAuthenticationServiceCreateSessionTokenResponse =
...
class PaymentMethodAuthenticationClient(
    ...
    fun authenticate(request: PaymentMethodAuthenticationServiceAuthenticateRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentMethodAuthenticationServiceAuthenticateResponse =
    ...
    fun post_authenticate(request: PaymentMethodAuthenticationServicePostAuthenticateRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentMethodAuthenticationServicePostAuthenticateResponse =
    ...
    fun pre_authenticate(request: PaymentMethodAuthenticationServicePreAuthenticateRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentMethodAuthenticationServicePreAuthenticateResponse =
...
class PaymentMethodClient(
    ...
    fun tokenize(request: PaymentMethodServiceTokenizeRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentMethodServiceTokenizeResponse =
...
class PaymentClient(
    ...
    fun authorize(request: PaymentServiceAuthorizeRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceAuthorizeResponse =
    ...
    fun capture(request: PaymentServiceCaptureRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceCaptureResponse =
    ...
    fun create_order(request: PaymentServiceCreateOrderRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceCreateOrderResponse =
    ...
    fun get(request: PaymentServiceGetRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceGetResponse =
    ...
    fun refund(request: PaymentServiceRefundRequest, metadata: Map<String, String>, options: ConfigOptions? = null): RefundResponse =
    ...
    fun reverse(request: PaymentServiceReverseRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceReverseResponse =
    ...
    fun setup_recurring(request: PaymentServiceSetupRecurringRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceSetupRecurringResponse =
    ...
    fun void(request: PaymentServiceVoidRequest, metadata: Map<String, String>, options: ConfigOptions? = null): PaymentServiceVoidResponse =
...
class RecurringPaymentClient(
    ...
    fun charge(request: RecurringPaymentServiceChargeRequest, metadata: Map<String, String>, options: ConfigOptions? = null): RecurringPaymentServiceChargeResponse =
