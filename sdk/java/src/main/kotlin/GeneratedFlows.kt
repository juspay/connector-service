...
object FlowRegistry {
    val reqTransformers: Map<String, (ByteArray, ByteArray) -> ByteArray> = mapOf(
        "accept" to { requestBytes, optionsBytes -> acceptReqTransformer(requestBytes, optionsBytes) },
        "authenticate" to { requestBytes, optionsBytes -> authenticateReqTransformer(requestBytes, optionsBytes) },
        "authorize" to { requestBytes, optionsBytes -> authorizeReqTransformer(requestBytes, optionsBytes) },
        "capture" to { requestBytes, optionsBytes -> captureReqTransformer(requestBytes, optionsBytes) },
        "charge" to { requestBytes, optionsBytes -> chargeReqTransformer(requestBytes, optionsBytes) },
        "create" to { requestBytes, optionsBytes -> createReqTransformer(requestBytes, optionsBytes) },
        "create_access_token" to { requestBytes, optionsBytes -> createAccessTokenReqTransformer(requestBytes, optionsBytes) },
        "create_order" to { requestBytes, optionsBytes -> createOrderReqTransformer(requestBytes, optionsBytes) },
        "create_session_token" to { requestBytes, optionsBytes -> createSessionTokenReqTransformer(requestBytes, optionsBytes) },
        "defend" to { requestBytes, optionsBytes -> defendReqTransformer(requestBytes, optionsBytes) },
        "get" to { requestBytes, optionsBytes -> getReqTransformer(requestBytes, optionsBytes) },
        "post_authenticate" to { requestBytes, optionsBytes -> postAuthenticateReqTransformer(requestBytes, optionsBytes) },
        "pre_authenticate" to { requestBytes, optionsBytes -> preAuthenticateReqTransformer(requestBytes, optionsBytes) },
        "refund" to { requestBytes, optionsBytes -> refundReqTransformer(requestBytes, optionsBytes) },
        "reverse" to { requestBytes, optionsBytes -> reverseReqTransformer(requestBytes, optionsBytes) },
        "setup_recurring" to { requestBytes, optionsBytes -> setupRecurringReqTransformer(requestBytes, optionsBytes) },
        "submit_evidence" to { requestBytes, optionsBytes -> submitEvidenceReqTransformer(requestBytes, optionsBytes) },
        "tokenize" to { requestBytes, optionsBytes -> tokenizeReqTransformer(requestBytes, optionsBytes) },
        "void" to { requestBytes, optionsBytes -> voidReqTransformer(requestBytes, optionsBytes) },
    )

    val resTransformers: Map<String, (ByteArray, ByteArray, ByteArray) -> ByteArray> = mapOf(
        "accept" to { responseBytes, requestBytes, optionsBytes -> acceptResTransformer(responseBytes, requestBytes, optionsBytes) },
        "authenticate" to { responseBytes, requestBytes, optionsBytes -> authenticateResTransformer(responseBytes, requestBytes, optionsBytes) },
        "authorize" to { responseBytes, requestBytes, optionsBytes -> authorizeResTransformer(responseBytes, requestBytes, optionsBytes) },
        "capture" to { responseBytes, requestBytes, optionsBytes -> captureResTransformer(responseBytes, requestBytes, optionsBytes) },
        "charge" to { responseBytes, requestBytes, optionsBytes -> chargeResTransformer(responseBytes, requestBytes, optionsBytes) },
        "create" to { responseBytes, requestBytes, optionsBytes -> createResTransformer(responseBytes, requestBytes, optionsBytes) },
        "create_access_token" to { responseBytes, requestBytes, optionsBytes -> createAccessTokenResTransformer(responseBytes, requestBytes, optionsBytes) },
        "create_order" to { responseBytes, requestBytes, optionsBytes -> createOrderResTransformer(responseBytes, requestBytes, optionsBytes) },
        "create_session_token" to { responseBytes, requestBytes, optionsBytes -> createSessionTokenResTransformer(responseBytes, requestBytes, optionsBytes) },
        "defend" to { responseBytes, requestBytes, optionsBytes -> defendResTransformer(responseBytes, requestBytes, optionsBytes) },
        "get" to { responseBytes, requestBytes, optionsBytes -> getResTransformer(responseBytes, requestBytes, optionsBytes) },
        "post_authenticate" to { responseBytes, requestBytes, optionsBytes -> postAuthenticateResTransformer(responseBytes, requestBytes, optionsBytes) },
        "pre_authenticate" to { responseBytes, requestBytes, optionsBytes -> preAuthenticateResTransformer(responseBytes, requestBytes, optionsBytes) },
        "refund" to { responseBytes, requestBytes, optionsBytes -> refundResTransformer(responseBytes, requestBytes, optionsBytes) },
        "reverse" to { responseBytes, requestBytes, optionsBytes -> reverseResTransformer(responseBytes, requestBytes, optionsBytes) },
        "setup_recurring" to { responseBytes, requestBytes, optionsBytes -> setupRecurringResTransformer(responseBytes, requestBytes, optionsBytes) },
        "submit_evidence" to { responseBytes, requestBytes, optionsBytes -> submitEvidenceResTransformer(responseBytes, requestBytes, optionsBytes) },
        "tokenize" to { responseBytes, requestBytes, optionsBytes -> tokenizeResTransformer(responseBytes, requestBytes, optionsBytes) },
        "void" to { responseBytes, requestBytes, optionsBytes -> voidResTransformer(responseBytes, requestBytes, optionsBytes) },
    )
    ...
    val directTransformers: Map<String, (ByteArray, ByteArray) -> ByteArray> = mapOf(
        "handle_event" to { requestBytes, optionsBytes -> handleEventTransformer(requestBytes, optionsBytes) },
    )
