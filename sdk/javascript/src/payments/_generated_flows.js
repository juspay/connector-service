...
const FLOWS = {
  ...
  proxied_authenticate      : { request: "ProxyPaymentMethodAuthenticationServiceAuthenticateRequest", response: "PaymentMethodAuthenticationServiceAuthenticateResponse" },
  ...
  proxied_authorize         : { request: "ProxyPaymentServiceAuthorizeRequest", response: "PaymentServiceAuthorizeResponse" },

  // proxied_post_authenticate: ProxiedPaymentService.PostAuthenticate — Post-authenticate via vault proxy.
  proxied_post_authenticate : { request: "ProxyPaymentMethodAuthenticationServicePostAuthenticateRequest", response: "PaymentMethodAuthenticationServicePostAuthenticateResponse" },
  ...
  proxied_pre_authenticate  : { request: "ProxyPaymentMethodAuthenticationServicePreAuthenticateRequest", response: "PaymentMethodAuthenticationServicePreAuthenticateResponse" },

  // proxied_setup_recurring: ProxiedPaymentService.SetupRecurring — Setup recurring mandate using vault-aliased card data.
  proxied_setup_recurring   : { request: "ProxyPaymentServiceSetupRecurringRequest", response: "PaymentServiceSetupRecurringResponse" },
