...
const FLOWS = {
  ...
  proxy_authenticate        : { request: "ProxyPaymentMethodAuthenticationServiceAuthenticateRequest", response: "PaymentMethodAuthenticationServiceAuthenticateResponse" },

  // proxy_authorize: ProxyPaymentService.Authorize — Authorize using vault-aliased card data. Proxy substitutes before connector.
  proxy_authorize           : { request: "ProxyPaymentServiceAuthorizeRequest", response: "PaymentServiceAuthorizeResponse" },

  // proxy_post_authenticate: ProxyPaymentService.PostAuthenticate — Post-authenticate via vault proxy.
  proxy_post_authenticate   : { request: "ProxyPaymentMethodAuthenticationServicePostAuthenticateRequest", response: "PaymentMethodAuthenticationServicePostAuthenticateResponse" },
  ...
  proxy_pre_authenticate    : { request: "ProxyPaymentMethodAuthenticationServicePreAuthenticateRequest", response: "PaymentMethodAuthenticationServicePreAuthenticateResponse" },

  // proxy_setup_recurring: ProxyPaymentService.SetupRecurring — Setup recurring mandate using vault-aliased card data.
  proxy_setup_recurring     : { request: "ProxyPaymentServiceSetupRecurringRequest", response: "PaymentServiceSetupRecurringResponse" },
