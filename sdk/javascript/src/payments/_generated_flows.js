...
const FLOWS = {
  ...
  create_sdk_session_token       : { request: "MerchantAuthenticationServiceCreateSdkSessionTokenRequest", response: "MerchantAuthenticationServiceCreateSdkSessionTokenResponse" },
