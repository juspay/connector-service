...
const _SECRET_STRING_FIELDS: Record<string, readonly string[]> = {
  ...
  StripeSessionTokenResponse: ["clientSecret"],
...
const _MSG_FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  SessionToken: { "googlePay": "GpaySessionTokenResponse", "paypal": "PaypalSessionTokenResponse", "applePay": "ApplepaySessionTokenResponse", "stripe": "StripeSessionTokenResponse" },
