...
class CustomerClient(_ConnectorClientBase):
    def create(self, request: CustomerServiceCreateRequest, options: ConfigOptions | None = ...) -> CustomerServiceCreateResponse:
...
class EventClient(_ConnectorClientBase):
    def handle_event(self, request: EventServiceHandleRequest, options: ConfigOptions | None = ...) -> EventServiceHandleResponse:
...
class MerchantAuthenticationClient(_ConnectorClientBase):
    def create_access_token(self, request: MerchantAuthenticationServiceCreateAccessTokenRequest, options: ConfigOptions | None = ...) -> MerchantAuthenticationServiceCreateAccessTokenResponse:
    ...
    def create_session_token(self, request: MerchantAuthenticationServiceCreateSessionTokenRequest, options: ConfigOptions | None = ...) -> MerchantAuthenticationServiceCreateSessionTokenResponse:
...
class PaymentMethodAuthenticationClient(_ConnectorClientBase):
    def authenticate(self, request: PaymentMethodAuthenticationServiceAuthenticateRequest, options: ConfigOptions | None = ...) -> PaymentMethodAuthenticationServiceAuthenticateResponse:
    ...
    def post_authenticate(self, request: PaymentMethodAuthenticationServicePostAuthenticateRequest, options: ConfigOptions | None = ...) -> PaymentMethodAuthenticationServicePostAuthenticateResponse:
    ...
    def pre_authenticate(self, request: PaymentMethodAuthenticationServicePreAuthenticateRequest, options: ConfigOptions | None = ...) -> PaymentMethodAuthenticationServicePreAuthenticateResponse:
...
class PaymentMethodClient(_ConnectorClientBase):
    def tokenize(self, request: PaymentMethodServiceTokenizeRequest, options: ConfigOptions | None = ...) -> PaymentMethodServiceTokenizeResponse:
...
class PaymentClient(_ConnectorClientBase):
    def authorize(self, request: PaymentServiceAuthorizeRequest, options: ConfigOptions | None = ...) -> PaymentServiceAuthorizeResponse:
    ...
    def capture(self, request: PaymentServiceCaptureRequest, options: ConfigOptions | None = ...) -> PaymentServiceCaptureResponse:
    ...
    def create_order(self, request: PaymentServiceCreateOrderRequest, options: ConfigOptions | None = ...) -> PaymentServiceCreateOrderResponse:
    ...
    def get(self, request: PaymentServiceGetRequest, options: ConfigOptions | None = ...) -> PaymentServiceGetResponse:
    ...
    def refund(self, request: PaymentServiceRefundRequest, options: ConfigOptions | None = ...) -> RefundResponse:
    ...
    def reverse(self, request: PaymentServiceReverseRequest, options: ConfigOptions | None = ...) -> PaymentServiceReverseResponse:
    ...
    def setup_recurring(self, request: PaymentServiceSetupRecurringRequest, options: ConfigOptions | None = ...) -> PaymentServiceSetupRecurringResponse:
    ...
    def void(self, request: PaymentServiceVoidRequest, options: ConfigOptions | None = ...) -> PaymentServiceVoidResponse:
...
class RecurringPaymentClient(_ConnectorClientBase):
    def charge(self, request: RecurringPaymentServiceChargeRequest, options: ConfigOptions | None = ...) -> RecurringPaymentServiceChargeResponse:
