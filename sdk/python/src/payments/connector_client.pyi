...
class CustomerClient(_ConnectorClientBase):
    def create(self, request: CustomerServiceCreateRequest, metadata: dict, options: RequestConfig | None = ...) -> CustomerServiceCreateResponse:
...
class EventClient(_ConnectorClientBase):
    def handle_event(self, request: EventServiceHandleRequest, metadata: dict, options: RequestConfig | None = ...) -> EventServiceHandleResponse:
...
class MerchantAuthenticationClient(_ConnectorClientBase):
    def create_access_token(self, request: MerchantAuthenticationServiceCreateAccessTokenRequest, metadata: dict, options: RequestConfig | None = ...) -> MerchantAuthenticationServiceCreateAccessTokenResponse:
    ...
    def create_session_token(self, request: MerchantAuthenticationServiceCreateSessionTokenRequest, metadata: dict, options: RequestConfig | None = ...) -> MerchantAuthenticationServiceCreateSessionTokenResponse:
...
class PaymentMethodAuthenticationClient(_ConnectorClientBase):
    def authenticate(self, request: PaymentMethodAuthenticationServiceAuthenticateRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentMethodAuthenticationServiceAuthenticateResponse:
    ...
    def post_authenticate(self, request: PaymentMethodAuthenticationServicePostAuthenticateRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentMethodAuthenticationServicePostAuthenticateResponse:
    ...
    def pre_authenticate(self, request: PaymentMethodAuthenticationServicePreAuthenticateRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentMethodAuthenticationServicePreAuthenticateResponse:
...
class PaymentMethodClient(_ConnectorClientBase):
    def tokenize(self, request: PaymentMethodServiceTokenizeRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentMethodServiceTokenizeResponse:
...
class PaymentClient(_ConnectorClientBase):
    def authorize(self, request: PaymentServiceAuthorizeRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceAuthorizeResponse:
    ...
    def capture(self, request: PaymentServiceCaptureRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceCaptureResponse:
    ...
    def create_order(self, request: PaymentServiceCreateOrderRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceCreateOrderResponse:
    ...
    def get(self, request: PaymentServiceGetRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceGetResponse:
    ...
    def refund(self, request: PaymentServiceRefundRequest, metadata: dict, options: RequestConfig | None = ...) -> RefundResponse:
    ...
    def reverse(self, request: PaymentServiceReverseRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceReverseResponse:
    ...
    def setup_recurring(self, request: PaymentServiceSetupRecurringRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceSetupRecurringResponse:
    ...
    def void(self, request: PaymentServiceVoidRequest, metadata: dict, options: RequestConfig | None = ...) -> PaymentServiceVoidResponse:
...
class RecurringPaymentClient(_ConnectorClientBase):
    def charge(self, request: RecurringPaymentServiceChargeRequest, metadata: dict, options: RequestConfig | None = ...) -> RecurringPaymentServiceChargeResponse:
