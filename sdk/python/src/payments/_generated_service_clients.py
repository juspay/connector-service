...
class MerchantAuthenticationClient(_ConnectorClientBase):
    ...
    def create_sdk_session_token(self, request, options=None):
        ...
        return self._execute_flow("create_sdk_session_token", request, _pb2.MerchantAuthenticationServiceCreateSdkSessionTokenResponse, options)
