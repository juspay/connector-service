...
# Create options bytes for the new FFI signature (takes ClientConfig as context)
# In high-level client, this is handled automatically. 
# For low-level FFI test, we use the raw config.
