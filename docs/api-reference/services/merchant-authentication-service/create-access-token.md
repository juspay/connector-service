...
|-------|------|----------|-------------|
| `merchant_access_token_id` | Identifier | Yes | Your unique token reference |
...
| `merchant_access_token_id` | Identifier | Your token reference (echoed back) |
...
grpcurl -H "x-connector: stripe" \
  ...
  -d '{
    "merchant_access_token_id": {"id": "token_001"},
    "connector": "STRIPE",
    "test_mode": true
  }' \
  localhost:8080 \
...
```json
{
  "access_token": {"value": "pk_test_1234567890abcdef"},
  "token_type": "Bearer",
