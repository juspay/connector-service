...
@doc-guidance
────────────────────────────────────────────────────
PAGE INTENT: IDs of the connector service request and respons ehas been modelled with a standard of entity_domain_id. Start with the problems of IDs and how LLMs can hallucinate with IDs citing examples from processors; why differnt ID stragey across payment processor confuse developers. Explain the different types of IDs in key mentods such as authorize, refund, customer. 
