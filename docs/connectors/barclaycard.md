...
config = sdk_config_pb2.ConnectorConfig(
    connector=sdk_config_pb2.Connector.BARCLAYCARD,
...
pub async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = PaymentServiceVoidRequest {
        ...
        // connector_transaction_id: todo!(),
        // cancellation_reason: todo!(),  // Void Details
        // amount: todo!(),  // Amount Information
        ..Default::default()
    };
...
<!-- TODO: Add sample payload for `authenticate` in `scripts/connector-annotations/barclaycard.yaml` -->
...
<!-- TODO: Add sample payload for `post_authenticate` in `scripts/connector-annotations/barclaycard.yaml` -->
...
<!-- TODO: Add sample payload for `pre_authenticate` in `scripts/connector-annotations/barclaycard.yaml` -->
