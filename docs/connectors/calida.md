...
<!-- TODO: Add sample payload for `authorize` in `scripts/connector-annotations/calida.yaml` -->
...
config = sdk_config_pb2.ConnectorConfig(
    connector=sdk_config_pb2.Connector.CALIDA,
...
<!-- TODO: Add sample payload for `authenticate` in `scripts/connector-annotations/calida.yaml` -->
...
<!-- TODO: Add sample payload for `post_authenticate` in `scripts/connector-annotations/calida.yaml` -->
...
<!-- TODO: Add sample payload for `pre_authenticate` in `scripts/connector-annotations/calida.yaml` -->
