...
config = sdk_config_pb2.ConnectorConfig(
    connector=sdk_config_pb2.Connector.DLOCAL,
...
<!-- TODO: Add sample payload for `authenticate` in `scripts/connector-annotations/dlocal.yaml` -->
...
<!-- TODO: Add sample payload for `post_authenticate` in `scripts/connector-annotations/dlocal.yaml` -->
...
<!-- TODO: Add sample payload for `pre_authenticate` in `scripts/connector-annotations/dlocal.yaml` -->
