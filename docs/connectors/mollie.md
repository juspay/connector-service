...
config = sdk_config_pb2.ConnectorConfig(
    connector=sdk_config_pb2.Connector.MOLLIE,
...
<!-- TODO: Add sample payload for `authenticate` in `scripts/connector-annotations/mollie.yaml` -->
...
<!-- TODO: Add sample payload for `post_authenticate` in `scripts/connector-annotations/mollie.yaml` -->
...
<!-- TODO: Add sample payload for `pre_authenticate` in `scripts/connector-annotations/mollie.yaml` -->
