...
config = sdk_config_pb2.ConnectorConfig(
    connector=sdk_config_pb2.Connector.CYBERSOURCE,
...
pub async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = PaymentServiceSetupRecurringRequest {
        ...
        // metadata: todo!(),  // Additional metadata for the connector
...
<!-- TODO: Add sample payload for `authenticate` in `scripts/connector-annotations/cybersource.yaml` -->
...
<!-- TODO: Add sample payload for `post_authenticate` in `scripts/connector-annotations/cybersource.yaml` -->
...
<!-- TODO: Add sample payload for `pre_authenticate` in `scripts/connector-annotations/cybersource.yaml` -->
