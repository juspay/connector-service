...
use grpc_api_types::payments::{
    ...
    PaymentServiceCaptureResponse, PaymentServiceCreatePaymentMethodTokenRequest,
    PaymentServiceCreatePaymentMethodTokenResponse, PaymentServiceDisputeRequest,
