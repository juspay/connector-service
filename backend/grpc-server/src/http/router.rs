...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/composite/payments/authorize", post(handlers::composite::payments::authorize))
        .route("/composite/payments/get", post(handlers::composite::payments::get))
        ...
        .route("/payments/void_post_capture", post(handlers::payments::void_post_capture))
        .route("/payments/get", post(handlers::payments::get_payment))
        .route("/payments/create_order", post(handlers::payments::create_order))
        .route("/payments/create_session_token", post(handlers::payments::create_session_token))
        .route(
        ...
        .route("/payments/register", post(handlers::payments::setup_recurring))
        // .route(
        //     "/payments/register_only",
        //     post(handlers::payments::register_only),
        // )
        .route("/payments/repeat_everything", post(handlers::payments::repeat_everything))
        .route("/payments/refund", post(handlers::payments::refund))
        // .route("/payments/dispute", post(handlers::payments::dispute))
        .route("/payments/pre_authenticate", post(handlers::payments::pre_authenticate))
        .route("/payments/authenticate", post(handlers::payments::authenticate))
        .route("/payments/post_authenticate", post(handlers::payments::post_authenticate))
        .route("/payments/create_access_token", post(handlers::payments::create_access_token))
        ...
        .route("/disputes/submit_evidence", post(handlers::disputes::submit_evidence))
        ...
        .route("/disputes/transform", post(handlers::disputes::transform_dispute))
        .with_state(state)
}
