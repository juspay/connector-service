...
use grpc_api_types::payments::{
    refund_service_server::RefundService, EventServiceHandleRequest, EventServiceHandleResponse, RefundResponse,
...
http_handler!(get_refund, RefundServiceGetRequest, RefundResponse, get, refunds_service);
