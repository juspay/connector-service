...
use domain_types::{
    connector_flow::{Authorize, PSync, CreateAccessToken},
    connector_types::{
    ...
    errors,
    payment_method_data::{
        PaymentMethodData, PaymentMethodDataTypes, BankRedirectData,
    },
...
pub type RefundsResponseRouterData<F, T> = ResponseRouterData<T, RouterDataV2<F, RefundFlowData, RefundsData, RefundsResponseData>>;
...
fn get_attempt_status(
    (item, current_status): (VoltPaymentStatus, AttemptStatus),
) -> AttemptStatus {
    match item {
...
impl<T: PaymentMethodDataTypes + std::fmt::Debug + std::marker::Sync + std::marker::Send + 'static + serde::Serialize> TryFrom<VoltRouterData<RouterDataV2<Authorize, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>, T>> for VoltPaymentsRequest {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: VoltRouterData<RouterDataV2<Authorize, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>, T>,
    ) -> Result<Self, Self::Error> {
...
impl<T: PaymentMethodDataTypes + std::fmt::Debug + std::marker::Sync + std::marker::Send + 'static + serde::Serialize> TryFrom<VoltRouterData<RouterDataV2<CreateAccessToken, PaymentFlowData, AccessTokenRequestData, AccessTokenResponseData>, T>> for VoltAuthUpdateRequest {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(item: VoltRouterData<RouterDataV2<CreateAccessToken, PaymentFlowData, AccessTokenRequestData, AccessTokenResponseData>, T>) -> Result<Self, Self::Error> {
...
impl<F, T> TryFrom<ResponseRouterData<VoltAuthUpdateResponse, RouterDataV2<F, PaymentFlowData, T, AccessTokenResponseData>>>
    for RouterDataV2<F, PaymentFlowData, T, AccessTokenResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<VoltAuthUpdateResponse, RouterDataV2<F, PaymentFlowData, T, AccessTokenResponseData>>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl<F, T> TryFrom<ResponseRouterData<VoltPaymentsResponse, RouterDataV2<F, PaymentFlowData, T, PaymentsResponseData>>>
    for RouterDataV2<F, PaymentFlowData, T, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<VoltPaymentsResponse, RouterDataV2<F, PaymentFlowData, T, PaymentsResponseData>>,
    ) -> Result<Self, Self::Error> {
    ...
    for RouterDataV2<F, PaymentFlowData, PaymentsSyncData, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<VoltPsyncResponse, Self>,
    ) -> Result<Self, Self::Error> {
...
impl<F, T> TryFrom<ResponseRouterData<VoltPaymentsResponseData, RouterDataV2<F, PaymentFlowData, T, PaymentsResponseData>>>
    for RouterDataV2<F, PaymentFlowData, T, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<VoltPaymentsResponseData, RouterDataV2<F, PaymentFlowData, T, PaymentsResponseData>>,
    ) -> Result<Self, Self::Error> {
        match item.response {
...
impl<F, T: PaymentMethodDataTypes + std::fmt::Debug + std::marker::Sync + std::marker::Send + 'static + serde::Serialize> TryFrom<VoltRouterData<RouterDataV2<F, RefundFlowData, RefundsData, RefundsResponseData>, T>> for VoltRefundRequest {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(item: VoltRouterData<RouterDataV2<F, RefundFlowData, RefundsData, RefundsResponseData>, T>) -> Result<Self, Self::Error> {
        Ok(Self {
    ...
    for RouterDataV2<F, RefundFlowData, RefundsData, RefundsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: RefundsResponseRouterData<F, RefundResponse>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
