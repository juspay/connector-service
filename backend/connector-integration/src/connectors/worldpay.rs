...
macros::macro_connector_implementation!(
    ...
    connector: Worldpay,
    curl_request: Json(WorldpayAuthorizeRequest),
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok("https://try.access.worldpay.com/payments".to_string())
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("https://try.access.worldpay.com/payments/{}", connector_transaction_id))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("https://try.access.worldpay.com/payments/{}/captures", connector_transaction_id))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("https://try.access.worldpay.com/payments/{}/refunds", connector_transaction_id))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            let connector_transaction_id = req.request.connector_transaction_id.clone();
            Ok(format!("https://try.access.worldpay.com/payments/{}/cancellations", connector_transaction_id))
        }
    }
);
...
// =============================================================================
// EMPTY CONNECTOR INTEGRATION V2 IMPLEMENTATIONS (for other flows)
// =============================================================================
