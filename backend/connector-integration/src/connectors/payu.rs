...
macros::create_all_prerequisites!(
    ...
    member_functions: {
        ...
        fn get_transaction_id(
            ...
            request.related_transaction_id.map(|id| Ok(id.to_string())).unwrap_or(Err(ConnectorError::MissingRequiredField { field_name: "related_transaction_id".to_string() }.into()))
        }
