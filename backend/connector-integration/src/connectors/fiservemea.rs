...
// Fiservemea struct will be generated by create_all_prerequisites! macro

// =============================================================================
// MACRO-BASED CONNECTOR STRUCTURE
// =============================================================================
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/ipp/payments-gateway/v2/payments", &req.resource_common_data.connectors.fiservemea.base_url))
        }
    }
);
