...
use common_utils::{
    errors::CustomResult, events, ext_traits::ByteSliceExt, types::MinorUnit,
};
use domain_types::{
    connector_flow::{
...
use transformers::{FiservemeaAuthorizeResponse, FiservemeaPaymentsRequest};
    ...
    for Fiservemea<T>
{
    ...
    fn get_auth_header(
        ...
        // Authentication is handled in get_headers for Fiservemea
