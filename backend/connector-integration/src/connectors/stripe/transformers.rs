...
use domain_types::{
    ...
    errors::{ConnectorRequestError, ConnectorResponseError, ResultRequestToResponseExt, ResultResponseToRequestExt},
...
impl TryFrom<common_enums::PaymentMethodType> for StripePaymentMethodType {
    ...
    fn try_from(value: common_enums::PaymentMethodType) -> Result<Self, Self::Error> {
        match value {
            ...
            | common_enums::PaymentMethodType::Oxxo => Err(ConnectorRequestError::NotImplemented(
            ...
            | common_enums::PaymentMethodType::Wero => Err(ConnectorRequestError::NotImplemented(
                get_unimplemented_payment_method_error_message("stripe"),
            )
            .into()),
        }
...
impl TryFrom<&BankRedirectData> for StripePaymentMethodType {
    ...
    fn try_from(bank_redirect_data: &BankRedirectData) -> Result<Self, Self::Error> {
        match bank_redirect_data {
            ...
            BankRedirectData::OnlineBankingFpx { .. } => Err(ConnectorRequestError::NotImplemented(
                get_unimplemented_payment_method_error_message("stripe"),
            )),
...
) -> Result<Option<StripePaymentMethodType>, ConnectorRequestError> {
    match wallet_data {
        ...
        WalletData::MobilePayRedirect(_) => Err(ConnectorRequestError::NotImplemented(
            get_unimplemented_payment_method_error_message("stripe"),
        )),
...
) -> Result<(Option<StripePaymentMethodType>, Option<BankDebitData>), ConnectorRequestError> {
    match bank_debit_data {
    ...
    match payment_method_data {
        ...
        PaymentMethodData::BankTransfer(bank_transfer_data) => match bank_transfer_data.deref() {
            ...
            payment_method_data::BankTransferData::Pix { .. } => Err(
                ConnectorRequestError::NotImplemented(get_unimplemented_payment_method_error_message(
                    "stripe",
                ))
                .into(),
            ),
        ...
        PaymentMethodData::Crypto(_) => Err(ConnectorRequestError::NotImplemented(
            get_unimplemented_payment_method_error_message("stripe"),
        )
        .into()),
        ...
        PaymentMethodData::Reward => Err(ConnectorRequestError::NotImplemented(
            get_unimplemented_payment_method_error_message("stripe"),
        )
        .into()),

        PaymentMethodData::Voucher(voucher_data) => match voucher_data {
            VoucherData::Boleto(_) | VoucherData::Oxxo => Err(ConnectorRequestError::NotImplemented(
                get_unimplemented_payment_method_error_message("stripe"),
            )
            .into()),
            ...
            let (payment_method_data, payment_method_type, billing_address) =
                create_stripe_payment_method(
                    ...
                    PaymentRequestDetails {
                        ...
                        billing_address: billing_address.ok_or(ConnectorRequestError::MissingRequiredField {
            ...
            .and_then(|mandate_details| {
                mandate_details
                    ...
                    .map(|customer_acceptance| {
                        Ok::<_, error_stack::Report<ConnectorRequestError>>(
    ...
    T: SplitPaymentData + GetRequestIncrementalAuthorization,
{
    ...
    fn try_from(
        ...
        let connector_metadata =
            get_connector_metadata(item.response.next_action.as_ref(), item.response.amount).into_response_err()?;
...
fn mandatory_parameters_for_sepa_bank_debit_mandates(
...
) -> Result<StripeBillingAddress, ConnectorRequestError> {
    ...
    match is_customer_initiated_mandate_payment {
        Some(true) => Ok(StripeBillingAddress {
            name: Some(billing_name.ok_or(ConnectorRequestError::MissingRequiredField {
                field_name: "billing_name",
            })?),

            email: Some(billing_email.ok_or(ConnectorRequestError::MissingRequiredField {
    ...
    fn try_from(
        ...
        if from_metadata.is_some() && item.request.split_payments.is_some() {
                        ...
                        .and_then(|m| m.transfer_account_id.clone().map(|s| s.expose()))
            {
                ...
                Err(ConnectorRequestError::MandatePaymentDataMismatch { fields: field_str })?
            }
        }
...
) -> Result<Option<StripePaymentMethodType>, error_stack::Report<ConnectorRequestError>> {
