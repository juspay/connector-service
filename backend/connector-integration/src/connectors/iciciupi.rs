...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: Void,
            request_body: transformers::IciciUpiVoidRequest,
            response_body: transformers::IciciUpiVoidResponse,
            router_data: RouterDataV2<Void, PaymentFlowData, PaymentVoidData, PaymentsResponseData>,
        ),
        (
            flow: Capture,
            request_body: transformers::IciciUpiCaptureRequest,
            response_body: transformers::IciciUpiCaptureResponse,
            router_data: RouterDataV2<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData>,
        ),
        (
            flow: Refund,
            request_body: transformers::IciciUpiRefundRequest,
            response_body: transformers::IciciUpiRefundResponse,
            router_data: RouterDataV2<Refund, RefundFlowData, RefundsData, RefundsResponseData>,
        ),
        (
            flow: RSync,
            request_body: transformers::IciciUpiRSyncRequest,
            response_body: transformers::IciciUpiRSyncResponse,
            router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>,
        ),
        (
            flow: CreateOrder,
            request_body: transformers::IciciUpiCreateOrderRequest,
            response_body: transformers::IciciUpiCreateOrderResponse,
            router_data: RouterDataV2<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse>,
        ),
        (
            flow: CreateSessionToken,
            request_body: transformers::IciciUpiSessionTokenRequest,
            response_body: transformers::IciciUpiSessionTokenResponse,
            router_data: RouterDataV2<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData>,
        ),
        (
            flow: SetupMandate,
            request_body: transformers::IciciUpiSetupMandateRequest,
            response_body: transformers::IciciUpiSetupMandateResponse,
            router_data: RouterDataV2<SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>,
        ),
        (
            flow: RepeatPayment,
            request_body: transformers::IciciUpiRepeatPaymentRequest,
            response_body: transformers::IciciUpiRepeatPaymentResponse,
            router_data: RouterDataV2<RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>,
        ),
        (
            flow: Accept,
            request_body: transformers::IciciUpiAcceptDisputeRequest,
            response_body: transformers::IciciUpiAcceptDisputeResponse,
            router_data: RouterDataV2<Accept, DisputeFlowData, AcceptDisputeData, DisputeResponseData>,
        ),
        (
            flow: SubmitEvidence,
            request_body: transformers::IciciUpiSubmitEvidenceRequest,
            response_body: transformers::IciciUpiSubmitEvidenceResponse,
            router_data: RouterDataV2<SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>,
        ),
        (
            flow: DefendDispute,
            request_body: transformers::IciciUpiDefendDisputeRequest,
            response_body: transformers::IciciUpiDefendDisputeResponse,
