...
use serde::Serialize;
use transformers::{self as iciciupi, IciciUpiPaymentsRequest, IciciUpiPaymentsResponse, IciciUpiPaymentsSyncRequest, IciciUpiPaymentsSyncResponse, IciciUpiResponseEnum};
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: Void,
            request_body: iciciupi::IciciUpiVoidRequest,
            response_body: iciciupi::IciciUpiVoidResponse,
            router_data: RouterDataV2<Void, PaymentFlowData, PaymentVoidData, PaymentsResponseData>,
        ),
        (
            flow: Capture,
            request_body: iciciupi::IciciUpiCaptureRequest,
            response_body: iciciupi::IciciUpiCaptureResponse,
            router_data: RouterDataV2<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData>,
        ),
        (
            flow: Refund,
            request_body: iciciupi::IciciUpiRefundRequest,
            response_body: iciciupi::IciciUpiRefundResponse,
            router_data: RouterDataV2<Refund, RefundFlowData, RefundsData, RefundsResponseData>,
        ),
        (
            flow: RSync,
            request_body: iciciupi::IciciUpiRSyncRequest,
            response_body: iciciupi::IciciUpiRSyncResponse,
            router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>,
        ),
        (
            flow: CreateOrder,
            request_body: iciciupi::IciciUpiCreateOrderRequest,
            response_body: iciciupi::IciciUpiCreateOrderResponse,
            router_data: RouterDataV2<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse>,
        ),
        (
            flow: CreateSessionToken,
            request_body: iciciupi::IciciUpiSessionTokenRequest,
            response_body: iciciupi::IciciUpiSessionTokenResponse,
            router_data: RouterDataV2<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData>,
        ),
        (
            flow: SetupMandate,
            request_body: iciciupi::IciciUpiSetupMandateRequest,
            response_body: iciciupi::IciciUpiSetupMandateResponse,
            router_data: RouterDataV2<SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>,
        ),
        (
            flow: RepeatPayment,
            request_body: iciciupi::IciciUpiRepeatPaymentRequest,
            response_body: iciciupi::IciciUpiRepeatPaymentResponse,
            router_data: RouterDataV2<RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>,
        ),
        (
            flow: Accept,
            request_body: iciciupi::IciciUpiAcceptDisputeRequest,
            response_body: iciciupi::IciciUpiAcceptDisputeResponse,
            router_data: RouterDataV2<Accept, DisputeFlowData, AcceptDisputeData, DisputeResponseData>,
        ),
        (
            flow: SubmitEvidence,
            request_body: iciciupi::IciciUpiSubmitEvidenceRequest,
            response_body: iciciupi::IciciUpiSubmitEvidenceResponse,
            router_data: RouterDataV2<SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>,
        ),
        (
            flow: DefendDispute,
            request_body: iciciupi::IciciUpiDefendDisputeRequest,
            response_body: iciciupi::IciciUpiDefendDisputeResponse,
