...
use serde::Serialize;
use transformers::{self as hsbcupi, HsbcUpiPaymentsRequest, HsbcUpiPaymentsResponse, HsbcUpiPaymentsSyncRequest, HsbcUpiPaymentsSyncResponse};
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::ConnectorServiceTrait<T> for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentAuthorizeV2<T> for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentSyncV2 for HsbcUpi<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentSessionToken for HsbcUpi<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentVoidV2 for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::RefundSyncV2 for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::RefundV2 for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentCapture for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::SetupMandateV2<T> for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::AcceptDispute for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::SubmitEvidenceV2 for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::DisputeDefend for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::IncomingWebhook for HsbcUpi<T>
{
    fn verify_webhook_source(
        ...
        // TODO: Implement webhook verification based on HSBC UPI requirements
        Ok(true)
    }
    ...
    fn process_payment_webhook(
        ...
        error_stack::Report<domain_types::errors::ConnectorError>,
    > {
        // TODO: Implement webhook processing based on HSBC UPI callback structure
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentOrderCreate for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::ValidationTrait for HsbcUpi<T>
{
}
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::RepeatPaymentV2 for HsbcUpi<T>
{
}
...
macros::create_all_prerequisites!(
    ...
    api: [
        (
            flow: Authorize,
            request_body: HsbcUpiPaymentsRequest,
            response_body: HsbcUpiPaymentsResponse,
...
macros::macro_connector_implementation!(
    ...
    connector: HsbcUpi,
    curl_request: Json(HsbcUpiPaymentsRequest),
    curl_response: HsbcUpiPaymentsResponse,
    flow_name: Authorize,
    ...
    other_functions: {
        fn get_headers(
            ...
            let auth_type = hsbcupi::HsbcUpiAuth::try_from(&req.connector_auth_type)?;
...
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: HsbcUpi,
    curl_request: Json(HsbcUpiPaymentsSyncRequest),
    curl_response: HsbcUpiPaymentsSyncResponse,
    flow_name: PSync,
    resource_common_data: PaymentFlowData,
    ...
    > ConnectorCommon for HsbcUpi<T>
{
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.hsbcupi.base_url.as_ref()
    }
    ...
    fn get_auth_header(
        ...
        // HSBC UPI uses custom auth in get_headers
        Ok(vec![])
    }
    ...
    fn build_error_response(
        ...
        let response: hsbcupi::HsbcUpiErrorResponse = res
            .response
            .parse_struct("HsbcUpiErrorResponse")
...
pub struct HsbcUpiVoidRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiVoidResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiCaptureRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiCaptureResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiRefundRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiRefundResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiRefundSyncRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiRefundSyncResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiCreateOrderRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiCreateOrderResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiSessionTokenRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiSessionTokenResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiSetupMandateRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiSetupMandateResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiRepeatPaymentRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiRepeatPaymentResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiAcceptDisputeRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiAcceptDisputeResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiDefendDisputeRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiDefendDisputeResponse;

#[derive(Debug, Clone, Serialize)]
pub struct HsbcUpiSubmitEvidenceRequest;
#[derive(Debug, Clone)]
pub struct HsbcUpiSubmitEvidenceResponse;
    ...
    ($flow:ty, $common_data:ty, $req:ty, $resp:ty) => {
        impl<
                T: PaymentMethodDataTypes
                    ...
                    + 'static
                    + Serialize,
            > SourceVerification<$flow, $common_data, $req, $resp> for HsbcUpi<T>
        {
            fn get_secrets(
                &self,
