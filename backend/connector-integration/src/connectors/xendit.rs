...
//marker traits
impl connector_types::PaymentSessionToken for Xendit {}
...
impl ConnectorIntegrationV2<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData> for Xendit {}
