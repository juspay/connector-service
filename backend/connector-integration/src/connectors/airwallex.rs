...
use transformers::{
    ...
    AirwallexIntentResponse, AirwallexPaymentRequest, AirwallexPaymentResponse,
...
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    connector_types::RepeatPaymentV2 for Airwallex<T>
{
}
...
macros::create_all_prerequisites!(
    ...
    api: [
        (
            ...
            response_body: AirwallexPaymentResponse,
    ...
    member_functions: {
        ...
        pub fn build_payment_headers<F, Req, Res>(
            ...
            let access_token = req
                ...
                .attach_printable("Failed to get OAuth access token for Airwallex")?;
        ...
        pub fn build_refund_headers<F, Req, Res>(
            ...
            let access_token = req
                ...
                .get_access_token()
                .change_context(errors::ConnectorError::FailedToObtainAuthType)
                .attach_printable("Failed to get OAuth access token for Airwallex refund flow")?;
...
macros::macro_connector_implementation!(
    ...
    curl_response: AirwallexPaymentResponse,
    flow_name: Authorize,
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            // Check if we have reference_id from CreateOrder (like Razorpay V2 pattern)
            if let Some(reference_id) = &req.resource_common_data.reference_id {
                // 2-step flow: confirm existing payment intent using reference_id as order_id
                Ok(format!("{}/pa/payment_intents/{}/confirm", self.connector_base_url_payments(req), reference_id))
            } else {
                // Fallback: unified flow for direct payment creation
                Ok(format!("{}/pa/payment_intents/create", self.connector_base_url_payments(req)))
            }
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/pa/payment_intents/{}", self.connector_base_url_payments(req), payment_id))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/pa/payment_intents/{}/capture", self.connector_base_url_payments(req), payment_id))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/pa/refunds/create", self.connector_base_url_refunds(req)))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/pa/refunds/{}", self.connector_base_url_refunds(req), refund_id))
        }
    }
);
    ...
    other_functions: {
        fn get_headers(
            ...
            Ok(vec![
                ...
                (
                    "x-api-key".to_string(),
                    auth.x_api_key.expose().to_string().into(),
                ),
                (
                    "x-client-id".to_string(),
                    auth.x_client_id.expose().to_string().into(),
                ),
            ])
        }
        fn get_url(
            ...
            Ok(format!("{}/authentication/login", self.connector_base_url_payments(req)))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/pa/payment_intents/{}/cancel", self.connector_base_url_payments(req), payment_id))
        }
    }
);
