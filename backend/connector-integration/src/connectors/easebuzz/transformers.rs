...
fn get_auth_credentials(
    ...
    EaseBuzzAuth::try_from(connector_auth_type).map_err(|_| errors::ConnectorError::FailedToObtainAuthType)
}
    ...
    for EaseBuzzPaymentsRequest
{
    ...
    fn try_from(
        ...
        let phone = None; // Phone number extraction not implemented
        ...
        let hash = generate_hash(
            ...
            "Payment", // productinfo
            None, // firstname
            email.as_ref().map(|e| e.peek().as_str()),
            None, // udf1
            None, // udf2
            None, // udf3
            None, // udf4
...
impl<F> TryFrom<ResponseRouterData<EaseBuzzPaymentsSyncResponse, RouterDataV2<F, PaymentFlowData, domain_types::connector_types::PaymentsSyncData, PaymentsResponseData>>>
