...
impl<
    ...
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> TryFrom<ResponseRouterData<EaseBuzzPaymentsResponse, EaseBuzzRouterData<RouterDataV2<F, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>, T>>>
    for RouterDataV2<F, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>
{
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(
        item: ResponseRouterData<EaseBuzzPaymentsResponse, EaseBuzzRouterData<RouterDataV2<F, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>, T>>,
    ) -> Result<Self, Self::Error> {
...
impl<
    ...
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> TryFrom<ResponseRouterData<EaseBuzzPaymentsSyncResponse, EaseBuzzRouterData<RouterDataV2<F, PaymentFlowData, PaymentsSyncData, PaymentsResponseData>, T>>>
    for RouterDataV2<F, PaymentFlowData, PaymentsSyncData, PaymentsResponseData>
{
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(
        item: ResponseRouterData<EaseBuzzPaymentsSyncResponse, EaseBuzzRouterData<RouterDataV2<F, PaymentFlowData, PaymentsSyncData, PaymentsResponseData>, T>>,
    ) -> Result<Self, Self::Error> {
        let ResponseRouterData {
            response,
            router_data,
