...
> connector_types::IncomingWebhook for ZaakPay<T>
{
    fn verify_webhook_source(
        ...
        // TODO: Implement webhook verification based on ZaakPay's webhook signature mechanism
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (flow: RSync, request_body: ZaakPayRefundRequest, response_body: ZaakPayRefundResponse, router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>),
