...
use domain_types::{
    connector_flow::{
        Accept, Authorize, Authenticate, CreateAccessToken, CreateConnectorCustomer, CreateOrder, CreateSessionToken, DefendDispute, PaymentMethodToken, PostAuthenticate, PreAuthenticate, PSync, RSync,
...
> SourceVerification<domain_types::connector_flow::SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData> for ZaakPay<T>
{
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
> SourceVerification<domain_types::connector_flow::RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData> for ZaakPay<T>
{
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
> SourceVerification<domain_types::connector_flow::SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData> for ZaakPay<T>
{
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::Refund, RefundFlowData, RefundsData, RefundsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::Refund, RefundFlowData, RefundsData, RefundsResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::PaymentMethodToken, PaymentFlowData, PaymentMethodTokenizationData<T>, PaymentMethodTokenResponse> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::PaymentMethodToken, PaymentFlowData, PaymentMethodTokenizationData<T>, PaymentMethodTokenResponse>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::PreAuthenticate, PaymentFlowData, PaymentsPreAuthenticateData<T>, PaymentsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::PreAuthenticate, PaymentFlowData, PaymentsPreAuthenticateData<T>, PaymentsResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::Authenticate, PaymentFlowData, PaymentsAuthenticateData<T>, PaymentsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::Authenticate, PaymentFlowData, PaymentsAuthenticateData<T>, PaymentsResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::PostAuthenticate, PaymentFlowData, PaymentsPostAuthenticateData<T>, PaymentsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::PostAuthenticate, PaymentFlowData, PaymentsPostAuthenticateData<T>, PaymentsResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::VoidPC, PaymentFlowData, PaymentsCancelPostCaptureData, PaymentsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<domain_types::connector_flow::DefendDispute, DisputeFlowData, DisputeDefendData, DisputeResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
    ...
    fn get_signature(
        &self,
        _payload: &[u8],
        _router_data: &RouterDataV2<domain_types::connector_flow::DefendDispute, DisputeFlowData, DisputeDefendData, DisputeResponseData>,
        _secrets: &[u8],
    ) -> CustomResult<Vec<u8>, errors::ConnectorError> {
        Ok(Vec::new())
    }
...
// Additional SourceVerification implementations for required flows
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<Void, PaymentFlowData, PaymentVoidData, PaymentsResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<CreateConnectorCustomer, PaymentFlowData, ConnectorCustomerData, ConnectorCustomerResponse> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<CreateAccessToken, PaymentFlowData, AccessTokenRequestData, AccessTokenResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> SourceVerification<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse> for ZaakPay<T>
{
    fn get_secrets(
        &self,
        _secrets: ConnectorSourceVerificationSecrets,
