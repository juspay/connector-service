...
> connector_types::IncomingWebhook for ZaakPay<T>
{
    fn verify_webhook_source(
        ...
        // Webhook verification not implemented for this migration
        Ok(false)
    }
    ...
    fn process_payment_webhook(
        ...
        error_stack::Report<domain_types::errors::ConnectorError>,
    > {
        // Webhook processing not implemented for this migration
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (flow: RSync, request_body: ZaakPayRSyncRequest, response_body: ZaakPayRSyncResponse, router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>),
