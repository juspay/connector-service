...
use transformers::{
    ...
    AciVoidRequest, AciRefundSyncRequest, AciPSyncResponse,
    AciVoidResponse, AciRefundSyncResponse,
};
...
// Aci struct will be generated by the create_all_prerequisites macro

// Trait implementations with generic type parameters
// Note: PaymentTokenV2 and PaymentAccessToken implementations are not required for basic connector functionality
// They would require additional ConnectorIntegrationV2 implementations for PaymentMethodToken and CreateAccessToken flows

// Required trait implementations for ConnectorServiceTrait
// Note: PaymentTokenV2 and PaymentAccessToken are not implemented for ACI
// but are required by ConnectorServiceTrait - we'll need to check if there's a way around this
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            ...
            response_body: AciPSyncResponse,
        ...
        (
            ...
            response_body: AciRefundSyncResponse,
    ...
    for Aci<T>
{
    ...
    fn build_error_response(
        ...
        println!("aci: Building error response for status code: {}", res.status_code);
        println!("aci: Raw error response body: {:?}", String::from_utf8_lossy(&res.response));
        ...
        println!("aci: Parsed error response: {:?}", response);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        fn get_headers(
            ...
            println!("aci: Building headers for Authorize request");
            let headers = self.build_headers(req)?;
            println!("aci: Headers built successfully: {:?}", headers);
            Ok(headers)
        }
        fn get_url(
            &self,
            ...
            let url = format!("{}v1/payments", self.connector_base_url_payments(req));
            println!("aci: API URL generated: {}", url);
            Ok(url)
        }
    }
);
