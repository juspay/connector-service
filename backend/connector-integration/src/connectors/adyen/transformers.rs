use domain_types::{
    connector_flow::{AcceptDispute, Authorize, Capture, Refund, Void},
    connector_types::{
        AcceptDisputeData, DisputeFlowData, DisputeResponseData, EventType, PaymentFlowData, PaymentVoidData,
