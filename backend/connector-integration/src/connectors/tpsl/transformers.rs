    ...
    fn try_from(
        ...
        let request = TPSLUPISyncRequest {
            ...
            transaction: TransactionUPITxnType {
                device_identifier: "127.0.0.1".to_string(), // TODO: Extract device identifier from request
