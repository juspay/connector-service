    ...
    fn try_from(auth_type: &ConnectorAuthType) -> Result<Self, Self::Error> {
        match auth_type {
            ConnectorAuthType::SignatureKey { api_key, key1: _, api_secret: _ } => {
                let auth_data_str = api_key.clone().expose();
...
impl From<TpslTransactionStatus> for common_enums::AttemptStatus {
    fn from(item: TpslTransactionStatus) -> Self {
        match item {
            ...
            TpslTransactionStatus::Pending => Self::AuthenticationPending,
            TpslTransactionStatus::Unknown => Self::AuthenticationPending,
        }
    }
}
    ...
    for TpslPaymentsRequest
{
    ...
    fn try_from(
        ...
        let vpa = match &item.router_data.request.payment_method_data {
            PaymentMethodData::Upi(UpiData::UpiIntent(_)) => None,
        ...
        match item.router_data.resource_common_data.payment_method {
            common_enums::PaymentMethod::Upi => {
                ...
                let transaction_payload = TpslTransactionPayload {
                    ...
                    token: auth_type.merchant_key.peek().to_string(),
                    security_token: auth_type.salt_key.peek().to_string(),
                    sub_type: "INTENT".to_string(),
                    request_type: "TXN".to_string(),
                    reference: item.router_data.resource_common_data.connector_request_reference_id.clone(),
                    merchant_initiated: "NO".to_string(),
                    tenure_id: "".to_string(),
                };
            ...
            _ => "".to_string(),
                    ...
                    vpa: vpa_clone.map(|v| v.peek().to_string()).unwrap_or_default(),
                    aadhar_no: "".to_string(),
                };
                ...
                Ok(Self {
                    ...
                    payment: TpslPaymentPayload {
                        ...
                        instruction: TpslInstructionPayload {
                            ...
                            identifier: item.router_data.resource_common_data.connector_request_reference_id.clone(),
                            reference: item.router_data.resource_common_data.connector_request_reference_id.clone(),
                            start_date_time: "2024-01-01 00:00:00".to_string(),
                            validity: "".to_string(),
                        },
                    },
    ...
    for RouterDataV2<F, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>
{
    ...
    fn try_from(
        ...
        let (status, response) = match response {
            TpslPaymentsResponse::Success(success_data) => {
                let redirection_data = get_redirect_form_data(&success_data)?;
                (
                    ...
                    Ok(PaymentsResponseData::TransactionResponse {
                        ...
                        network_txn_id: success_data.payment_method.payment_transaction.identifier.clone(),
                        connector_response_reference_id: Some(success_data.merchant_transaction_identifier),
...
fn get_redirect_form_data(
    ...
    Ok(RedirectForm::Form {
        endpoint: "upi://pay".to_string(), // This would be dynamic based on response
        method: Method::Get,
