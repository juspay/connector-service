...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: SetupMandate,
            request_body: EaseBuzzSetupMandateRequest<T>,
        ...
        (
            ...
            request_body: EaseBuzzPreAuthenticateRequest<T>,
            response_body: EaseBuzzPreAuthenticateResponse,
            router_data: RouterDataV2<PreAuthenticate, PaymentFlowData, PaymentsPreAuthenticateData<T>, PaymentsResponseData>,
        ),
        (
            flow: Authenticate,
            request_body: EaseBuzzAuthenticateRequest<T>,
        ...
        (
            ...
            request_body: EaseBuzzPostAuthenticateRequest<T>,
        ...
        (
            ...
            request_body: EaseBuzzPaymentMethodTokenRequest<T>,
    ...
    member_functions: {
        ...
        pub fn connector_base_url_refunds<'a, F, Req, Res>(
            ...
            "https://pay.easebuzz.in" // Default to production for refunds
        }
    }
);
