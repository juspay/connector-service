...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: Capture,
            request_body: easebuzz::EasebuzzCaptureRequest,
            response_body: easebuzz::EasebuzzCaptureResponse,
            router_data: RouterDataV2<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData>,
        ),
        (
            flow: Refund,
            request_body: easebuzz::EasebuzzRefundRequest,
            response_body: easebuzz::EasebuzzRefundRequestResponse,
            router_data: RouterDataV2<Refund, RefundFlowData, RefundsData, RefundsResponseData>,
        ),
        (
            flow: RSync,
            request_body: easebuzz::EasebuzzRefundSyncRequest,
            response_body: easebuzz::EasebuzzRefundSyncResponseWrapper,
            router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>,
        ),
        (
            flow: CreateOrder,
            request_body: easebuzz::EasebuzzCreateOrderRequest,
            response_body: easebuzz::EasebuzzCreateOrderResponse,
            router_data: RouterDataV2<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse>,
        ),
        (
            flow: CreateSessionToken,
            request_body: easebuzz::EasebuzzSessionTokenRequest,
            response_body: easebuzz::EasebuzzSessionTokenResponse,
            router_data: RouterDataV2<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData>,
        ),
        (
            flow: SetupMandate,
            request_body: easebuzz::EasebuzzSetupMandateRequest,
            response_body: easebuzz::EasebuzzSetupMandateResponse,
            router_data: RouterDataV2<SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>,
        ),
        (
            flow: RepeatPayment,
            request_body: easebuzz::EasebuzzRepeatPaymentRequest,
            response_body: easebuzz::EasebuzzRepeatPaymentResponse,
            router_data: RouterDataV2<RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>,
        ),
        (
            flow: Accept,
            request_body: easebuzz::EasebuzzAcceptDisputeRequest,
            response_body: easebuzz::EasebuzzAcceptDisputeResponse,
            router_data: RouterDataV2<Accept, DisputeFlowData, AcceptDisputeData, DisputeResponseData>,
        ),
        (
            flow: SubmitEvidence,
            request_body: easebuzz::EasebuzzSubmitEvidenceRequest,
            response_body: easebuzz::EasebuzzSubmitEvidenceResponse,
            router_data: RouterDataV2<SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>,
        ),
        (
            flow: DefendDispute,
            request_body: easebuzz::EasebuzzDefendDisputeRequest,
            response_body: easebuzz::EasebuzzDefendDisputeResponse,
            router_data: RouterDataV2<DefendDispute, DisputeFlowData, DisputeDefendData, DisputeResponseData>,
        ),
        (
            flow: PreAuthenticate,
            request_body: easebuzz::EasebuzzPreAuthenticateRequest,
            response_body: easebuzz::EasebuzzPreAuthenticateResponse,
            router_data: RouterDataV2<PreAuthenticate, PaymentFlowData, PaymentsPreAuthenticateData<T>, PaymentsResponseData>,
        ),
        (
            flow: Authenticate,
            request_body: easebuzz::EasebuzzAuthenticateRequest,
            response_body: easebuzz::EasebuzzAuthenticateResponse,
            router_data: RouterDataV2<Authenticate, PaymentFlowData, PaymentsAuthenticateData<T>, PaymentsResponseData>,
        ),
        (
            flow: PostAuthenticate,
            request_body: easebuzz::EasebuzzPostAuthenticateRequest,
            response_body: easebuzz::EasebuzzPostAuthenticateResponse,
        ...
        (
            ...
            request_body: easebuzz::EasebuzzCreateAccessTokenRequest,
            response_body: easebuzz::EasebuzzCreateAccessTokenResponse,
            router_data: RouterDataV2<CreateAccessToken, PaymentFlowData, AccessTokenRequestData, AccessTokenResponseData>,
        ),
        (
            flow: CreateConnectorCustomer,
            request_body: easebuzz::EasebuzzCreateConnectorCustomerRequest,
            response_body: easebuzz::EasebuzzCreateConnectorCustomerResponse,
            router_data: RouterDataV2<CreateConnectorCustomer, PaymentFlowData, ConnectorCustomerData, ConnectorCustomerResponse>,
        ),
        (
            flow: PaymentMethodToken,
            request_body: easebuzz::EasebuzzPaymentMethodTokenRequest,
            response_body: easebuzz::EasebuzzPaymentMethodTokenResponse,
...
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Easebuzz,
    curl_request: Json(easebuzz::EasebuzzPaymentsSyncRequest),
    curl_response: EasebuzzPaymentsResponse,
    flow_name: PSync,
    resource_common_data: PaymentFlowData,
