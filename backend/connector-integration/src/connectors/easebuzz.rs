...
// Required trait implementations for ConnectorServiceTrait - empty stubs
impl<
        T: PaymentMethodDataTypes
            + std::fmt::Debug
            + std::marker::Sync
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        fn get_headers(
            ...
            // Add any additional headers required by EaseBuzz
            Ok(header)
        }
        fn get_url(
            &self,
    ...
    > ConnectorCommon for EaseBuzz<T>
{
    ...
    fn get_auth_header(
        ...
        // EaseBuzz uses custom auth in the request body
        Ok(vec![])
    }
...
// Additional SourceVerification implementations for all required flows
impl_source_verification_stub!(
    Void,
    PaymentFlowData,
...
// Stub implementations for all required flows
impl<
        T: PaymentMethodDataTypes
            + std::fmt::Debug
            + std::marker::Sync
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > ConnectorIntegrationV2<Refund, domain_types::connector_types::RefundFlowData, domain_types::connector_types::RefundsData, domain_types::connector_types::RefundsResponseData>
    for EaseBuzz<T>
{
}
