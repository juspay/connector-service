...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        fn get_headers(
            ...
            if let Ok(easebuzz_auth) = transformers::EaseBuzzAuthType::try_from(auth_type) {
                header.push((
                    headers::AUTHORIZATION.to_string(),
                    format!("Bearer {}", easebuzz_auth.key.peek()).into_masked(),
                ));
            }
        ...
        fn get_url(
            ...
            Ok(format!("{}{}", base_url, constants::EaseBuzzConstants::INITIATE_PAYMENT))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            let base_url = self.connector_base_url_payments(req);
            Ok(format!("{}{}", base_url, constants::EaseBuzzConstants::TRANSACTION_SYNC))
        }
    }
);
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> ConnectorIntegrationV2<Void, PaymentFlowData, transformers::EaseBuzzVoidRequest, PaymentsResponseData>
    for EaseBuzz<T>
{
}
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> ConnectorIntegrationV2<Capture, PaymentFlowData, transformers::EaseBuzzCaptureRequest, PaymentsResponseData>
    for EaseBuzz<T>
{
}
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> ConnectorIntegrationV2<Refund, RefundFlowData, transformers::EaseBuzzRefundRequest, RefundsResponseData>
    for EaseBuzz<T>
{
}
...
impl<
    T: PaymentMethodDataTypes
        ...
        + 'static
        + Serialize,
> ConnectorIntegrationV2<RSync, RefundFlowData, transformers::EaseBuzzRefundSyncRequest, RefundsResponseData>
    for EaseBuzz<T>
{
}
...
>
    ConnectorIntegrationV2<
        PreAuthenticate,
        PaymentFlowData,
        transformers::EaseBuzzPreAuthenticateRequest,
...
>
    ConnectorIntegrationV2<
        Authenticate,
        PaymentFlowData,
        transformers::EaseBuzzAuthenticateRequest,
        PaymentsResponseData,
    > for EaseBuzz<T>
{
}
...
>
    ConnectorIntegrationV2<
        PostAuthenticate,
        PaymentFlowData,
        transformers::EaseBuzzPostAuthenticateRequest,
        PaymentsResponseData,
    > for EaseBuzz<T>
{
}
...
>
    ConnectorIntegrationV2<
        CreateOrder,
        PaymentFlowData,
        transformers::EaseBuzzCreateOrderRequest,
...
impl<
    T: PaymentMethodDataTypes
        ...
        + Serialize,
>
    ConnectorIntegrationV2<SubmitEvidence, DisputeFlowData, transformers::EaseBuzzSubmitEvidenceRequest, DisputeResponseData>
    for EaseBuzz<T>
{
}
...
impl<
    T: PaymentMethodDataTypes
        ...
        + Serialize,
>
    ConnectorIntegrationV2<DefendDispute, DisputeFlowData, transformers::EaseBuzzDefendDisputeRequest, DisputeResponseData>
    for EaseBuzz<T>
{
}
...
impl<
    T: PaymentMethodDataTypes
        ...
        + Serialize,
>
    ConnectorIntegrationV2<Accept, DisputeFlowData, transformers::EaseBuzzAcceptDisputeRequest, DisputeResponseData>
    for EaseBuzz<T>
{
}
...
>
    ConnectorIntegrationV2<
        SetupMandate,
        PaymentFlowData,
        transformers::EaseBuzzSetupMandateRequest,
        PaymentsResponseData,
    > for EaseBuzz<T>
{
}
...
impl<
    T: PaymentMethodDataTypes
        ...
        + Serialize,
>
    ConnectorIntegrationV2<RepeatPayment, PaymentFlowData, transformers::EaseBuzzRepeatPaymentRequest, PaymentsResponseData>
    for EaseBuzz<T>
{
}
...
>
    ConnectorIntegrationV2<
        CreateSessionToken,
        PaymentFlowData,
        transformers::EaseBuzzSessionTokenRequest,
...
>
    ConnectorIntegrationV2<
        CreateAccessToken,
        PaymentFlowData,
        transformers::EaseBuzzCreateAccessTokenRequest,
...
>
    ConnectorIntegrationV2<
        ...
        PaymentFlowData,
        transformers::EaseBuzzCreateConnectorCustomerRequest,
...
>
    ConnectorIntegrationV2<
        PaymentMethodToken,
        PaymentFlowData,
        transformers::EaseBuzzPaymentMethodTokenRequest,
...
impl_source_verification_stub!(Void, PaymentFlowData, transformers::EaseBuzzVoidRequest, PaymentsResponseData);
impl_source_verification_stub!(Refund, RefundFlowData, transformers::EaseBuzzRefundRequest, RefundsResponseData);
impl_source_verification_stub!(RSync, RefundFlowData, transformers::EaseBuzzRefundSyncRequest, RefundsResponseData);
impl_source_verification_stub!(
    SetupMandate,
    PaymentFlowData,
    transformers::EaseBuzzSetupMandateRequest,
...
impl_source_verification_stub!(
    RepeatPayment,
    PaymentFlowData,
    transformers::EaseBuzzRepeatPaymentRequest,
    PaymentsResponseData
);
impl_source_verification_stub!(
    Accept,
    DisputeFlowData,
    transformers::EaseBuzzAcceptDisputeRequest,
    DisputeResponseData
);
impl_source_verification_stub!(
    SubmitEvidence,
    DisputeFlowData,
    transformers::EaseBuzzSubmitEvidenceRequest,
    DisputeResponseData
);
impl_source_verification_stub!(
    DefendDispute,
    DisputeFlowData,
    transformers::EaseBuzzDefendDisputeRequest,
    DisputeResponseData
);
impl_source_verification_stub!(
    CreateOrder,
