...
use serde::Serialize;
use transformers::{self as easebuzz, EaseBuzzPaymentsRequest, EaseBuzzPaymentsResponseEnum};
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (flow: Void, request_body: transformers::EaseBuzzVoidRequest, response_body: transformers::EaseBuzzVoidResponse, router_data: RouterDataV2<Void, PaymentFlowData, PaymentVoidData, PaymentsResponseData>),
        (flow: Capture, request_body: transformers::EaseBuzzCaptureRequest, response_body: transformers::EaseBuzzCaptureResponse, router_data: RouterDataV2<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData>),
        (flow: Refund, request_body: transformers::EaseBuzzRefundRequest, response_body: transformers::EaseBuzzRefundResponse, router_data: RouterDataV2<Refund, RefundFlowData, RefundsData, RefundsResponseData>),
        (flow: RSync, request_body: transformers::EaseBuzzRSyncRequest, response_body: transformers::EaseBuzzRSyncResponse, router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>),
        (flow: CreateOrder, request_body: transformers::EaseBuzzCreateOrderRequest, response_body: transformers::EaseBuzzCreateOrderResponse, router_data: RouterDataV2<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse>),
        (flow: CreateSessionToken, request_body: transformers::EaseBuzzSessionTokenRequest, response_body: transformers::EaseBuzzSessionTokenResponse, router_data: RouterDataV2<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData>),
        (flow: SetupMandate, request_body: transformers::EaseBuzzSetupMandateRequest, response_body: transformers::EaseBuzzSetupMandateResponse, router_data: RouterDataV2<SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>),
        (flow: RepeatPayment, request_body: transformers::EaseBuzzRepeatPaymentRequest, response_body: transformers::EaseBuzzRepeatPaymentResponse, router_data: RouterDataV2<RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>),
        (flow: Accept, request_body: transformers::EaseBuzzAcceptDisputeRequest, response_body: transformers::EaseBuzzAcceptDisputeResponse, router_data: RouterDataV2<Accept, DisputeFlowData, AcceptDisputeData, DisputeResponseData>),
        (flow: SubmitEvidence, request_body: transformers::EaseBuzzSubmitEvidenceRequest, response_body: transformers::EaseBuzzSubmitEvidenceResponse, router_data: RouterDataV2<SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>),
        (flow: DefendDispute, request_body: transformers::EaseBuzzDefendDisputeRequest, response_body: transformers::EaseBuzzDefendDisputeResponse, router_data: RouterDataV2<DefendDispute, DisputeFlowData, DisputeDefendData, DisputeResponseData>)
    ],
    amount_converters: [
    ...
    > ConnectorCommon for EaseBuzz<T>
{
    ...
    fn build_error_response(
        ...
        Ok(ErrorResponse {
            ...
            message: response.error_desc.or(response.message).clone(),
