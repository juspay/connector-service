...
use domain_types::{
    ...
    connector_types::{
        ...
        PaymentMethodTokenResponse, PaymentMethodTokenizationData, PaymentVoidData, PaymentsAuthorizeData, PaymentsAuthenticateData, PaymentsCaptureData, PaymentsPostAuthenticateData, PaymentsPreAuthenticateData, PaymentsResponseData,
...
macros::create_all_prerequisites!(
    ...
    member_functions: {
        ...
        pub fn connector_base_url_payments<'a, F, Req, Res>(
            ...
            if is_test {
                constants::api::TEST_BASE_URL
            } else {
                constants::api::PROD_BASE_URL
            }
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}{}", base_url, constants::api::INITIATE_PAYMENT))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            let base_url = self.connector_base_url_payments(req);
            Ok(format!("{}{}", base_url, constants::api::TRANSACTION_SYNC))
        }
    }
);
