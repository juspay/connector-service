    ...
    > connector_types::IncomingWebhook for EaseBuzz<T>
{
    fn verify_webhook_source(
        ...
        // TODO: Implement webhook verification for EaseBuzz
        Ok(true)
    }
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: SetupMandate,
            request_body: transformers::EaseBuzzSetupMandateRequest<T>,
        ...
        (
            ...
            request_body: transformers::EaseBuzzPreAuthenticateRequest<T>,
            response_body: transformers::EaseBuzzPreAuthenticateResponse,
            router_data: RouterDataV2<PreAuthenticate, PaymentFlowData, PaymentsPreAuthenticateData<T>, PaymentsResponseData>,
        ),
        (
            flow: Authenticate,
            request_body: transformers::EaseBuzzAuthenticateRequest<T>,
        ...
        (
            ...
            request_body: transformers::EaseBuzzPostAuthenticateRequest<T>,
        ...
        (
            ...
            request_body: transformers::EaseBuzzPaymentMethodTokenRequest<T>,
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            let base_url = self.connector_base_url_payments(req);
            Ok(format!("{}/payment/transaction/status", base_url))
        }
    }
);
    ...
    > ConnectorCommon for EaseBuzz<T>
{
    ...
    fn get_auth_header(
        ...
        // EaseBuzz uses custom auth in the request body, not headers
        Ok(vec![])
    }
