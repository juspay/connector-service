...
use domain_types::{
    connector_flow::{
        ...
        PostAuthenticate, PreAuthenticate, PSync, Refund, RepeatPayment, SetupMandate,
        SubmitEvidence, Void, VoidPC, RSync,
    },
    connector_types::{
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        // Add stub implementations for required flows
        (
            flow: PreAuthenticate,
            request_body: EaseBuzzDummyRequest,
            response_body: EaseBuzzDummyResponse,
