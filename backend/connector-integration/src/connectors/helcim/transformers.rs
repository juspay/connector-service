...
use crate::{connectors::helcim::HelcimRouterData, types::ResponseRouterData, ConnectorResponseError};
...
) -> Result<common_enums::Currency, ConnectorRequestError> {
    ...
    fn try_from(
        ...
        match item.router_data.request.sync_type {
            ...
            SyncRequestType::MultipleCaptureSync => {
                Err(
                    ConnectorRequestError::NotImplemented("manual multiple capture sync".to_string())
                        .into(),
                )
