...
macros::create_all_prerequisites!(
    ...
    member_functions: {
        ...
        pub fn connector_base_url_payments<'a, F, Req, Res>(
            ...
            &req.resource_common_data.connectors.get_config().adyen.base_url
        }
        ...
        pub fn connector_base_url_disputes<'a, F, Req, Res>(
            ...
            req.resource_common_data.connectors.get_config().adyen.dispute_base_url.as_deref()
        }
    }
);
    ...
    for Adyen<T>
{
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.get_config().adyen.base_url.as_ref()
    }
