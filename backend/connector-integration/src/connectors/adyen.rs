...
use domain_types::{
    connector_flow::{
        ...
        PaymentMethodToken, PostAuthenticate, PreAuthenticate, PSync, RSync, Refund, SetupMandate, 
        SubmitEvidence, Void,
    },
    connector_types::{
        ...
        PaymentVoidData, PaymentsAuthorizeData, PaymentsAuthenticateData, PaymentsCaptureData, 
