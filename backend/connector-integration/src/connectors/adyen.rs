...
use domain_types::{
    ...
    connector_types::{
        AcceptDisputeData, AcceptDisputeV2, ConnectorServiceTrait, ConnectorWebhookSecrets, DisputeFlowData, DisputeResponseData, IncomingWebhook, PaymentAuthorizeV2,
    ...
    for Adyen
{
    ...
    fn handle_response_v2(
        &self,
        data: &RouterDataV2<AcceptDispute, DisputeFlowData, AcceptDisputeData, DisputeResponseData>,
        event_builder: Option<&mut ConnectorEvent>,
        res: Response,
    ) -> CustomResult<
        RouterDataV2<AcceptDispute, DisputeFlowData, AcceptDisputeData, DisputeResponseData>,
        errors::ConnectorError,
    > {
