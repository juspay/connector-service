    ...
    > connector_types::IncomingWebhook for TPSL<T>
{
    fn verify_webhook_source(
        ...
        // TPSL webhook verification - to be implemented based on requirements
        Ok(true)
    }
    ...
    fn process_payment_webhook(
        ...
        error_stack::Report<domain_types::errors::ConnectorError>,
    > {
        // TPSL webhook processing - to be implemented based on requirements
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        fn get_headers(
            ...
            let auth_header = get_tpsl_auth_header(&auth_type)?;
