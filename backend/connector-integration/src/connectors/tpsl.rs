...
use transformers::{
    ...
    TpslVoidRequest, TpslVoidResponse, TpslCaptureRequest, TpslCaptureResponse, TpslRefundRequest, TpslRefundResponse,
    TpslRefundSyncRequest, TpslRefundSyncResponse, TpslCreateOrderRequest, TpslCreateOrderResponse,
    TpslSessionTokenRequest, TpslSessionTokenResponse, TpslMandateRequest, TpslMandateResponse,
    TpslRepeatPaymentRequest, TpslRepeatPaymentResponse, TpslAcceptDisputeRequest, TpslAcceptDisputeResponse,
    TpslDefendDisputeRequest, TpslDefendDisputeResponse, TpslSubmitEvidenceRequest, TpslSubmitEvidenceResponse,
};
