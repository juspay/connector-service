...
pub type TpslRouterData<F, T> = crate::connectors::ConnectorRouterData<F, T>;
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (Void, TpslVoidRequest, TpslVoidResponse, RouterDataV2<Void, PaymentFlowData, PaymentVoidData, PaymentsResponseData>),
        (Capture, TpslCaptureRequest, TpslCaptureResponse, RouterDataV2<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData>),
        (Refund, TpslRefundRequest, TpslRefundResponse, RouterDataV2<Refund, RefundFlowData, RefundsData, RefundsResponseData>),
        (RSync, TpslRefundSyncRequest, TpslRefundSyncResponse, RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>),
        (CreateOrder, TpslCreateOrderRequest, TpslCreateOrderResponse, RouterDataV2<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse>),
        (CreateSessionToken, TpslSessionTokenRequest, TpslSessionTokenResponse, RouterDataV2<CreateSessionToken, PaymentFlowData, SessionTokenRequestData, SessionTokenResponseData>),
        (SetupMandate, TpslSetupMandateRequest, TpslSetupMandateResponse, RouterDataV2<SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>),
        (RepeatPayment, TpslRepeatPaymentRequest, TpslRepeatPaymentResponse, RouterDataV2<RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>),
        (Accept, TpslAcceptDisputeRequest, TpslAcceptDisputeResponse, RouterDataV2<Accept, DisputeFlowData, AcceptDisputeData, DisputeResponseData>),
        (DefendDispute, TpslDefendDisputeRequest, TpslDefendDisputeResponse, RouterDataV2<DefendDispute, DisputeFlowData, DisputeDefendData, DisputeResponseData>),
        (SubmitEvidence, TpslSubmitEvidenceRequest, TpslSubmitEvidenceResponse, RouterDataV2<SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>),
    ],
    amount_converters: [
