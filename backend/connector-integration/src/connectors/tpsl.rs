...
use domain_types::{
    ...
    connector_types::{
        ...
        PaymentVoidData, PaymentsAccessTokenData, PaymentsAuthorizeData, PaymentsAuthenticateData, PaymentsCaptureData, PaymentsCancelPostCaptureData, PaymentsCreateConnectorCustomerData, PaymentsIncomingWebhookData, PaymentsPostAuthenticateData, PaymentsPreAuthenticateData, PaymentsResponseData,
        PaymentsSyncData, PaymentsTokenData, RefundFlowData, RefundSyncData, RefundsData, RefundsResponseData,
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > ConnectorIntegrationV2<domain_types::connector_flow::Token, PaymentFlowData, PaymentsTokenData<T>, PaymentsResponseData>
    for TPSL<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > ConnectorIntegrationV2<domain_types::connector_flow::AccessToken, PaymentFlowData, PaymentsAccessTokenData, PaymentsResponseData>
    for TPSL<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > ConnectorIntegrationV2<domain_types::connector_flow::CreateConnectorCustomer, PaymentFlowData, PaymentsCreateConnectorCustomerData, PaymentsResponseData>
    for TPSL<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > ConnectorIntegrationV2<domain_types::connector_flow::IncomingWebhook, PaymentFlowData, PaymentsIncomingWebhookData, PaymentsResponseData>
    for TPSL<T>
{
}
