...
use transformers::{
    self as helcim, HelcimPaymentsRequest, HelcimPaymentsResponse, HelcimSyncRequest, HelcimSyncResponse,
    HelcimCaptureRequest, HelcimCaptureResponse, HelcimVoidRequest, HelcimVoidResponse, HelcimRefundRequest, HelcimRefundResponse,
    HelcimRSyncRequest, HelcimRSyncResponse,
};
    ...
    member_functions: {
            ...
            Self: ConnectorIntegrationV2<F, FCD, Req, Res>,
        {
            ...
            let mut idempotency_key = vec![(
                ...
                common_utils::fp_utils::generate_id_with_default_len("HS").into_masked(),
            )];
