...
fn build_billdesk_message(
    ...
    amount_converter: &dyn common_utils::types::AmountConvertor<Output = common_utils::types::StringMinorUnit>,
    ...
    for BilldeskPaymentsRequest
{
    ...
    fn try_from(
        ...
        let msg = build_billdesk_message(&auth, &item.router_data, &common_utils::types::StringMinorUnitForConnector)?;
...
impl TryFrom<crate::connectors::billdesk::BilldeskRouterData<RouterDataV2<PSync, PaymentFlowData, domain_types::connector_types::PaymentsSyncData, PaymentsResponseData>, T>>
