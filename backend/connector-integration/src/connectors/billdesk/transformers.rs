...
// The BilldeskRouterData type is generated by the create_all_prerequisites! macro
pub struct BilldeskRouterData<RD: FlowTypes, T: PaymentMethodDataTypes> {
    pub connector: crate::connectors::billdesk::Billdesk<T>,
    pub router_data: RD,
}

impl<RD: FlowTypes, T: PaymentMethodDataTypes> FlowTypes for BilldeskRouterData<RD, T> {
    type Flow = RD::Flow;
