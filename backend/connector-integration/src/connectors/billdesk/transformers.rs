...
// This type is generated by the create_all_prerequisites! macro
pub struct BilldeskRouterData<RD: FlowTypes, T: domain_types::payment_method_data::PaymentMethodDataTypes> {
    pub connector: crate::connectors::billdesk::Billdesk<T>,
    pub router_data: RD,
}

impl<RD: FlowTypes, T: domain_types::payment_method_data::PaymentMethodDataTypes> FlowTypes for BilldeskRouterData<RD, T> {
    type Flow = RD::Flow;
