...
use std::fmt::Debug;
use transformers::{
    self as forte, ForteCaptureRequest, ForteCaptureResponse, FortePSyncRequest,
    FortePSyncResponse, FortePaymentsRequest, FortePaymentsResponse, ForteRSyncRequest,
...
// Forte struct is generated by the macros::create_all_prerequisites! macro
    ...
    for Forte<T>
{
    ...
    fn get_auth_header(
        ...
        let encoded_api_key = BASE64_ENGINE.encode(format!(
            "{}:{}",
            auth.api_login_id.peek(),
            auth.secure_key.peek()
        ));
        Ok(vec![(
            headers::AUTHORIZATION.to_string(),
            format!("Basic {}", encoded_api_key).into(),
        )])
    }
...
macros::macro_connector_implementation!(
    ...
    connector: Forte,
    curl_request: Json(FortePaymentsRequestDefault),
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/v3/transactions", self.connector_base_url_payments(req)))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/v3/transactions/{}", self.connector_base_url_payments(req), connector_transaction_id))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/v3/transactions", self.connector_base_url_refunds(req)))
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/v3/transactions/{}", self.connector_base_url_refunds(req), connector_refund_id))
        }
    }
);
