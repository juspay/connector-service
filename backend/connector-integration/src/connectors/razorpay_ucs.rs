...
use serde::Serialize;
use transformers::{self as razorpay_ucs, RazorpayUcsPaymentsRequest, RazorpayUcsPaymentsResponse};
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::ConnectorServiceTrait<T> for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentAuthorizeV2<T> for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentSyncV2 for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentSessionToken for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentVoidV2 for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::RefundSyncV2 for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::RefundV2 for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentCapture for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::SetupMandateV2<T> for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::AcceptDispute for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::SubmitEvidenceV2 for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::DisputeDefend for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::PaymentOrderCreate for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::ValidationTrait for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::RepeatPaymentV2 for RazorpayUcs<T>
{
}
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > connector_types::IncomingWebhook for RazorpayUcs<T>
{
    ...
    fn process_payment_webhook(
        ...
        error_stack::Report<domain_types::errors::ConnectorError>,
    > {
        let webhook: transformers::RazorpayUcsPaymentsSyncResponse = request
            .body
            .parse_struct("RazorpayUcsPaymentsSyncResponse")
...
// CRITICAL: UCS v2 macro framework implementation
macros::create_all_prerequisites!(
    connector_name: RazorpayUcs,
    generic_type: T,
    api: [
        (
            flow: Authorize,
            request_body: RazorpayUcsPaymentsRequest,
            response_body: RazorpayUcsPaymentsResponse,
            router_data: RouterDataV2<Authorize, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>,
        ),
        (
            flow: PSync,
            request_body: RazorpayUcsPaymentsSyncRequest,
            response_body: RazorpayUcsPaymentsSyncResponse,
            router_data: RouterDataV2<PSync, PaymentFlowData, PaymentsSyncData, PaymentsResponseData>,
        ),
        (
            flow: RSync,
            request_body: RazorpayUcsRefundSyncRequest,
            response_body: RazorpayUcsRefundSyncResponse,
            router_data: RouterDataV2<RSync, RefundFlowData, RefundSyncData, RefundsResponseData>,
        ),
        (
            flow: Void,
            request_body: RazorpayUcsVoidRequest,
            response_body: RazorpayUcsVoidResponse,
            router_data: RouterDataV2<Void, PaymentFlowData, PaymentVoidData, PaymentsResponseData>,
        ),
        (
            flow: Capture,
            request_body: RazorpayUcsCaptureRequest,
            response_body: RazorpayUcsCaptureResponse,
            router_data: RouterDataV2<Capture, PaymentFlowData, PaymentsCaptureData, PaymentsResponseData>,
        ),
        (
            flow: Refund,
            request_body: RazorpayUcsRefundRequest,
            response_body: RazorpayUcsRefundResponse,
            router_data: RouterDataV2<Refund, RefundFlowData, RefundsData, RefundsResponseData>,
        ),
        (
            flow: CreateOrder,
            request_body: RazorpayUcsCreateOrderRequest,
            response_body: RazorpayUcsCreateOrderResponse,
            router_data: RouterDataV2<CreateOrder, PaymentFlowData, PaymentCreateOrderData, PaymentCreateOrderResponse>,
        ),
        (
            flow: SetupMandate,
            request_body: RazorpayUcsSetupMandateRequest,
            response_body: RazorpayUcsSetupMandateResponse,
            router_data: RouterDataV2<SetupMandate, PaymentFlowData, SetupMandateRequestData<T>, PaymentsResponseData>,
        ),
        (
            flow: RepeatPayment,
            request_body: RazorpayUcsRepeatPaymentRequest,
            response_body: RazorpayUcsRepeatPaymentResponse,
            router_data: RouterDataV2<RepeatPayment, PaymentFlowData, RepeatPaymentData, PaymentsResponseData>,
        ),
        (
            flow: Accept,
            request_body: RazorpayUcsAcceptRequest,
            response_body: RazorpayUcsAcceptResponse,
            router_data: RouterDataV2<Accept, DisputeFlowData, AcceptDisputeData, DisputeResponseData>,
        ),
        (
            flow: DefendDispute,
            request_body: RazorpayUcsDefendDisputeRequest,
            response_body: RazorpayUcsDefendDisputeResponse,
            router_data: RouterDataV2<DefendDispute, DisputeFlowData, DisputeDefendData, DisputeResponseData>,
        ),
        (
            flow: SubmitEvidence,
            request_body: RazorpayUcsSubmitEvidenceRequest,
            response_body: RazorpayUcsSubmitEvidenceResponse,
            router_data: RouterDataV2<SubmitEvidence, DisputeFlowData, SubmitEvidenceData, DisputeResponseData>,
        ),
        (
            flow: CreateSessionToken,
            request_body: RazorpayUcsCreateSessionTokenRequest,
            response_body: RazorpayUcsCreateSessionTokenResponse,
    ...
    member_functions: {
            ...
            Self: ConnectorIntegrationV2<F, FCD, Req, Res>,
        {
            ...
            let auth_type = transformers::RazorpayUcsAuth::try_from(&req.connector_auth_type)?;
            let mut api_key = get_auth_header_razorpay_ucs(&auth_type)?;
        ...
        pub fn connector_base_url_payments<'a, F, Req, Res>(
            ...
            &req.resource_common_data.connectors.razorpayv2.base_url
        }
...
// CRITICAL: Macro implementation for Authorize flow
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: RazorpayUcs,
    curl_request: Json(RazorpayUcsPaymentsRequest),
    curl_response: RazorpayUcsPaymentsResponse,
    flow_name: Authorize,
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/v1/payments/create/upi", base_url))
        }
        fn get_api_tag(
            &self,
...
// CRITICAL: Macro implementation for PSync flow
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: RazorpayUcs,
    curl_response: RazorpayUcsPaymentsSyncResponse,
    flow_name: PSync,
    resource_common_data: PaymentFlowData,
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}/v1/payments/{}", base_url, payment_id))
        }
        fn get_api_tag(
            &self,
            _req: &RouterDataV2<PSync, PaymentFlowData, PaymentsSyncData, PaymentsResponseData>,
        ) -> Option<String> {
            Some("GW_SYNC_PAYMENT".to_string())
        }
    }
);
...
impl<
        T: PaymentMethodDataTypes
            ...
            + 'static
            + Serialize,
    > ConnectorCommon for RazorpayUcs<T>
{
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.razorpayv2.base_url.as_ref()
    }
    ...
    fn get_auth_header(
        ...
        // RazorpayUcs uses custom auth in get_headers
        Ok(vec![])
    }
    ...
    fn build_error_response(
        ...
        let response: razorpay_ucs::RazorpayUcsErrorResponse = res
            .response
            .parse_struct("RazorpayUcsErrorResponse")
...
macro_rules! impl_not_implemented_flow {
    ($flow:ty, $common_data:ty, $req:ty, $resp:ty) => {
        impl<T: PaymentMethodDataTypes + std::fmt::Debug + std::marker::Sync + std::marker::Send + 'static + Serialize>
            ConnectorIntegrationV2<$flow, $common_data, $req, $resp> for RazorpayUcs<T>
        {
            fn build_request_v2(
                &self,
    ...
    ($flow:ty, $common_data:ty, $req:ty, $resp:ty) => {
        impl<
                T: PaymentMethodDataTypes
                    ...
                    + 'static
                    + Serialize,
            > SourceVerification<$flow, $common_data, $req, $resp> for RazorpayUcs<T>
        {
            fn get_secrets(
                &self,
...
fn get_auth_header_razorpay_ucs(
    auth_type: &transformers::RazorpayUcsAuth,
) -> CustomResult<Vec<(String, Maskable<String>)>, errors::ConnectorError> {
