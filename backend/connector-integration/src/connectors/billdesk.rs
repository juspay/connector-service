...
use constants::{endpoints, headers};
    ...
    > connector_types::IncomingWebhook for Billdesk<T>
{
    ...
    fn process_payment_webhook(
        ...
        error_stack::Report<domain_types::errors::ConnectorError>,
    > {
        let webhook: billdesk::BilldeskUPITransactionResponse = request
            .body
            .parse_struct("BilldeskUPITransactionResponse")
    ...
    member_functions: {
        ...
        pub fn connector_base_url<'a, F, Req, Res>(
            ...
            if req.resource_common_data.is_sandbox() {
                endpoints::UAT_BASE_URL
            } else {
                endpoints::PROD_BASE_URL
            }
        }
    }
);
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            let endpoint = if req.resource_common_data.is_sandbox() {
                endpoints::UPI_INITIATE_UAT
            } else {
                endpoints::UPI_INITIATE_PROD
            };
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            let base_url = self.connector_base_url(req);
            let endpoint = if req.resource_common_data.is_sandbox() {
                endpoints::STATUS_SYNC_UAT
            } else {
                endpoints::STATUS_SYNC_PROD
            };
            Ok(format!("{}{}", base_url, endpoint))
        }
    }
    ...
    > ConnectorCommon for Billdesk<T>
{
    ...
    fn get_auth_header(
        ...
        // Billdesk uses custom authentication in the message body
...
// SourceVerification implementations for UPI flows
