...
use domain_types::{
    ...
    connector_types::{
        ConnectorCustomerData, ConnectorCustomerResponse, PaymentFlowData, PaymentMethodTokenResponse, PaymentMethodTokenizationData, PaymentsAuthenticateData, PaymentsAuthorizeData, PaymentsCancelPostCaptureData, PaymentsPostAuthenticateData, PaymentsPreAuthenticateData, PaymentsResponseData, PaymentsSyncData, SessionTokenRequestData, SessionTokenResponseData,
    },
    errors,
...
use transformers::{self as billdesk, BilldeskPaymentsRequest, BilldeskPaymentsResponse, BilldeskPaymentsSyncRequest, BilldeskPaymentsSyncResponse,
    BilldeskVoidRequest, BilldeskVoidResponse, BilldeskVoidPCRequest, BilldeskVoidPCResponse, BilldeskPaymentMethodTokenRequest, BilldeskPaymentMethodTokenResponse, BilldeskCreateConnectorCustomerRequest, BilldeskCreateConnectorCustomerResponse, BilldeskCreateAccessTokenRequest, BilldeskCreateAccessTokenResponse, BilldeskCaptureRequest, BilldeskCaptureResponse,
    ...
    BilldeskAuthenticateRequest, BilldeskAuthenticateResponse, BilldeskPreAuthenticateRequest, BilldeskPreAuthenticateResponse
};
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            ...
            router_data: RouterDataV2<PaymentMethodToken, PaymentFlowData, domain_types::connector_types::PaymentMethodTokenizationData<T>, PaymentMethodTokenResponse>,
        ),
        (
        ...
        (
            ...
            request_body: BilldeskCreateAccessTokenRequest,
            response_body: BilldeskCreateAccessTokenResponse,
...
// MANDATORY: Use macro for PostAuthenticate flow implementation
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billdesk,
    curl_request: Json(BilldeskPostAuthenticateRequest),
    curl_response: BilldeskPostAuthenticateResponse,
    flow_name: PostAuthenticate,
    resource_common_data: PaymentFlowData,
    flow_request: domain_types::connector_types::PaymentsPostAuthenticateData<T>,
    flow_response: PaymentsResponseData,
    http_method: Post,
    generic_type: T,
    [PaymentMethodDataTypes + std::fmt::Debug + std::marker::Sync + std::marker::Send + 'static + Serialize],
    other_functions: {
        fn get_headers(
            ...
            // Add checksum header for Billdesk authentication
            let checksum = billdesk::generate_checksum_for_post_auth(req, &auth, self.amount_converter)?;
            header.push((headers::CHECKSUM.to_string(), checksum.into_masked()));
...
// MANDATORY: Use macro for Authenticate flow implementation
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billdesk,
    ...
    resource_common_data: PaymentFlowData,
    flow_request: domain_types::connector_types::PaymentsAuthenticateData<T>,
    flow_response: PaymentsResponseData,
    http_method: Post,
    generic_type: T,
    [PaymentMethodDataTypes + std::fmt::Debug + std::marker::Sync + std::marker::Send + 'static + Serialize],
    other_functions: {
        fn get_headers(
            ...
            // Add checksum header for Billdesk authentication
            let checksum = billdesk::generate_checksum_for_auth(req, &auth, self.amount_converter)?;
            header.push((headers::CHECKSUM.to_string(), checksum.into_masked()));
...
// MANDATORY: Use macro for PreAuthenticate flow implementation
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billdesk,
    ...
    other_functions: {
        fn get_headers(
            ...
            // Add checksum header for Billdesk authentication
            let checksum = billdesk::generate_checksum_for_pre_auth(req, &auth, self.amount_converter)?;
            header.push((headers::CHECKSUM.to_string(), checksum.into_masked()));
...
// MANDATORY: Use macro for VoidPC flow implementation
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billdesk,
    curl_request: Json(BilldeskVoidPCRequest),
...
// MANDATORY: Use macro for CreateConnectorCustomer flow implementation
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billdesk,
    ...
    other_functions: {
        fn get_headers(
            &self,
            req: &RouterDataV2<CreateConnectorCustomer, PaymentFlowData, domain_types::connector_types::ConnectorCustomerData, ConnectorCustomerResponse>,
        ) -> CustomResult<Vec<(String, Maskable<String>)>, errors::ConnectorError> {
            let mut header = vec![(
                headers::CONTENT_TYPE.to_string(),
                self.common_get_content_type().to_string().into(),
...
// MANDATORY: Use macro for CreateAccessToken flow implementation
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billdesk,
    curl_request: Json(BilldeskCreateAccessTokenRequest),
    curl_response: BilldeskCreateAccessTokenResponse,
    flow_name: CreateAccessToken,
    resource_common_data: PaymentFlowData,
    flow_request: domain_types::connector_types::SessionTokenRequestData,
    ...
    other_functions: {
        fn get_headers(
            &self,
            req: &RouterDataV2<CreateAccessToken, PaymentFlowData, domain_types::connector_types::SessionTokenRequestData, SessionTokenResponseData>,
        ) -> CustomResult<Vec<(String, Maskable<String>)>, errors::ConnectorError> {
            let mut header = vec![(
                headers::CONTENT_TYPE.to_string(),
                self.common_get_content_type().to_string().into(),
