...
use domain_types::{
    ...
    connector_types::{
        ...
        PaymentMethodTokenResponse, PaymentMethodTokenizationData, PaymentVoidData, PaymentsAuthenticateData, PaymentsAuthorizeData, PaymentsCaptureData,
        PaymentsPostAuthenticateData, PaymentsPreAuthenticateData, PaymentsResponseData,
        PaymentsSyncData, RefundFlowData, RefundSyncData, RefundsData, RefundsResponseData,
        RepeatPaymentData, RequestDetails, SessionTokenRequestData, SessionTokenResponseData,
        SetupMandateRequestData, SubmitEvidenceData, EventType,
    },
    errors,
...
fn get_billdesk_auth_header(
    ...
    let checksum = generate_checksum(auth_type)?;
    Ok(vec![(headers::AUTHORIZATION.to_string(), checksum.into_masked())])
}

fn generate_checksum(auth_type: &transformers::BilldeskAuth) -> CustomResult<String, errors::ConnectorError> {
