...
use domain_types::{
    ...
    connector_types::{
        ...
        PaymentMethodTokenResponse, PaymentMethodTokenizationData, PaymentVoidData, PaymentsAuthenticateData, PaymentsAuthorizeData, PaymentsCaptureData, PaymentsPostAuthenticateData,
...
fn get_billdesk_auth_header(
    ...
    Ok(format!(
        "Basic {}",
        base64::engine::general_purpose::STANDARD.encode(format!("{}:{}", merchant_id, checksum_key))
    )
    .into_masked())
}