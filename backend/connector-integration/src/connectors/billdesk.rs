    ...
    > connector_types::IncomingWebhook for Billdesk<T>
{
    fn verify_webhook_source(
        ...
        // TODO: Implement webhook verification based on Billdesk's webhook signature mechanism
        Ok(true)
    }
...
macros::macro_connector_implementation!(
    ...
    other_functions: {
        ...
        fn get_url(
            ...
            Ok(format!("{}?reqid=REFUNDSTATUSV2", base_url))
        }
    }
);
    ...
    > ConnectorCommon for Billdesk<T>
{
    ...
    fn base_url<'a>(&self, _connectors: &'a Connectors) -> &'a str {
        // Base URL is determined dynamically based on test mode in member functions
        ""
    }
