...
use domain_types::{
    ...
    errors,
    payment_method_data::{PaymentMethodData, RawCardNumber},
...
impl<T: PaymentMethodData> TryFrom<&RouterDataV2<Authorize, PaymentFlowData, PaymentsAuthorizeData<T>, PaymentsResponseData>>
