...
impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    connector_types::PaymentSessionToken for Billwerk<T>
{
}

impl<T: PaymentMethodDataTypes + Debug + Sync + Send + 'static + Serialize>
    connector_types::PaymentAccessToken for Billwerk<T>
{
}
...
macros::create_all_prerequisites!(
    ...
    api: [
        ...
        (
            flow: Authorize,
            request_body: BillwerkPaymentsRequest<T>,
    ...
    for Billwerk<T>
{
    ...
    fn build_error_response(
        ...
        print!("Response_build_error_response: {:?}", res);
...
macros::macro_connector_implementation!(
    connector_default_implementations: [get_content_type, get_error_response_v2],
    connector: Billwerk,
    curl_request: Json(BillwerkRSyncRequest),
