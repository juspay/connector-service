...
use crate::connectors::{
    ...
    Dlocal, Elavon, Finix, Fiserv, Fiuu, Helcim, Mifinity, Nexinets, Noon, Novalnet, Paytm, Payu,
    Phonepe, Placetopay, Rapyd, Razorpay, RazorpayV2, Volt, Xendit,
};
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            ConnectorEnum::Finix => Box::new(Finix::new()),
