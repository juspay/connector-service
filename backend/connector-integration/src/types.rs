...
use crate::connectors::{
    Aci, Adyen, Authorizedotnet, Billdesk, Bluecode, Braintree, Cashfree, Cashtocode, Checkout, Cryptopay,
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            ConnectorEnum::Billdesk => todo!("Billdesk connector not yet fully implemented"),
        }
    }
}
