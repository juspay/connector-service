...
use crate::connectors::{
    ...
    Checkout, Cryptopay, Cybersource, Datatrans, Dlocal, Elavon, Fiserv, Fiservemea, Fiuu, Getnet,
    Globalpay, Helcim, Hipay, Mifinity, Multisafepay, Nexinets, Noon, Novalnet, Payload, Paypal,
    Paytm, Payu, Phonepe, Placetopay, Rapyd, Razorpay, RazorpayV2, Silverflow, Stax, Stripe,
    Trustpay, Trustpayments, Volt, Worldpay, Worldpayvantiv, Xendit,
};
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            ConnectorEnum::Getnet => Box::new(Getnet::new()),
