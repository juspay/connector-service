...
use crate::connectors::{
    Aci, Adyen, Authipay, Authorizedotnet, Billwerk, Bluecode, Bluesnap, Braintree, Cashfree,
    Cashtocode, Celero, Checkout, Cryptopay, Cybersource, Datatrans, Dlocal, Elavon, Fiserv,
    Fiservemea, Fiuu, Globalpay, Helcim, Hipay, Iatapay, Mifinity, Multisafepay, Nexinets, Noon,
    Novalnet, Payload, Paypal, Paysafe, Paytm, Payu, Phonepe, Placetopay, Rapyd, Razorpay,
    RazorpayV2, Silverflow, Stax, Stripe, Trustpay, Trustpayments, Volt, Worldpay, Worldpayvantiv,
    Xendit,
};
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            ConnectorEnum::Globalpay => Box::new(Globalpay::new()),
            ConnectorEnum::Dlocal => Box::new(Dlocal::new()),
            ConnectorEnum::Hipay => Box::new(Hipay::new()),
            ConnectorEnum::Placetopay => Box::new(Placetopay::new()),
            ConnectorEnum::Trustpayments => Box::new(Trustpayments::new()),
