...
use crate::connectors::{
    Aci, Adyen, Archipel, Authorizedotnet, Bluecode, Braintree, Cashfree, Cashtocode, Checkout,
    Cryptopay, Cybersource, Dlocal, Elavon, Fiserv, Fiuu, Helcim, Mifinity, Nexinets, Noon,
    Novalnet, Paytm, Payu, Phonepe, Placetopay, Rapyd, Razorpay, RazorpayV2, Stripe, Trustpay,
    Volt, Worldpay, Xendit,
};
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            ConnectorEnum::Archipel => Box::new(Archipel::new()),
        }
    }
}
