...
use crate::connectors::{
    Adyen, Authorizedotnet, Cashfree, Cashtocode, Checkout, /* CcavenueV2, */ Elavon, Fiserv, Fiuu, Mifinity,
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            // ConnectorEnum::CcavenueV2 => Box::new(CcavenueV2::new()), // Temporarily commented out
        }
    }
}
