...
use crate::connectors::{
    Aci, Adyen, Authorizedotnet, Bankofamerica, Bluecode, Braintree, Cashfree, Cashtocode, Checkout, Cryptopay,
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            ConnectorEnum::Bankofamerica => Box::new(Bankofamerica::new()),
        }
    }
}
