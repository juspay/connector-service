...
use crate::connectors::{
    ...
    Cybersource, Dlocal, EaseBuzz, Elavon, Fiserv, Fiuu, Helcim, Mifinity, Nexinets, Noon, Novalnet, Paytm,
    ...
    ConnectorData<T>
{
    ...
    fn convert_connector(connector_name: ConnectorEnum) -> BoxedConnector<T> {
        match connector_name {
            ...
            // ConnectorEnum::EaseBuzz => Box::new(EaseBuzz::new()) as Box<dyn connector_types::ConnectorServiceTrait<T> + Sync>,
        }
    }
}
