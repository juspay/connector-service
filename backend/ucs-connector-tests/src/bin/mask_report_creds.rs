...
//!
//! Usage:
//!   cargo run -p ucs-connector-tests --bin mask_report_creds
//!   cargo run -p ucs-connector-tests --bin mask_report_creds -- --path <report_dir>
//!   cargo run -p ucs-connector-tests --bin mask_report_creds -- --dry-run
//!
...
use ucs_connector_tests::harness::cred_masking::{mask_json_value, mask_sensitive_text};
use ucs_connector_tests::harness::report::{report_path, ScenarioRunReport};
...
Usage:
  cargo run -p ucs-connector-tests --bin mask_report_creds
  cargo run -p ucs-connector-tests --bin mask_report_creds -- --path <report.json>
  cargo run -p ucs-connector-tests --bin mask_report_creds -- --dry-run
