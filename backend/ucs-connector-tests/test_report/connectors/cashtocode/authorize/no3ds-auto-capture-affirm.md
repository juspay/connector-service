# Connector `cashtocode` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_64348628d0de4286b73f5299",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "morgan.8601@example.com"
    },
    "id": "cust_791bdc8ec1ad4d6f9af3d855",
    "phone_number": "+444834314549"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.4677@sandbox.example.com"
      },
      "phone_number": {
        "value": "1004912837"
      },
