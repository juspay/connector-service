# Connector `datatrans` / Suite `post_authenticate` / Scenario `threeds_card_post_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "casey.2057@example.com"
    },
    "id": "cust_6cd1b6ca1f92474a93a77fc3",
    "phone_number": "+443967477573"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.5420@sandbox.example.com"
      },
      "phone_number": {
        "value": "8695632055"
      },
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_72b168e0f2014132b791514b"
  },
  "metadata": {
    "value": "{}"
  },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PostAuthenticate <<'JSON'
{
  ...
  "connector_order_reference_id": "gen_556803",
  "metadata": {
    "value": "{}"
  },
  "connector_feature_data": {
