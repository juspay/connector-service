# Connector `worldpayxml` / Suite `authorize` / Scenario `threeds_manual_capture_credit_card`
...
{
  "merchant_transaction_id": "mti_02941222438243d4b7717548",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Brown",
    "email": {
      "value": "sam.3389@testmail.io"
    },
    "id": "cust_f99cd022b9124a5b8002b91d",
    "phone_number": "+444382883389"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "4516 Lake Blvd"
      },
      "line3": {
        "value": "1790 Sunset St"
      },
      "city": {
        "value": "Chicago"
      },
...
date: Tue, 24 Mar 2026 07:11:22 GMT
x-request-id: authorize_threeds_manual_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "mti_02941222438243d4b7717548",
  "connectorTransactionId": "mti_02941222438243d4b7717548",
  "status": "AUTHORIZED",
  "statusCode": 200,
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 07:11:22 GMT",
    "expires": "Tue, 24 Mar 2026 07:11:22 GMT",
    "p3p": "CP=\"NON\"",
    "pragma": "no-cache",
