# Connector `elavon` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_6f4abf2af6654daf8e18c7db",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "alex.1256@sandbox.example.com"
    },
    "id": "cust_c93cd1d7f30d4eb9aa47c29a",
    "phone_number": "+913073681980"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.5204@sandbox.example.com"
      },
      "phone_number": {
        "value": "3884619154"
      },
