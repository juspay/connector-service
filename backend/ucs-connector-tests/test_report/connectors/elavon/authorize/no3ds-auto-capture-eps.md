# Connector `elavon` / Suite `authorize` / Scenario `no3ds_auto_capture_eps`
...
{
  "merchant_transaction_id": "mti_0712e9f2c63643a39bffb422",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ava Brown",
    "email": {
      "value": "jordan.7972@testmail.io"
    },
    "id": "cust_f8777d191bd2401887ffa96c",
    "phone_number": "+12123133485"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "AT",
      "email": {
        "value": "jordan.1242@sandbox.example.com"
      },
      "phone_number": {
        "value": "9596339148"
      },
