# Connector `nexinets` / Suite `capture` / Scenario `capture_full_amount`
...
{
  "merchant_transaction_id": "mti_eb7d9679566e4a038d602c23",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "morgan.9400@testmail.io"
    },
    "id": "cust_267bcd1e0a8046c0a053e9b3",
    "phone_number": "+441131474108"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "9354 Sunset Ln"
      },
      "line2": {
        "value": "7086 Sunset Rd"
      },
      "line3": {
        "value": "5853 Pine St"
      },
      ...
      "email": {
        "value": "riley.1884@sandbox.example.com"
      },
      "phone_number": {
        "value": "1233847652"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.9552@sandbox.example.com"
      },
      "phone_number": {
        "value": "1606691561"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_61f63cc695054ccdb873bd70",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
