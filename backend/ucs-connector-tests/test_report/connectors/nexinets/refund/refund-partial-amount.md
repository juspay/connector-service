# Connector `nexinets` / Suite `refund` / Scenario `refund_partial_amount`
...
{
  "merchant_transaction_id": "mti_1681b1caf7ee48b99ac54461",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Johnson",
    "email": {
      "value": "casey.5391@sandbox.example.com"
    },
    "id": "cust_d1e0322c20bd40b89d10f4ab",
    "phone_number": "+441823051702"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.3493@sandbox.example.com"
      },
      "phone_number": {
        "value": "5338181674"
      },
...
{
  "merchant_refund_id": "mri_ae1f8c3884b742e5a42f23a9",
