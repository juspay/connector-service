# Connector `paypal` / Suite `authorize` / Scenario `no3ds_auto_capture_ideal`
...
{
  "merchant_transaction_id": "mti_c126615d30574950bd639c2cf61aa169",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Mia Brown",
    "email": {
      "value": "casey.8018@sandbox.example.com"
    },
    "id": "cust_ca55863e9d324210bbdecdc5d7900639",
    "phone_number": "+918301848685"
  },
  "state": {
    "access_token": ***MASKED***
      "token": ***MASKED***
...
Response contents:
{
  "merchantTransactionId": "mti_c126615d30574950bd639c2cf61aa169",
  "connectorTransactionId": "13M99714PA231121K",
  ...
  "responseHeaders": {
    ...
    "paypal-debug-id": "f676192538f11",
    "server": "nginx",
    "server-timing": "traceparent;desc=\"00-0000000000000000000f676192538f11-3c4d3ea3cfa5cd8e-01\"",
    ...
    "x-timer": "S1774283119.550379,VS0,VE1704"
  },
  "redirectionData": {
    "form": {
      "endpoint": "https://sandbox.paypal.com/payment/ideal",
