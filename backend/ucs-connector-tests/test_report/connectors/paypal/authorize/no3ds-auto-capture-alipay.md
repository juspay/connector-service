# Connector `paypal` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_6aea231ff86d46fa813a510a64ef73a7",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Wilson",
    "email": {
      "value": "jordan.2053@testmail.io"
    },
    "id": "cust_6c73b801dc9342d79a501fd21ff4970a",
    "phone_number": "+19491210667"
  },
  "state": {
    "access_token": ***MASKED***
      "token": ***MASKED***
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "alex.3445@sandbox.example.com"
      },
      "phone_number": {
        "value": "1883851812"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "6048 Market Ln"
      },
      "line2": {
        "value": "1870 Pine Ave"
      },
      "line3": {
        "value": "8679 Sunset Dr"
      },
      "city": {
        "value": "San Francisco"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.9111@sandbox.example.com"
      },
      "phone_number": {
        "value": "2960985433"
      },
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:25:08 GMT
x-request-id: authorize_no3ds_auto_capture_alipay_req
