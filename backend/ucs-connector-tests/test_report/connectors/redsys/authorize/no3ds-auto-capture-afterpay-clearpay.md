# Connector `redsys` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_21097c592d31482a87ea36e0",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Johnson",
    "email": {
      "value": "sam.2428@sandbox.example.com"
    },
    "id": "cust_c0848bf3942744b7a93efb1e",
    "phone_number": "+446210411795"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "alex.2095@sandbox.example.com"
      },
      "phone_number": {
        "value": "7952924817"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.7364@sandbox.example.com"
      },
      "phone_number": {
        "value": "6875236158"
      },
