# Connector `getnet` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_7f9fab32e2e74906a7bd2bf3",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Miller",
    "email": {
      "value": "riley.1754@sandbox.example.com"
    },
    "id": "cust_146753f40c784c57a29899bb",
    "phone_number": "+14914297828"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.4579@sandbox.example.com"
      },
      "phone_number": {
        "value": "3303354419"
      },
