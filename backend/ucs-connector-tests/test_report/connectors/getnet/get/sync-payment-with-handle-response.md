# Connector `getnet` / Suite `get` / Scenario `sync_payment_with_handle_response`
...
date: Tue, 24 Mar 2026 07:02:10 GMT
x-request-id: get_sync_payment_with_handle_response_req
...
{
  "merchant_transaction_id": "mti_358e5f47139b4dddac016a4b",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "riley.3335@sandbox.example.com"
    },
    "id": "cust_97ec871d28d3408ca5aeeee5",
    "phone_number": "+917717265280"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "7742 Market Ln"
      },
      "line2": {
        "value": "3827 Oak Dr"
      },
      "line3": {
        "value": "2958 Sunset Ln"
      },
      "city": {
        "value": "San Francisco"
      },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:02:09 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
