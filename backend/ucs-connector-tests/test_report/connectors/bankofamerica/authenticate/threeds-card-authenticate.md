# Connector `bankofamerica` / Suite `authenticate` / Scenario `threeds_card_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "jordan.8502@example.com"
    },
    "id": "cust_f629bc075f5941c5a5701ddc",
    "phone_number": "+446665871982"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.3685@sandbox.example.com"
      },
      "phone_number": {
        "value": "2283232890"
      },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_0d270f5d93964d36ae263198"
  },
  "metadata": {
    "value": "{}"
  },
