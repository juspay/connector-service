# Connector `nmi` / Suite `authenticate` / Scenario `threeds_card_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ava Taylor",
    "email": {
      "value": "casey.7918@testmail.io"
    },
    "id": "cust_096982facb6845cbb0a1745b",
    "phone_number": "+912927607130"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.1948@sandbox.example.com"
      },
      "phone_number": {
        "value": "3629950087"
      },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_33d8afc2d99f47d486187475"
  },
  "metadata": {
    "value": "{}"
  },
