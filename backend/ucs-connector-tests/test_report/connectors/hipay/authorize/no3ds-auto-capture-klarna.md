# Connector `hipay` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_8119748b1e354816abb1459f",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Taylor",
    "email": {
      "value": "riley.6813@testmail.io"
    },
    "id": "cust_ce38fbc1f3ff481bb628a487",
    "phone_number": "+19580020906"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.6687@sandbox.example.com"
      },
      "phone_number": {
        "value": "8164672049"
      },
