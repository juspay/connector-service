# Connector `hipay` / Suite `authorize` / Scenario `no3ds_auto_capture_bancontact`
...
{
  "merchant_transaction_id": "mti_db94c92e1a704cc1bf46b536",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "morgan.6002@example.com"
    },
    "id": "cust_b9ce5150e597468ab64993da",
    "phone_number": "+919264983463"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "BE",
      "email": {
        "value": "morgan.5828@sandbox.example.com"
      },
      "phone_number": {
        "value": "8936163273"
      },
