# Connector `iatapay` / Suite `capture` / Scenario `capture_full_amount`
...
{
  "merchant_transaction_id": "mti_127b0eaf12bd4ae4b674db46",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Smith",
    "email": {
      "value": "morgan.9473@sandbox.example.com"
    },
    "id": "cust_6ce13d139cd0454d8bb6306b",
    "phone_number": "+16667025559"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "3038 Main Blvd"
      },
      "line2": {
        "value": "3635 Sunset St"
      },
      "line3": {
        "value": "2194 Lake Dr"
      },
      ...
      "email": {
        "value": "casey.7629@sandbox.example.com"
      },
      "phone_number": {
        "value": "3629951594"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.5605@sandbox.example.com"
      },
      "phone_number": {
        "value": "2681506334"
      },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:02:54 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_444f1cf7add944b38d5d966e",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
