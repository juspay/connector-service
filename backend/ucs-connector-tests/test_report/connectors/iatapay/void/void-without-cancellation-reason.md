# Connector `iatapay` / Suite `void` / Scenario `void_without_cancellation_reason`
...
{
  "merchant_transaction_id": "mti_f42029d412be454f814e1afc",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Smith",
    "email": {
      "value": "alex.3831@testmail.io"
    },
    "id": "cust_7ceca755294e495cb1446473",
    "phone_number": "+13437413262"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_266cfb10f1fb40e0bb6a88bc",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
