# Connector `iatapay` / Suite `void` / Scenario `void_authorized_payment`
...
{
  "merchant_transaction_id": "mti_3d17ce96e6624ea49bebecfa",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "sam.8063@example.com"
    },
    "id": "cust_41c0a64455a746f0bc3f4547",
    "phone_number": "+911805675794"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.6142@sandbox.example.com"
      },
      "phone_number": {
        "value": "3180695861"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_9df10d14257b400ebd955c7d",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
