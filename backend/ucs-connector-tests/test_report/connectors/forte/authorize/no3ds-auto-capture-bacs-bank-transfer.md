# Connector `forte` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_43f34ce178454ceabc354579",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "casey.7364@testmail.io"
    },
    "id": "cust_cdf31b4e9d06423a8251f1b4",
    "phone_number": "+911993356213"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:15 GMT
x-request-id: authorize_no3ds_auto_capture_bacs_bank_transfer_req
