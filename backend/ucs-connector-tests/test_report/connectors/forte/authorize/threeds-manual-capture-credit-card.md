# Connector `forte` / Suite `authorize` / Scenario `threeds_manual_capture_credit_card`
...
{
  "merchant_transaction_id": "mti_bf86c95d6ad5424e8d5202a7",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "casey.2464@testmail.io"
    },
    "id": "cust_5319a30950804e8e84fc533b",
    "phone_number": "+12244055507"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:19 GMT
x-request-id: authorize_threeds_manual_capture_credit_card_req
