# Connector `forte` / Suite `authorize` / Scenario `no3ds_manual_capture_credit_card`
...
{
  "merchant_transaction_id": "mti_6c1f42b15ce2400eb8db360a",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Miller",
    "email": {
      "value": "sam.5249@sandbox.example.com"
    },
    "id": "cust_927a5945ff9044a3bb7cc0d1",
    "phone_number": "+443603361216"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:18 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req
