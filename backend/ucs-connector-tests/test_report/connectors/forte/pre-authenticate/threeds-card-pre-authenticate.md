# Connector `forte` / Suite `pre_authenticate` / Scenario `threeds_card_pre_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ethan Smith",
    "email": {
      "value": "alex.5409@testmail.io"
    },
    "id": "cust_9f57281c62a34c81a1903f4a",
    "phone_number": "+12221317814"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.8538@sandbox.example.com"
      },
      "phone_number": {
        "value": "7878977335"
      },
