# Connector `forte` / Suite `post_authenticate` / Scenario `threeds_card_post_authenticate`
...
Response trailers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:24 GMT
x-request-id: authenticate_threeds_card_authenticate_req
Sent 1 request and received 0 responses
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ava Taylor",
    "email": {
      "value": "jordan.7406@example.com"
    },
    "id": "cust_9a20d4169a05435c91d31c8e",
    "phone_number": "+916921301224"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "2619 Sunset Ln"
      },
      "line3": {
        "value": "3184 Pine Blvd"
      },
      "city": {
        "value": "Los Angeles"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.1325@sandbox.example.com"
      },
      "phone_number": {
        "value": "6828400826"
      },
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_0c3a5505552a4e5083e148e2"
  },
  "metadata": {
    "value": "{}"
  },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PostAuthenticate <<'JSON'
{
  ...
  "connector_order_reference_id": "gen_606153",
  "metadata": {
    "value": "{}"
  },
  "connector_feature_data": {
