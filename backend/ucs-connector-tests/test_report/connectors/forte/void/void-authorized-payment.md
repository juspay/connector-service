# Connector `forte` / Suite `void` / Scenario `void_authorized_payment`
...
{
  "merchant_customer_id": "mcui_797c600e26df429380f755dc",
  "customer_name": "Ava Brown",
  "email": {
    "value": "morgan.6468@testmail.io"
  },
  "phone_number": "+913477812237",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Mia"
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "6208 Sunset Dr"
      },
      "line2": {
        "value": "2156 Main Ave"
      },
      "line3": {
        "value": "1808 Sunset Ave"
      },
      "city": {
        "value": "New York"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.7251@sandbox.example.com"
      },
      "phone_number": {
        "value": "5972995224"
      },
...
{
  "merchant_transaction_id": "mti_1a8999d8dab54466bfa1a955",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "casey.6096@testmail.io"
    },
    "id": "cust_7d0d1f941a3649b2ad99bb21",
    "phone_number": "+448953540710"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_95878a231bf44ef69dac9090",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
