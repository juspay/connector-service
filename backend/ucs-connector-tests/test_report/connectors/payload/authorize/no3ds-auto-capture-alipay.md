# Connector `payload` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_6c9a872d1c114d7385c3346f66c763ca",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "riley.5034@example.com"
    },
    "id": "cust_757e54b288524effa713978a5722426e",
    "phone_number": "+913742052511"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.3316@sandbox.example.com"
      },
      "phone_number": {
        "value": "6023422177"
      },
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      "code": "BAD_REQUEST",
      "message": "Wallet is not supported by Payload"
    }
  },
  "statusCode": 400
}
