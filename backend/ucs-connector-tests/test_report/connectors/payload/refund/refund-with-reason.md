...
{
  "merchant_transaction_id": "mti_c547f6c9529b48b3a975c10628d93a96",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Smith",
    "email": {
      "value": "casey.8408@example.com"
    },
    "id": "cust_ba3bc16ee9274affb7f5d9557efd816e",
    "phone_number": "+442989875878"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.2415@sandbox.example.com"
      },
      "phone_number": {
        "value": "7663895097"
      },
...
date: Mon, 23 Mar 2026 16:23:13 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "txn_3fCKm9zCdU3uMAVlVWqQw",
  "connectorTransactionId": "txn_3fCKm9zCdU3uMAVlVWqQw",
  "status": "FAILURE",
  "error": {
    "issuerDetails": {
      "networkDetails": {}
...
{
  "merchant_refund_id": "mri_875bd11dba694f45a3d4b8bd4f6e1330",
  "connector_transaction_id": "txn_3fCKm9zCdU3uMAVlVWqQw",
  "payment_amount": 6000,
  "refund_amount": {
    "minor_amount": 6000,
    "currency": "USD"
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:23:14 GMT
x-request-id: refund_refund_with_reason_req
