# Connector `payload` / Suite `setup_recurring` / Scenario `setup_recurring_with_order_context`
...
{
  "merchant_recurring_payment_id": "mrpi_8ed8596c78394fb4ad614d0f459092d4",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Taylor",
    "email": {
      "value": "casey.9817@testmail.io"
    },
    "id": "cust_f21547ed5eff4bdb902f437bf4017272",
    "phone_number": "+917364300821"
  },
  "browser_info": {
  ...
  "address": {
    "billing_address": {
      ...
      "line1": {
        "value": "2639 Sunset Rd"
      },
      "line2": {
        "value": "6567 Sunset Ln"
      },
      "line3": {
        "value": "1531 Lake Ave"
      },
      ...
      "email": {
        "value": "alex.9121@sandbox.example.com"
      },
      "phone_number": {
        "value": "9502332492"
      },
