# Connector `globalpay` / Suite `capture` / Scenario `capture_with_merchant_order_id`
...
{
  "merchant_customer_id": "mcui_6cf7a7f96f3e4eedb818d518",
  "customer_name": "Liam Brown",
  "email": {
    "value": "sam.1317@example.com"
  },
  "phone_number": "+13757441754",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Liam"
      ...
      "email": {
        "value": "morgan.1025@sandbox.example.com"
      },
      "phone_number": {
        "value": "2524622573"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.8223@sandbox.example.com"
      },
      "phone_number": {
        "value": "1519408853"
      },
...
{
  "merchant_transaction_id": "mti_5983686b440542b18557f842",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Taylor",
    "email": {
      "value": "alex.9819@testmail.io"
    },
    "id": "cust_9b65e25a24914c46a56aecb2",
    "phone_number": "+915623768216"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_7ca88b275d9645f1a2654203",
  "merchant_order_id": "gen_297900",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:51:52 GMT
x-request-id: capture_capture_with_merchant_order_id_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "x-request-id": "c6d18bac-d3b9-49a0-af45-57da482f69611659728.1",
    "x_global_transaction_id": "rrt-359691cc-c7bd-4482-8722-c9d780e2fd1f6g187",
    "x_global_transaction_id_source": "gp-apigee"
  },
  "state": {
    "accessToken": ***MASKED***
      "token": ***MASKED***
        "value": "jEIWuwYY9VgBTOIib3PFXBowwpCj"
      },
