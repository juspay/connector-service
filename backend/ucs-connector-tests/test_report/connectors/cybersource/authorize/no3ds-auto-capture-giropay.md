# Connector `cybersource` / Suite `authorize` / Scenario `no3ds_auto_capture_giropay`
...
{
  "merchant_transaction_id": "mti_82a5d84574a84874b20aaccb",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "morgan.9423@sandbox.example.com"
    },
    "id": "cust_e5c022351f304992bfa821dd",
    "phone_number": "+443339665455"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.2825@sandbox.example.com"
      },
      "phone_number": {
        "value": "3454757089"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "DE",
      "email": {
        "value": "casey.1532@sandbox.example.com"
      },
      "phone_number": {
        "value": "5460000945"
      },
