# Connector `cybersource` / Suite `authorize` / Scenario `no3ds_auto_capture_eps`
...
{
  "merchant_transaction_id": "mti_d3ae5416412a48d393249c74",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "riley.9421@testmail.io"
    },
    "id": "cust_ebd59dd48d204c3590b9e9f3",
    "phone_number": "+16861734074"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "jordan.7928@sandbox.example.com"
      },
      "phone_number": {
        "value": "4550899044"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "AT",
      "email": {
        "value": "jordan.9329@sandbox.example.com"
      },
      "phone_number": {
        "value": "4490087095"
      },
