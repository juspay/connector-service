# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_bc7552921c92495daec324e3",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Wilson",
    "email": {
      "value": "morgan.2316@example.com"
    },
    "id": "cust_b27dc7ef180745ffa5230802",
    "phone_number": "+912199516979",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method Wallet(AliPayRedirect(AliPayRedirection))"
    }
  },
  "statusCode": 501,
  "state": {
