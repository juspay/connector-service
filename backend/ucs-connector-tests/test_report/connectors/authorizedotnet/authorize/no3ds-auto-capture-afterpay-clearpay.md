# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_d0cc8c5bd51d443f9c396db5",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Smith",
    "email": {
      "value": "morgan.3111@example.com"
    },
    "id": "cust_d5fcd029ee49485cae414858",
    "phone_number": "+914917929085",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method PayLater(AfterpayClearpayRedirect)"
    }
  },
  "statusCode": 501,
  "state": {
