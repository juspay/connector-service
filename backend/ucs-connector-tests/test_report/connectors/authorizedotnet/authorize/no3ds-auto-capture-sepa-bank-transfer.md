# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_sepa_bank_transfer`
...
{
  "merchant_transaction_id": "mti_f38748c01bbd4050adf68dfc",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "sam.9334@example.com"
    },
    "id": "cust_e5099bd02fe44d73b7f816a8",
    "phone_number": "+446513279009",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankTransfer(SepaBankTransfer)"
    }
  },
  "statusCode": 501,
  "state": {
