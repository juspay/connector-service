# Connector `wellsfargo` / Suite `authorize` / Scenario `no3ds_auto_capture_sepa_bank_transfer`
...
{
  "merchant_transaction_id": "mti_97439b8a93e34cc49b5e5af6ca0de88b",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ava Wilson",
    "email": {
      "value": "jordan.9240@sandbox.example.com"
    },
    "id": "cust_5877d30b8be94dc4be33ab3ef01a670c",
    "phone_number": "+916751592614"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:41:54 GMT
x-request-id: authorize_no3ds_auto_capture_sepa_bank_transfer_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      "code": "BAD_REQUEST",
      "message": "Payment method is not supported by Wellsfargo"
    }
  },
  "statusCode": 400
}
