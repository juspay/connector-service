# Connector `rapyd` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_60a8ef8e680d4d849a95af7b4b4bddba",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "casey.3947@testmail.io"
    },
    "id": "cust_d5714b3945114d6abffebb74432c4e66",
    "phone_number": "+443368857620"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.5743@sandbox.example.com"
      },
      "phone_number": {
        "value": "1223794951"
      },
