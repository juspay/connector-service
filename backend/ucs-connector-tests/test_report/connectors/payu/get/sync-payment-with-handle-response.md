# Connector `payu` / Suite `get` / Scenario `sync_payment_with_handle_response`
...
{
  "merchant_transaction_id": "mti_a773e3e6018f42bc9d2eb574",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "casey.3626@testmail.io"
    },
    "id": "cust_f9e56595ea624be3b96d0cb7",
    "phone_number": "+16003220468"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "9910 Market Ln"
      },
      "line2": {
        "value": "2808 Pine Dr"
      },
      "line3": {
        "value": "3652 Sunset St"
      },
      "city": {
        "value": "Chicago"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.4543@sandbox.example.com"
      },
      "phone_number": {
        "value": "3594089635"
      },
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "Unknown PayU sync error"
    }
  },
  "statusCode": 429,
  "responseHeaders": {
