# Connector `paybox` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_06a1a306114644c2978bfbaa",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ethan Miller",
    "email": {
      "value": "casey.8798@example.com"
    },
    "id": "cust_3a0b4b98630f4573baf679fc",
    "phone_number": "+16213096305"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "9546 Market Rd"
      },
      "line2": {
        "value": "6795 Lake St"
      },
      "line3": {
        "value": "3872 Lake Blvd"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "PL",
      "email": {
        "value": "sam.8313@sandbox.example.com"
      },
      "phone_number": {
        "value": "6680162142"
      },
