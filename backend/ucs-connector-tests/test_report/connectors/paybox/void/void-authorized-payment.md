# Connector `paybox` / Suite `void` / Scenario `void_authorized_payment`
...
{
  "merchant_transaction_id": "mti_683d57fbef1642e89c99e7f5",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Miller",
    "email": {
      "value": "riley.7048@testmail.io"
    },
    "id": "cust_3291d72886cf412c9a7c09f9",
    "phone_number": "+919216691374"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.3425@sandbox.example.com"
      },
      "phone_number": {
        "value": "8837958798"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_e01e0ab1b995480a8f559114",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
