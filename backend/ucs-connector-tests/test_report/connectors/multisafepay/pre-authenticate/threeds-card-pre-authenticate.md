# Connector `multisafepay` / Suite `pre_authenticate` / Scenario `threeds_card_pre_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "sam.3049@sandbox.example.com"
    },
    "id": "cust_81e3af1d642a45e3bac73efd",
    "phone_number": "+446060057836"
  },
  "address": {
    "shipping_address": {
      "first_name": {
