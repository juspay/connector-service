# Connector `multisafepay` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_8cad97e9827e4c56a3026a2f",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Selected payment method through multisafepay"
    }
  },
  "statusCode": 501
}
