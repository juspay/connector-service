# Connector `multisafepay` / Suite `capture` / Scenario `capture_partial_amount`
...
date: Mon, 23 Mar 2026 18:56:00 GMT
x-request-id: capture_capture_partial_amount_req
...
Response trailers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:55:59 GMT
x-request-id: create_customer_create_customer_req
Sent 1 request and received 0 responses
...
{
  "merchant_customer_id": "mcui_2df61e6bd9f6419f86c61ab2",
  "customer_name": "Ava Taylor",
  "email": {
    "value": "morgan.7735@testmail.io"
  },
  "phone_number": "+445598318806",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Liam"
...
{
  "merchant_transaction_id": "mti_fe3c0bdb74ef4709a0f3afe5",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "riley.4776@example.com"
    },
    "id": "cust_d1e6df00a5714a029552c879",
    "phone_number": "+18804138593"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_efa67159b8cc460b9bfce28e",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
