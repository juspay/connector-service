# Connector `nuvei` / Suite `setup_recurring` / Scenario `setup_recurring_with_order_context`
...
Response trailers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:21:09 GMT
x-request-id: create_customer_create_customer_req
Sent 1 request and received 0 responses
...
{
  "merchant_customer_id": "mcui_43cd4d491ac548959665968f760c750c",
  "customer_name": "Emma Smith",
  "email": {
    "value": "riley.8948@testmail.io"
  },
  "phone_number": "+16564615828",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
      ...
      "line1": {
        "value": "7138 Market St"
      },
      "line2": {
        "value": "1214 Pine Blvd"
      },
      "line3": {
        "value": "3945 Market Blvd"
      },
      "city": {
        "value": "New York"
      },
...
{
  "merchant_recurring_payment_id": "mrpi_cf011264c8914c2d8db5454b2f2452e6",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Smith",
    "email": {
      "value": "alex.3792@sandbox.example.com"
    },
    "id": "cust_8001610022b74f34b9f2c1a11e74472a",
    "phone_number": "+912371307018"
  },
  "browser_info": {
