# Connector `nuvei` / Suite `authorize` / Scenario `no3ds_fail_payment`
...
```text
assertion failed for field 'error.connector_details.message': expected 'Missing required field: session_token' to contain 'decline'
```
...
{
  "merchant_transaction_id": "mti_f461d77f44ce4487b504720b",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "sam.9163@example.com"
    },
    "id": "cust_af9739a74a484d9bb9161493",
    "phone_number": "+916275125171"
  },
  "browser_info": {
