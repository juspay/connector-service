# Connector `nuvei` / Suite `authenticate` / Scenario `threeds_card_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "riley.4735@sandbox.example.com"
    },
    "id": "cust_386111adf37544a9916c535b",
    "phone_number": "+918327920356"
  },
  "address": {
    "shipping_address": {
      "first_name": {
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_9ba54c89d90d43fba71b2160"
  },
  "metadata": {
    "value": "{}"
  },
