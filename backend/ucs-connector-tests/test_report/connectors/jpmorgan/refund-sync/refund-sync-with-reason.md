# Connector `jpmorgan` / Suite `refund_sync` / Scenario `refund_sync_with_reason`
...
date: Tue, 24 Mar 2026 05:47:25 GMT
x-request-id: refund_sync_refund_sync_with_reason_req
...
{
  "merchant_transaction_id": "mti_6dfdb0f2b54c417885076358",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Taylor",
    "email": {
      "value": "casey.5011@example.com"
    },
    "id": "cust_be2ddb279f244d81b91f7f9c",
    "phone_number": "+444795725080"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "1529 Market Dr"
      },
      "line2": {
        "value": "4519 Lake Blvd"
      },
      "line3": {
        "value": "1517 Sunset Ln"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.4736@sandbox.example.com"
      },
      "phone_number": {
        "value": "5659713503"
      },
...
{
  "merchant_refund_id": "mri_e40ebddf65d046ee8c9ce726",
