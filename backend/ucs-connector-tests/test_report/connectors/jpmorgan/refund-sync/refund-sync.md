# Connector `jpmorgan` / Suite `refund_sync` / Scenario `refund_sync`
...
{
  "merchant_transaction_id": "mti_f35e722696db4b4786e51bcd",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "casey.5681@sandbox.example.com"
    },
    "id": "cust_90441bbbd5b84bbbbf824d8a",
    "phone_number": "+447791208437"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.3610@sandbox.example.com"
      },
      "phone_number": {
        "value": "7344337991"
      },
...
{
  "merchant_refund_id": "mri_c8ab80b6d513475d92718e36",
