# Connector `jpmorgan` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_1af352dff73245a3b00f2ddf",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Johnson",
    "email": {
      "value": "riley.5195@sandbox.example.com"
    },
    "id": "cust_518b580eb52d4aa6aba8d1f1",
    "phone_number": "+443085011364"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.1983@sandbox.example.com"
      },
      "phone_number": {
        "value": "1228927071"
      },
