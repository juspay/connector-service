# Connector `jpmorgan` / Suite `authorize` / Scenario `no3ds_manual_capture_debit_card`
...
{
  "merchant_transaction_id": "mti_c75ee74fee2d471cb17426e6",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Smith",
    "email": {
      "value": "alex.3478@testmail.io"
    },
    "id": "cust_332c0bd735c24435875683ca",
    "phone_number": "+443779996361"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.7394@sandbox.example.com"
      },
      "phone_number": {
        "value": "4694569567"
      },
