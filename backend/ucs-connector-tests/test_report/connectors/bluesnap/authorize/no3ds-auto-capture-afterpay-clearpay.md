# Connector `bluesnap` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_887e947e9ce349abb02aec5b",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Brown",
    "email": {
      "value": "sam.3996@testmail.io"
    },
    "id": "cust_534bc70dfc274408a899950d",
    "phone_number": "+11967388115"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "4106 Main Blvd"
      },
      "line2": {
        "value": "8 Oak Ln"
      },
      "line3": {
        "value": "1765 Sunset Ave"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.6905@sandbox.example.com"
      },
      "phone_number": {
        "value": "4928517189"
      },
