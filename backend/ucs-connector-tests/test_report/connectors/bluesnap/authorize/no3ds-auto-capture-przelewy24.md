# Connector `bluesnap` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_9a22f534572c4773ab312aac",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "casey.1435@testmail.io"
    },
    "id": "cust_7262c1483dfc4cae8b5fba0f",
    "phone_number": "+446904730742"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "4244 Main Blvd"
      },
      "line3": {
        "value": "3445 Sunset Ave"
      },
      "city": {
        "value": "Seattle"
      },
      ...
      "country_alpha2_code": "PL",
      "email": {
        "value": "casey.5522@sandbox.example.com"
      },
      "phone_number": {
        "value": "4673567205"
      },
