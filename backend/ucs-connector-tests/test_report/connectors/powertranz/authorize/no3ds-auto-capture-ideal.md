# Connector `powertranz` / Suite `authorize` / Scenario `no3ds_auto_capture_ideal`
...
{
  "merchant_transaction_id": "mti_78dc2c0f82c3428ab51ed4b3",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "riley.5427@sandbox.example.com"
    },
    "id": "cust_a27546bde4e0403d9e427caa",
    "phone_number": "+443937800807"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.5475@sandbox.example.com"
      },
      "phone_number": {
        "value": "3028516222"
      },
