# Connector `powertranz` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_7f35c62f802d42238ecbd79d",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Johnson",
    "email": {
      "value": "riley.6894@testmail.io"
    },
    "id": "cust_0ff83f4551f843baaafd9d7d",
    "phone_number": "+442683061409"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.7471@sandbox.example.com"
      },
      "phone_number": {
        "value": "5275836394"
      },
