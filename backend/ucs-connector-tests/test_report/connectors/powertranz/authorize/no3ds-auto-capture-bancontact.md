# Connector `powertranz` / Suite `authorize` / Scenario `no3ds_auto_capture_bancontact`
...
{
  "merchant_transaction_id": "mti_30c6824654ff44e5b477157e",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ethan Wilson",
    "email": {
      "value": "jordan.9315@sandbox.example.com"
    },
    "id": "cust_b0dc94692e774f2f8b325a02",
    "phone_number": "+444373040228"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "BE",
      "email": {
        "value": "jordan.3225@sandbox.example.com"
      },
      "phone_number": {
        "value": "7430228368"
      },
