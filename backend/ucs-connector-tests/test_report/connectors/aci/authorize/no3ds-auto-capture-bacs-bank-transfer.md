# Connector `aci` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_b7fc888e402c4a2ebd44db2b",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Emma Smith",
    "email": {
      "value": "sam.1063@testmail.io"
    },
    "id": "cust_7de5bc3748d44e6695f65d2d",
    "phone_number": "+913519428759"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "jordan.7797@sandbox.example.com"
      },
      "phone_number": {
        "value": "5477363294"
      },
