# Connector `aci` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_ffffc84f98254fa5b6607851",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "alex.6971@example.com"
    },
    "id": "cust_c24644b69d1b48aba9bd51e4",
    "phone_number": "+13073776961"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.2126@sandbox.example.com"
      },
      "phone_number": {
        "value": "8696711998"
      },
...
date: Mon, 23 Mar 2026 18:24:49 GMT
x-request-id: authorize_no3ds_auto_capture_alipay_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Mon, 23 Mar 2026 18:24:49 GMT",
    "expires": "Mon, 23 Mar 2026 18:24:49 GMT",
    "pragma": "no-cache",
    "server": "ACI",
