# Connector `aci` / Suite `void` / Scenario `void_without_cancellation_reason`
...
{
  "merchant_transaction_id": "mti_c31b43f5a3304797bd519e02",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Brown",
    "email": {
      "value": "casey.1193@testmail.io"
    },
    "id": "cust_f7d9969564e948be9ba2a916",
    "phone_number": "+441211634937"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "8503 Sunset Ln"
      },
      "line2": {
        "value": "9609 Market Ln"
      },
      "line3": {
        "value": "3325 Sunset Ave"
      },
      "city": {
        "value": "Seattle"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.1420@sandbox.example.com"
      },
      "phone_number": {
        "value": "7168630365"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_a8a1f31c3c424fcba5da8795",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
