# Connector `novalnet` / Suite `authorize` / Scenario `no3ds_auto_capture_sepa_bank_transfer`
...
{
  "merchant_transaction_id": "mti_a0262fe3fc0e4d4d9b85ab07",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "casey.1052@example.com"
    },
    "id": "cust_40cacdd095f447ca9058a0cc",
    "phone_number": "+915714099901"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "DE",
      "email": {
        "value": "morgan.5074@sandbox.example.com"
      },
      "phone_number": {
        "value": "1466010533"
      },
