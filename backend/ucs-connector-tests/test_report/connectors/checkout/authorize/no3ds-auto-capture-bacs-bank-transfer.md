# Connector `checkout` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_a20c61a28c1f43028d279d54",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Mia Johnson",
    "email": {
      "value": "sam.5722@sandbox.example.com"
    },
    "id": "cust_de0043c2c6f34ea08ba659fb",
    "phone_number": "+15553223800"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.9789@sandbox.example.com"
      },
      "phone_number": {
        "value": "5162880526"
      },
