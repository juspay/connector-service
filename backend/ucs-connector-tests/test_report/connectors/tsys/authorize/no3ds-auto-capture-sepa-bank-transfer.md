# Connector `tsys` / Suite `authorize` / Scenario `no3ds_auto_capture_sepa_bank_transfer`
...
{
  "merchant_transaction_id": "mti_6cf75a36ffc044689f5cb4762e99c0c7",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "morgan.1264@example.com"
    },
    "id": "cust_3e407acd0e6944089cc1a0eeb8089c61",
    "phone_number": "+446922048493"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:38:36 GMT
x-request-id: authorize_no3ds_auto_capture_sepa_bank_transfer_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method not implemented"
    }
  },
  "statusCode": 501
}
