# Connector `fiserv` / Suite `authorize` / Scenario `no3ds_auto_capture_ach_bank_transfer`
...
{
  "merchant_transaction_id": "mti_52bbec4bb6904effa8791327",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Miller",
    "email": {
      "value": "riley.8080@sandbox.example.com"
    },
    "id": "cust_b4f4a12338254f5f865920b4",
    "phone_number": "+919505676939"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.6493@sandbox.example.com"
      },
      "phone_number": {
        "value": "7820832162"
      },
