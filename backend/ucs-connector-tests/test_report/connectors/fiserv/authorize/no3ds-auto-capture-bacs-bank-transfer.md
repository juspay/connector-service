# Connector `fiserv` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_c365b8f62add4cbaa7db6918",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "morgan.4709@testmail.io"
    },
    "id": "cust_66cb16128e054f3b997ac1c1",
    "phone_number": "+16267680025"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "GB",
      "email": {
        "value": "morgan.3181@sandbox.example.com"
      },
      "phone_number": {
        "value": "2778881156"
      },
