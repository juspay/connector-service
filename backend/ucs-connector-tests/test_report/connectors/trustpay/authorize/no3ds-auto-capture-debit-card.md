# Connector `trustpay` / Suite `authorize` / Scenario `no3ds_auto_capture_debit_card`
...
{
  "merchant_transaction_id": "mti_0e09ee75025845ae9ee80ab6371cff45",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Wilson",
    "email": {
      "value": "morgan.2092@testmail.io"
    },
    "id": "cust_ce79946a88b1460b8239aee30545bb64",
    "phone_number": "+14589260209"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:36:16 GMT
x-request-id: authorize_no3ds_auto_capture_debit_card_req
