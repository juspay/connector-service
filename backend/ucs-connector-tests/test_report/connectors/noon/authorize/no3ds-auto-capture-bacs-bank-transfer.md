# Connector `noon` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_1a9223f0c2d043c287ad2d88",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Ava Smith",
    "email": {
      "value": "jordan.1555@testmail.io"
    },
    "id": "cust_fc5d7ef8af514d58bd6d012f",
    "phone_number": "+917671649232"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "morgan.4314@sandbox.example.com"
      },
      "phone_number": {
        "value": "4943967115"
      },
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "8227 Market Rd"
      },
      "line3": {
        "value": "5750 Market St"
      },
      "city": {
        "value": "New York"
      },
