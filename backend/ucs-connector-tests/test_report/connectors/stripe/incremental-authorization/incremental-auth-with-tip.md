# Connector `stripe` / Suite `incremental_authorization` / Scenario `incremental_auth_with_tip`
...
grpcurl -plaintext \
  -H "x-merchant-id: test_merchant" \
  -H "x-tenant-id: default" \
  -H "x-request-id: incremental_authorization_incremental_auth_with_tip_req" \
  -H "x-connector-request-reference-id: incremental_authorization_incremental_auth_with_tip_ref" \
  -H "x-connector-config: ***MASKED***" \
...
Request metadata to send:
x-connector-config: ***MASKED***
x-connector-request-reference-id: incremental_authorization_incremental_auth_with_tip_ref
x-merchant-id: test_merchant
x-request-id: incremental_authorization_incremental_auth_with_tip_req
x-tenant-id: default
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Tue, 24 Mar 2026 08:50:32 GMT",
    "idempotency-key": "6df8553d-1738-4ac7-af91-7a5e602a9afa",
    "original-request": "req_T40syPESsxR0sI",
    "request-id": "req_T40syPESsxR0sI",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-version": "2022-11-15",
    "vary": "Origin",
