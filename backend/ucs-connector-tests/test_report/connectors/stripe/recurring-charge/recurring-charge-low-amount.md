# Connector `stripe` / Suite `recurring_charge` / Scenario `recurring_charge_low_amount`
...
{
  "merchant_charge_id": "mchi_1442cb6cdab648b2a2d9b2977f63c79b",
  "connector_recurring_payment_id": {
    "connector_mandate_id": {
      "connector_mandate_id": "cmi_179dea0357d04b16ac155f134f9f54ff"
    }
  },
  "amount": {
    "minor_amount": 6000,
...
Response contents:
{
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "No such PaymentMethod: 'cmi_179dea0357d04b16ac155f134f9f54ff'; It's possible this PaymentMethod exists on one of your connected accounts, in which case you should retry this request on that connected account. Learn more at https://stripe.com/docs/connect/authentication",
      "reason": "No such PaymentMethod: 'cmi_179dea0357d04b16ac155f134f9f54ff'; It's possible this PaymentMethod exists on one of your connected accounts, in which case you should retry this request on that connected account. Learn more at https://stripe.com/docs/connect/authentication"
    }
  },
  "statusCode": 400,
  "responseHeaders": {
    ...
    "idempotency-key": "122ae58f-5f1f-4fd7-a597-023e4678117e",
    "original-request": "req_NqM1dseyZCFOyL",
    "request-id": "req_NqM1dseyZCFOyL",
    "server": "nginx",
    "strict-transport-security": "max-age=63072000; includeSubDomains; preload",
    "stripe-version": "2022-11-15",
    "vary": "Origin",
  ...
  "rawConnectorRequest": {
    "value": "{\"url\":\"https://api.stripe.com/v1/payment_intents\",\"method\":\"POST\",\"headers\":{\"via\":\"HyperSwitch\",\"Authorization\":\"Bearer ***MASKED***",\"stripe-version\":\"2022-11-15\",\"Content-Type\":\"application/x-www-form-urlencoded\"},\"body\":\"amount=6000\u0026currency=USD\u0026metadata%5Border_id%5D=mchi_1442cb6cdab648b2a2d9b2977f63c79b\u0026return_url=https%3A%2F%2Fjuspay.in%2F\u0026confirm=true\u0026payment_method=cmi_179dea0357d04b16ac155f134f9f54ff\u0026customer=cus_U8SJr1fMbLIR7j\u0026capture_method=automatic\u0026payment_method_types%5B0%5D=card\u0026expand%5B0%5D=latest_charge\"}"
  }
}
