# Connector `billwerk` / Suite `capture` / Scenario `capture_partial_amount`
...
{
  "merchant_transaction_id": "mti_b74eac0923f148349ce66f05",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Brown",
    "email": {
      "value": "jordan.8049@example.com"
    },
    "id": "cust_a4a398aaef3c424abf802ccd",
    "phone_number": "+449096340723"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "2238 Market Ave"
      },
      "line3": {
        "value": "9489 Lake Blvd"
      },
      "city": {
        "value": "New York"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_014ff6eb51134f9d8a8506aa",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 06:58:45 GMT",
    "request-id": "711b8039f442dadc5743db35b6900602",
