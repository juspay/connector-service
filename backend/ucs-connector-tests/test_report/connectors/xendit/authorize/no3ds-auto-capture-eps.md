# Connector `xendit` / Suite `authorize` / Scenario `no3ds_auto_capture_eps`
...
{
  "merchant_transaction_id": "mti_52201d35c6884306aa5a26a6",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Taylor",
    "email": {
      "value": "morgan.4013@example.com"
    },
    "id": "cust_27648adddc7242cab3aee145",
    "phone_number": "+18823792729"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.5949@sandbox.example.com"
      },
      "phone_number": {
        "value": "5653557510"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "AT",
      "email": {
        "value": "morgan.2754@sandbox.example.com"
      },
      "phone_number": {
        "value": "5075045571"
      },
