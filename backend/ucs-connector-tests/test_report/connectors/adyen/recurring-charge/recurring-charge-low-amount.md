# Connector `adyen` / Suite `recurring_charge` / Scenario `recurring_charge_low_amount`
...
ERROR:
  ...
  Message: Missing required field: return_url
```
...
{
  "merchant_charge_id": "mchi_e4f34042ec4e426294dc7ec8",
