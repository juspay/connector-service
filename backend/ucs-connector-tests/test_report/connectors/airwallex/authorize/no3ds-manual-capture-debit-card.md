# Connector `airwallex` / Suite `authorize` / Scenario `no3ds_manual_capture_debit_card`
...
{
  "merchant_transaction_id": "mti_2101360cca2540a2846ba84b",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Taylor",
    "email": {
      "value": "riley.2917@example.com"
    },
    "id": "cust_5ca482b6097246d6831c7822",
    "phone_number": "+444861177512"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.2975@sandbox.example.com"
      },
      "phone_number": {
        "value": "1394018842"
      },
