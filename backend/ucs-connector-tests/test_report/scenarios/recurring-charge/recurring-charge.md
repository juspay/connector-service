...
|:----------|:------:|:--------------|
| `authorizedotnet` | [FAIL](./scenarios/recurring-charge/recurring-charge.md#connector-authorizedotnet) | `create_customer(create_customer)` (PASS) -> `setup_recurring(setup_recurring)` (PASS) |
| `paypal` | [FAIL](./scenarios/recurring-charge/recurring-charge.md#connector-paypal) | `create_access_token(create_access_token)` (PASS) -> `setup_recurring(setup_recurring)` (PASS) |
| `stripe` | [FAIL](./scenarios/recurring-charge/recurring-charge.md#connector-stripe) | `create_customer(create_customer)` (PASS) -> `setup_recurring(setup_recurring)` (PASS) |
...
{
  "merchant_charge_id": "mchi_a262b84d7f7344018176131af473d733",
  "connector_recurring_payment_id": {
    "connector_mandate_id": {
      "connector_mandate_id": "cmi_0c0fa80355ca428cac7b02ba5a01eea8"
    }
  },
  "amount": {
    "minor_amount": 6000,
...
grpcurl -plaintext \
  ...
  -d @ localhost:8000 types.RecurringPaymentService/Charge <<'JSON'
{
  "merchant_charge_id": "mchi_8ca96c6fb5d34e969bc82e6be47b8c51",
  "connector_recurring_payment_id": {
    "connector_mandate_id": {
      "connector_mandate_id": "cmi_9d26be4e9fee4736aa72e43d20bd30b1"
    }
  },
  "amount": {
    "minor_amount": 6000,
...
Response headers received:
content-type: application/grpc
date: Thu, 12 Mar 2026 15:42:27 GMT
x-request-id: recurring_charge_recurring_charge_req
...
Response contents:
{
  "error": {
    ...
    "connectorDetails": {
      ...
      "reason": "{\"name\":\"INTERNAL_SERVER_ERROR\",\"details\":[{\"issue\":\"INTERNAL_SERVER_ERROR\",\"description\":\"INTERNAL_SERVER_ERROR\"}],\"message\":\"An internal server error has occurred.\",\"debug_id\":\"f2763104e2353\",\"links\":[{\"href\":\"https://developer.paypal.com/api/rest/reference/orders/v2/errors/#INTERNAL_SERVER_ERROR\",\"rel\":\"information_link\",\"method\":\"GET\"}]}"
    }
  },
  "statusCode": 500,
  "responseHeaders": {
    ...
    "edge-control": "max-age=0",
    "http_x_pp_az_locator": "ccg18.slc",
    "paypal-debug-id": "f2763104e2353",
    "server": "nginx",
    "server-timing": "traceparent;desc=\"00-0000000000000000000f2763104e2353-1d97197de99af65b-01\"",
    "strict-transport-security": "max-age=31536000; includeSubDomains",
    "vary": "Accept-Encoding",
    "via": "1.1 varnish, 1.1 varnish",
    "x-cache": "MISS, MISS",
    ...
    "x-timer": "S1773330146.884128,VS0,VE2087"
  },
  "state": {
    "accessToken": ***MASKED***
      "token": ***MASKED***
  ...
  "rawConnectorRequest": {
    "value": "{\"url\":\"https://api-m.sandbox.paypal.com/v2/checkout/orders\",\"method\":\"POST\",\"headers\":{\"Content-Type\":\"application/json\",\"via\":\"HyperSwitch\",\"PayPal-Partner-Attribution-Id\":\"HyperSwitchlegacy_Ecom\",\"PayPal-Request-Id\":\"mchi_8ca96c6fb5d34e969bc82e6be47b8c51\",\"Prefer\":\"return=representation\",\"Authorization\":\"Bearer ***MASKED***"},\"body\":{\"intent\":\"CAPTURE\",\"purchase_units\":[{\"reference_id\":\"mchi_8ca96c6fb5d34e969bc82e6be47b8c51\",\"invoice_id\":\"mchi_8ca96c6fb5d34e969bc82e6be47b8c51\",\"custom_id\":null,\"amount\":{\"currency_code\":\"USD\",\"value\":\"60.00\",\"breakdown\":{\"item_total\":{\"currency_code\":\"USD\",\"value\":\"60.00\"},\"tax_total\":null,\"shipping\":{\"currency_code\":\"USD\",\"value\":\"0.00\"}}},\"shipping\":{\"address\":null,\"name\":{\"full_name\":null}},\"items\":[{\"name\":\"Payment for invoice mchi_8ca96c6fb5d34e969bc82e6be47b8c51\",\"quantity\":1,\"unit_amount\":{\"currency_code\":\"USD\",\"value\":\"60.00\"},\"tax\":null}]}],\"payment_source\":{\"card\":{\"vault_id\":\"cmi_9d26be4e9fee4736aa72e43d20bd30b1\"}}}}"
  }
}
