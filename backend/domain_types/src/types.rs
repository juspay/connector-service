    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            metadata: value
                ...
                .transpose()?,
            merchant_order_reference_id: value.merchant_order_id,
...
impl ForeignFrom<grpc_api_types::payments::TransactionStatus> for common_enums::TransactionStatus {
    fn foreign_from(value: grpc_api_types::payments::TransactionStatus) -> Self {
        match value {
            grpc_api_types::payments::TransactionStatus::Unspecified | grpc_api_types::payments::TransactionStatus::Success => Self::Success,
            ...
            PaymentsResponseData::TransactionResponse {
                ...
                PaymentServiceAuthorizeResponse {
                    ...
                    redirection_data: redirection_data
                        ...
                        .transpose()?,
                    feature_data: convert_connector_metadata_to_secret_string(connector_metadata),
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: extract_connector_request_reference_id(
                &value.merchant_registration_id,
            ),
            customer_id: value
                .customer
                .clone()
    ...
    let response = match transaction_response {
        Ok(response) => match response {
            PaymentsResponseData::TransactionResponse {
                ...
                PaymentServiceRegisterAutoDebitResponse {
                    ...
                    network_transaction_id: network_txn_id,
                    merchant_registration_id: connector_response_reference_id.map(|id| grpc_api_types::payments::Identifier {
                        id_type: Some(grpc_api_types::payments::identifier::IdType::Id(id)),
                    }),
                    status: grpc_status as i32,
                    mandate_reference: mandate_reference_grpc,
        ...
        Err(err) => {
            ...
            PaymentServiceRegisterAutoDebitResponse {
                ...
                redirection_data: None,
                network_transaction_id: None,
                merchant_registration_id: err.connector_transaction_id.map(|id| {
                    grpc_api_types::payments::Identifier {
                        id_type: Some(grpc_api_types::payments::identifier::IdType::Id(id)),
                    }
                }),
        ...
        Ok(response) => match response {
            PaymentsResponseData::TransactionResponse {
                ...
                grpc_api_types::payments::RecurringPaymentServiceChargeResponse {
                    ...
                    feature_data: convert_connector_metadata_to_secret_string(
                        connector_metadata,
                    ),
