...
use crate::{connector_types, payment_method_data::SamsungPayWalletCredentials, utils::extract_connector_request_reference_id};
use common_enums::{
...
impl ForeignTryFrom<
    grpc_api_types::payments::samsung_wallet::PaymentCredential
