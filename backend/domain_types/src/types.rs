    ...
    fn foreign_try_from(
        ...
        match value.payment_method {
            Some(data) => match data {
                ...
                grpc_api_types::payments::payment_method::PaymentMethod::Upi(upi_type) => {
                    match upi_type.upi_type {
                        Some(grpc_api_types::payments::upi_payment_method_type::UpiType::UpiCollect(upi_collect)) => Ok(
                        ...
                        Some(grpc_api_types::payments::upi_payment_method_type::UpiType::UpiIntent(_upi_intent)) => Ok(
...
impl ForeignTryFrom<(PaymentServiceVoidRequest, Connectors)> for PaymentFlowData {
    ...
    fn foreign_try_from(
        ...
        let address: PaymentAddress =
            { crate::payment_address::PaymentAddress::new(None, None, None, Some(false)) };
        Ok(Self {
            merchant_id: common_utils::id_type::MerchantId::default(),
            payment_id: "IRRELEVANT_PAYMENT_ID".to_string(),
            attempt_id: "IRRELEVANT_ATTEMPT_ID".to_string(),
...
impl ForeignTryFrom<grpc_api_types::payments::PaymentMethod> for common_enums::PaymentMethod {
    ...
    fn foreign_try_from(
        ...
        match item {
            ...
            grpc_api_types::payments::PaymentMethod {
                payment_method:
                    Some(grpc_api_types::payments::payment_method::PaymentMethod::Upi(_)),
            } => Ok(Self::Upi),
