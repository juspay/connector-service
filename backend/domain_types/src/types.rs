    ...
    match transaction_response {
        ...
        Err(e) => {
            ...
            Ok(PaymentServiceVoidResponse {
                ...
                merchant_transaction_id: e.connector_transaction_id,
                status: status as i32,
                error: Some(grpc_api_types::payments::ErrorInfo {
                    unified_details: None,
                    connector_details: Some(grpc_api_types::payments::ConnectorErrorDetails {
    ...
    )> for DisputeFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            connector_request_reference_id: value.merchant_dispute_id.clone(),
            raw_connector_response: None,
            raw_connector_request: None,
            connector_response_headers: None,
        })
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            address,
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: value.merchant_reverse_id,
            customer_id: None,
            connector_customer: None,
            description: None,
            return_url: None,
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            address,
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: value.merchant_authorization_id,
            customer_id: None,
            connector_customer: None,
            description: None,
            return_url: None,
...
impl ForeignTryFrom<grpc_api_types::payments::PaymentServiceRefundRequest> for RefundsData {
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            refund_id: value.merchant_refund_id.clone(),
            connector_transaction_id,
        ...
        Ok(response) => match response {
            PaymentsResponseData::TransactionResponse {
                ...
                PaymentServiceSetupRecurringResponse {
                    ...
                    network_transaction_id: network_txn_id,
                    merchant_recurring_payment_id: connector_response_reference_id,
                    status: grpc_status as i32,
                    mandate_reference: mandate_reference_grpc,
                    incremental_authorization_allowed,
                    error: None,
...
impl ForeignTryFrom<(DisputeServiceDefendRequest, Connectors)> for DisputeFlowData {
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            connector_request_reference_id: value.merchant_dispute_id,
            raw_connector_response: None,
            raw_connector_request: None,
            connector_response_headers: None,
        })
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            address,
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: value.merchant_order_id,
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            address,
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: value.merchant_session_id.clone(),
            customer_id: None,
            connector_customer: None,
            description: None,
            return_url: None,
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            address,
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: value.merchant_payment_method_id.clone(),
            customer_id: value
                .customer
                .clone()
                .and_then(|customer| customer.id)
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            connector_request_reference_id: value.merchant_order_id.clone(),
            customer_id: None,
            connector_customer: None,
            description: value.description,
            return_url: value.return_url.clone(),
    ...
    )> for PaymentFlowData
{
    ...
    fn foreign_try_from(
        ...
        Ok(Self {
            ...
            address: PaymentAddress::default(),
            auth_type: common_enums::AuthenticationType::default(),
            connector_request_reference_id: value.merchant_revoke_id.clone(),
            customer_id: None,
            connector_customer: None,
