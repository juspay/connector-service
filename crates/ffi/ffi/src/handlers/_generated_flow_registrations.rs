...
use crate::services::payments::{
    ...
    create_sdk_session_token_req_transformer, create_sdk_session_token_res_transformer,
...
impl_flow_handlers!(create_sdk_session_token, MerchantAuthenticationServiceCreateSdkSessionTokenRequest, MerchantAuthenticationServiceCreateSdkSessionTokenResponse, create_sdk_session_token_req_transformer, create_sdk_session_token_res_transformer);
