...
pub(crate) fn authorize_pm_variants() -> Vec<(&'static str, fn() -> PaymentMethod)> {
    vec![
        ...
        ("GoPay", gopay_method as fn() -> PaymentMethod),
        ("GCash", gcash_method as fn() -> PaymentMethod),
        ("Momo", momo_method as fn() -> PaymentMethod),
        ("Dana", dana_method as fn() -> PaymentMethod),
        ("KakaoPay", kakaopay_method as fn() -> PaymentMethod),
        ("TouchNGo", touchn_go_method as fn() -> PaymentMethod),
        ("Twint", twint_method as fn() -> PaymentMethod),
