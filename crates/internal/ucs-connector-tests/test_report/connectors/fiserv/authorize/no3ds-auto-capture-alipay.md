# Connector `fiserv` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_f9bb7ac61ec14a89bda40763",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Brown",
    "email": {
      "value": "morgan.9348@testmail.io"
    },
    "id": "cust_4d4a79e5bb9441e9aa3b6b6f",
    "phone_number": "+917874150042"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.4441@sandbox.example.com"
      },
      "phone_number": {
        "value": "7649848711"
      },
...
date: Tue, 24 Mar 2026 07:41:36 GMT
x-request-id: authorize_no3ds_auto_capture_alipay_req
