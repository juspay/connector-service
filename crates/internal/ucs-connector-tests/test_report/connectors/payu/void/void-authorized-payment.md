# Connector `payu` / Suite `void` / Scenario `void_authorized_payment`
...
{
  "merchant_transaction_id": "mti_6f4d24759c194ec7a24aae4e",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Smith",
    "email": {
      "value": "riley.3408@example.com"
    },
    "id": "cust_415f13ef8f454cc5911c6afa",
    "phone_number": "+441046354908"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_6c5ed37dca534288b16568cd",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
