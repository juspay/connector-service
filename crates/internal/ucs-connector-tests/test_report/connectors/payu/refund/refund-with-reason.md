# Connector `payu` / Suite `refund` / Scenario `refund_with_reason`
...
{
  "merchant_transaction_id": "mti_3f51c76eda624dae947bf981",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Miller",
    "email": {
      "value": "riley.5930@example.com"
    },
    "id": "cust_35f46d373d29442abf175fa4",
    "phone_number": "+16851688880"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.5051@sandbox.example.com"
      },
      "phone_number": {
        "value": "7410867935"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "8846 Main Blvd"
      },
      "line2": {
        "value": "7399 Lake St"
      },
      "line3": {
        "value": "1932 Market Dr"
      },
      "city": {
        "value": "New York"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.1273@sandbox.example.com"
      },
      "phone_number": {
        "value": "5606896300"
      },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:05:42 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_b4dfcb70786b4aaaa28edd7d",
