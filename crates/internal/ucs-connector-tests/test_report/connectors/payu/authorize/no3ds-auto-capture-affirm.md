# Connector `payu` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_8d38bfe396f2403898c12aa3",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "alex.9313@sandbox.example.com"
    },
    "id": "cust_75eca12395bc47348652162f",
    "phone_number": "+19870156243"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.7804@sandbox.example.com"
      },
      "phone_number": {
        "value": "1870722609"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.2867@sandbox.example.com"
      },
      "phone_number": {
        "value": "4976800874"
      },
