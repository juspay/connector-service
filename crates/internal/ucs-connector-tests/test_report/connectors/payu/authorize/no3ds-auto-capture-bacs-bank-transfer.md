# Connector `payu` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_fcff7410a61342688722be65",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Emma Smith",
    "email": {
      "value": "sam.3184@example.com"
    },
    "id": "cust_9e9eda742646424fb903fa28",
    "phone_number": "+911264854850"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "GB",
      "email": {
        "value": "alex.3654@sandbox.example.com"
      },
      "phone_number": {
        "value": "8663307488"
      },
