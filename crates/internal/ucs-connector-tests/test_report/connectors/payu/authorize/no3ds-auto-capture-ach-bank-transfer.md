# Connector `payu` / Suite `authorize` / Scenario `no3ds_auto_capture_ach_bank_transfer`
...
{
  "merchant_transaction_id": "mti_ceddace34b134bfb99f516bf",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Smith",
    "email": {
      "value": "riley.9454@example.com"
    },
    "id": "cust_c448c8bad6f64ae2b5894072",
    "phone_number": "+19725194016"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.5859@sandbox.example.com"
      },
      "phone_number": {
        "value": "7812141402"
      },
