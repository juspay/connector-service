# Connector `cashtocode` / Suite `authorize` / Scenario `no3ds_auto_capture_bancontact`
...
{
  "merchant_transaction_id": "mti_7581646befa04c38b5c6ea81",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Mia Smith",
    "email": {
      "value": "riley.3132@sandbox.example.com"
    },
    "id": "cust_dd6c27ffec344c51a1fd029d",
    "phone_number": "+913972969669"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line2": {
        "value": "6605 Market Ln"
      },
      "line3": {
        "value": "8282 Market Rd"
      },
      "city": {
        "value": "Los Angeles"
      },
      ...
      "email": {
        "value": "jordan.3802@sandbox.example.com"
      },
      "phone_number": {
        "value": "6359015925"
      },
