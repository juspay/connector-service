# Connector `noon` / Suite `authorize` / Scenario `no3ds_auto_capture_eps`
...
{
  "merchant_transaction_id": "mti_af688ca742544c92aeea570b",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "sam.7827@testmail.io"
    },
    "id": "cust_da268584e0a24058ac8bfc8f",
    "phone_number": "+17987688038"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "alex.8309@sandbox.example.com"
      },
      "phone_number": {
        "value": "8419104125"
      },
...
date: Tue, 24 Mar 2026 01:45:15 GMT
x-request-id: authorize_no3ds_auto_capture_eps_req
