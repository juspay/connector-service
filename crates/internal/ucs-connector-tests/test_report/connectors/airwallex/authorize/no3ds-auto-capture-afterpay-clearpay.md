# Connector `airwallex` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_1404699b79344e31aca62415",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Miller",
    "email": {
      "value": "jordan.6643@example.com"
    },
    "id": "cust_6d45245be70144fabcf88422",
    "phone_number": "+919535999919"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line2": {
        "value": "6257 Market Blvd"
      },
      "line3": {
        "value": "5267 Market Ln"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.1096@sandbox.example.com"
      },
      "phone_number": {
        "value": "4666888348"
      },
