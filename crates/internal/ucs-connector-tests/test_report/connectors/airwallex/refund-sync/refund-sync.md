# Connector `airwallex` / Suite `refund_sync` / Scenario `refund_sync`
...
date: Tue, 24 Mar 2026 05:15:55 GMT
x-request-id: refund_sync_refund_sync_req
...
{
  "merchant_transaction_id": "mti_aa3835131df94c27ba49c891",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Brown",
    "email": {
      "value": "jordan.4813@example.com"
    },
    "id": "cust_b23190f8e2ac4c6dba0a7209",
    "phone_number": "+14259617428"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.6528@sandbox.example.com"
      },
      "phone_number": {
        "value": "7866436451"
      },
...
{
  "merchant_refund_id": "mri_e702607d721e473ba600c690",
