# Connector `airwallex` / Suite `refund_sync` / Scenario `refund_sync_with_reason`
...
{
  "merchant_transaction_id": "mti_ec56a1280c9d411fa690594d",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Brown",
    "email": {
      "value": "sam.6145@example.com"
    },
    "id": "cust_b8574f149d2f4d90a4eb0403",
    "phone_number": "+12641377356"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.8438@sandbox.example.com"
      },
      "phone_number": {
        "value": "2498225942"
      },
...
{
  "merchant_refund_id": "mri_134ec27a689d46c883c4b179",
