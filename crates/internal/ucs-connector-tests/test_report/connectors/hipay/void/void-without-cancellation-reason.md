# Connector `hipay` / Suite `void` / Scenario `void_without_cancellation_reason`
...
date: Tue, 24 Mar 2026 05:30:42 GMT
x-request-id: void_void_without_cancellation_reason_req
...
{
  "merchant_transaction_id": "mti_f16c1167c4cf48ea8cabb20c",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Wilson",
    "email": {
      "value": "sam.5602@sandbox.example.com"
    },
    "id": "cust_8ac5cfc5d0b540b493391550",
    "phone_number": "+12513233574"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "3377 Market Rd"
      },
      "line2": {
        "value": "620 Main Ave"
      },
      "line3": {
        "value": "2121 Lake Blvd"
      },
      "city": {
        "value": "Chicago"
      },
      ...
      "email": {
        "value": "sam.8321@sandbox.example.com"
      },
      "phone_number": {
        "value": "9972997106"
      },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 05:30:41 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_b6576470d8eb4722a4429b30",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
