# Connector `hipay` / Suite `void` / Scenario `void_with_amount`
...
date: Tue, 24 Mar 2026 05:30:40 GMT
x-request-id: void_void_with_amount_req
...
{
  "merchant_transaction_id": "mti_88e98ab91e9f45eea11e5dee",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Johnson",
    "email": {
      "value": "casey.5566@example.com"
    },
    "id": "cust_30a4b2f902544289af28279f",
    "phone_number": "+448341843071"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "alex.2445@sandbox.example.com"
      },
      "phone_number": {
        "value": "5199444012"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "7542 Market St"
      },
      "line2": {
        "value": "6545 Sunset Dr"
      },
      "line3": {
        "value": "4327 Pine Rd"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.1245@sandbox.example.com"
      },
      "phone_number": {
        "value": "6439337157"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_3033920f80264538a346fcd5",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_706064",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
