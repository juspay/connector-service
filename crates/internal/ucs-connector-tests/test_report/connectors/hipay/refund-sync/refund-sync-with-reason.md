# Connector `hipay` / Suite `refund_sync` / Scenario `refund_sync_with_reason`
...
{
  "merchant_transaction_id": "mti_a5048d89c9b74828af6f8727",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "sam.3993@sandbox.example.com"
    },
    "id": "cust_7fb185b443d54e43bae289a4",
    "phone_number": "+14596684985"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line2": {
        "value": "2276 Sunset Rd"
      },
      "line3": {
        "value": "9997 Lake Blvd"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "8864 Market St"
      },
      "line3": {
        "value": "9437 Market St"
      },
      "city": {
        "value": "Chicago"
      },
...
date: Tue, 24 Mar 2026 05:30:53 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_e7e3597f97f64f05ad3016b8",
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 05:30:54 GMT
x-request-id: refund_sync_refund_sync_with_reason_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "via": "1.1 google",
    "x-cloud-trace-context": "14c7cb549567b12a14d6bc4366227589",
