# Connector `hipay` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_fa596301f11f46eab016a9cb",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Mia Brown",
    "email": {
      "value": "casey.7256@sandbox.example.com"
    },
    "id": "cust_86ffcdd5fe6842d7a2891290",
    "phone_number": "+915365618592"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "jordan.1141@sandbox.example.com"
      },
      "phone_number": {
        "value": "8548028773"
      },
