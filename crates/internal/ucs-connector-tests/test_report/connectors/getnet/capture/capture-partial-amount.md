# Connector `getnet` / Suite `capture` / Scenario `capture_partial_amount`
...
{
  "merchant_transaction_id": "mti_56095877957146469759af59",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Smith",
    "email": {
      "value": "jordan.7453@sandbox.example.com"
    },
    "id": "cust_8a251302c5c94284bf03cb6b",
    "phone_number": "+13619938566"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "8383 Market Ln"
      },
      "line2": {
        "value": "624 Oak St"
      },
      "line3": {
        "value": "4652 Market St"
      },
      "city": {
        "value": "New York"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_1553a5cc6e584176963538c4",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
