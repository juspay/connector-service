# Connector `getnet` / Suite `authorize` / Scenario `no3ds_auto_capture_bancontact`
...
{
  "merchant_transaction_id": "mti_f890c278560549229e288138",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Mia Johnson",
    "email": {
      "value": "casey.7550@testmail.io"
    },
    "id": "cust_7fa8f52cd32c41ae920054b5",
    "phone_number": "+11852114874"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "morgan.1063@sandbox.example.com"
      },
      "phone_number": {
        "value": "9768418758"
      },
