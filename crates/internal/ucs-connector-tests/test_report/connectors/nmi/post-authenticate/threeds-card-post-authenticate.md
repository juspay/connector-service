# Connector `nmi` / Suite `post_authenticate` / Scenario `threeds_card_post_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Noah Miller",
    "email": {
      "value": "casey.9568@sandbox.example.com"
    },
    "id": "cust_6ea199971d5f43c29c0b2141",
    "phone_number": "+15048523216"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.5645@sandbox.example.com"
      },
      "phone_number": {
        "value": "4576301114"
      },
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_d85dc4c3822c4e90a6c25363"
  },
  "metadata": {
    "value": "{}"
  },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PostAuthenticate <<'JSON'
{
  ...
  "connector_order_reference_id": "gen_310673",
  "metadata": {
    "value": "{}"
  },
  "connector_feature_data": {
