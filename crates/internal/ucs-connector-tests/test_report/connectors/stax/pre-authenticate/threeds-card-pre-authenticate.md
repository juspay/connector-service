# Connector `stax` / Suite `pre_authenticate` / Scenario `threeds_card_pre_authenticate`
...
date: Tue, 24 Mar 2026 07:24:17 GMT
x-request-id: pre_authenticate_threeds_card_pre_authenticate_req
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ethan Miller",
    "email": {
      "value": "morgan.5261@example.com"
    },
    "id": "cust_ff91acad93c74ca59e822542",
    "phone_number": "+12166454208"
  },
  "address": {
    "shipping_address": {
      "first_name": {
      ...
      "line2": {
        "value": "5975 Sunset Ln"
      },
      "line3": {
        "value": "1368 Main Blvd"
      },
      "city": {
        "value": "Austin"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.3556@sandbox.example.com"
      },
      "phone_number": {
        "value": "9396193004"
      },
