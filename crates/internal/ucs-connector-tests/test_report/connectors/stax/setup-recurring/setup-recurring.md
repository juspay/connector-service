# Connector `stax` / Suite `setup_recurring` / Scenario `setup_recurring`
...
{
  "merchant_recurring_payment_id": "mrpi_e6f92e657e3b46efafbecd43",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Brown",
    "email": {
      "value": "jordan.7850@example.com"
    },
    "id": "cust_345c3876d568450bb7fb0bba",
    "phone_number": "+13867670465",
