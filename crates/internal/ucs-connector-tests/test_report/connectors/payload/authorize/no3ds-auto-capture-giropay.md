# Connector `payload` / Suite `authorize` / Scenario `no3ds_auto_capture_giropay`
...
{
  "merchant_transaction_id": "mti_d9cb68248b974950abc3f29f44714b34",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "sam.6094@sandbox.example.com"
    },
    "id": "cust_4575c79ae7694d868b0758a01c30d6e4",
    "phone_number": "+916850051296"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.3620@sandbox.example.com"
      },
      "phone_number": {
        "value": "3130571411"
      },
