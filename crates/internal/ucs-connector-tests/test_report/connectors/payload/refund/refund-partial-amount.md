# Connector `payload` / Suite `refund` / Scenario `refund_partial_amount`
...
{
  "merchant_transaction_id": "mti_41bfac189d66421993b336fb0e802e76",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ava Taylor",
    "email": {
      "value": "sam.3876@sandbox.example.com"
    },
    "id": "cust_fcc5e278b7224d73b9dc49e9d5159330",
    "phone_number": "+12670175252"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.2665@sandbox.example.com"
      },
      "phone_number": {
        "value": "1228676187"
      },
...
date: Mon, 23 Mar 2026 16:23:11 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "txn_3fCKm9TBwinwmkou2OQwt",
  "connectorTransactionId": "txn_3fCKm9TBwinwmkou2OQwt",
  "status": "FAILURE",
  "error": {
    "issuerDetails": {
      "networkDetails": {}
...
{
  "merchant_refund_id": "mri_d07def64fb2345659f06f1ba639ea775",
  "connector_transaction_id": "txn_3fCKm9TBwinwmkou2OQwt",
  "payment_amount": 6000,
  "refund_amount": {
    "minor_amount": 3000,
    "currency": "USD"
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:23:12 GMT
x-request-id: refund_refund_partial_amount_req
