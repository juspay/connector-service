# Connector `xendit` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_ecfa3d5946ae4309966399cd",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Ava Miller",
    "email": {
      "value": "riley.2848@sandbox.example.com"
    },
    "id": "cust_3ec56ef4b14c4f339930565a",
    "phone_number": "+444850451021"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.6108@sandbox.example.com"
      },
      "phone_number": {
        "value": "2000353730"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "PL",
      "email": {
        "value": "morgan.4091@sandbox.example.com"
      },
      "phone_number": {
        "value": "7828685184"
      },
