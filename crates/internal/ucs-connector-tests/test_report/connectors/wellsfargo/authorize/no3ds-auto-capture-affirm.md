# Connector `wellsfargo` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_b2a18f35fc7549e18efc414c251d326f",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Wilson",
    "email": {
      "value": "sam.4097@example.com"
    },
    "id": "cust_fe4a81c50b514daf8b5bc734f58e7cbf",
    "phone_number": "+447356645443"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:41:46 GMT
x-request-id: authorize_no3ds_auto_capture_affirm_req
