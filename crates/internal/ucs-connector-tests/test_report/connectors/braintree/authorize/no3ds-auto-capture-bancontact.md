# Connector `braintree` / Suite `authorize` / Scenario `no3ds_auto_capture_bancontact`
...
{
  "merchant_payment_method_id": "gen_708274",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "id": "cust_75b969c614b849659fe732d5",
    "name": "Liam Johnson",
    "email": {
      "value": "sam.7922@example.com"
    }
  },
  "address": {
    "billing_address": {
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "cf-ray": "9e12b26679e03ba9-BOM",
    "connection": "keep-alive",
    "content-type": "application/json",
    "date": "Tue, 24 Mar 2026 03:47:51 GMT",
    "paypal-debug-id": "24cdf3d042ed8",
    "pragma": "no-cache",
    "server": "cloudflare",
    "set-cookie": "__cf_bm=HiHrkgBBlbbY5e8fbhfippalbbxsy7dMeyJssLWWg2Q-1774324071.4358888-1.0.1.1-YXCUwKxr_C0vEtBXK3wSKEQi38UTCa6OvQyAe.hio_3UgL2DV6sWxTVjSxAcH_JotJfe0GlY0KDuTWkEBTkIH4nuMFj37PIFuMK0bhDY_rcGDB2cTVEJLSGtssYXO39y; HttpOnly; Secure; Path=/; Domain=sandbox.braintree-api.com; Expires=Tue, 24 Mar 2026 04:17:51 GMT",
  ...
  "merchantPaymentMethodId": "tokencc_bh_mqwv4b_ptc39k_88ctkd_hgktyc_bw7"
}
...
{
  "merchant_transaction_id": "mti_d59738ed319f4c69a276dd0c",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    ...
    "id": "cust_75b969c614b849659fe732d5",
    "phone_number": "+919142360280"
  },
  "payment_method_token": ***MASKED***
    "value": "tokencc_bh_mqwv4b_ptc39k_88ctkd_hgktyc_bw7"
  },
  "address": {
    "shipping_address": {
      "first_name": {
