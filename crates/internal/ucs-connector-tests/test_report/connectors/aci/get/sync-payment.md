# Connector `aci` / Suite `get` / Scenario `sync_payment`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"800.900.300","message":"invalid authentication information"}}
```
...
{
  "merchant_transaction_id": "mti_3a98de7b797247f4bc122920",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Miller",
    "email": {
      "value": "morgan.1460@testmail.io"
    },
    "id": "cust_900c48018e444d7a9a0b1c3b",
    "phone_number": "+449596618672"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.2189@sandbox.example.com"
      },
      "phone_number": {
        "value": "9926301258"
      },
...
date: Mon, 23 Mar 2026 18:25:09 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Mon, 23 Mar 2026 18:25:09 GMT",
    "expires": "Mon, 23 Mar 2026 18:25:09 GMT",
    "pragma": "no-cache",
    "server": "ACI",
