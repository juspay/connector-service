# Connector `aci` / Suite `authorize` / Scenario `no3ds_auto_capture_debit_card`
...
{
  "merchant_transaction_id": "mti_8cd4c7f683d54e0bb3ba58a4",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "jordan.8061@example.com"
    },
    "id": "cust_412e9d3237a248a98259a9cb",
    "phone_number": "+449425825563"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.8024@sandbox.example.com"
      },
      "phone_number": {
        "value": "5952505705"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "2630 Sunset Rd"
      },
      "line2": {
        "value": "4083 Sunset Rd"
      },
      "line3": {
        "value": "7316 Lake St"
      },
...
date: Mon, 23 Mar 2026 18:24:51 GMT
x-request-id: authorize_no3ds_auto_capture_debit_card_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Mon, 23 Mar 2026 18:24:51 GMT",
    "expires": "Mon, 23 Mar 2026 18:24:51 GMT",
    "pragma": "no-cache",
    "server": "ACI",
