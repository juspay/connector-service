# Connector `worldpay` / Suite `authorize` / Scenario `threeds_manual_capture_credit_card`
...
{
  "merchant_customer_id": "mcui_5d009a079749477191bc48ce",
  "customer_name": "Liam Miller",
  "email": {
    "value": "morgan.4178@testmail.io"
  },
  "phone_number": "+446608973533",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
      ...
      "email": {
        "value": "casey.5062@sandbox.example.com"
      },
      "phone_number": {
        "value": "7400525932"
      },
...
{
  "merchant_transaction_id": "mti_906edb2676df4c9b8b81ec07",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    ...
    "id": "cust_d8c435146313492aafdf5127",
    "phone_number": "+917086385556"
  },
  "browser_info": {
