# Connector `elavon` / Suite `refund_sync` / Scenario `refund_sync`
...
date: Mon, 23 Mar 2026 18:44:05 GMT
x-request-id: refund_sync_refund_sync_req
...
{
  "merchant_transaction_id": "mti_591dbb10bcf04fe2b5ba0155",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Taylor",
    "email": {
      "value": "morgan.7255@example.com"
    },
    "id": "cust_05e4b806bf8a4f0fae760f98",
    "phone_number": "+912929554547"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.2314@sandbox.example.com"
      },
      "phone_number": {
        "value": "1713331705"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "8765 Market Blvd"
      },
      "line2": {
        "value": "2038 Lake Blvd"
      },
      "line3": {
        "value": "2926 Market Dr"
      },
      "city": {
        "value": "Seattle"
      },
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:44:04 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_563bf7c29e2a4ace89a2c932",
