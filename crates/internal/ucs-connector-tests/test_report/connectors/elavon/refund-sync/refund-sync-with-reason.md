# Connector `elavon` / Suite `refund_sync` / Scenario `refund_sync_with_reason`
...
{
  "merchant_transaction_id": "mti_8a9d72ccf62740f29f6208ec",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "riley.3609@example.com"
    },
    "id": "cust_c092b7b8a8fb44f597753273",
    "phone_number": "+12081566835"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:44:06 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_1d4739c43ea94548bbf797ff",
