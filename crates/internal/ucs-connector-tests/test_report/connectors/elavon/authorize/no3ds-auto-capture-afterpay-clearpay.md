# Connector `elavon` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_7e11700d51a142408cb55ee7",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Taylor",
    "email": {
      "value": "riley.4864@example.com"
    },
    "id": "cust_95bde521e8de484d9fe7e9d9",
    "phone_number": "+13434645356"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "casey.4677@sandbox.example.com"
      },
      "phone_number": {
        "value": "8469621635"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.5107@sandbox.example.com"
      },
      "phone_number": {
        "value": "1618938372"
      },
