# Connector `elavon` / Suite `get` / Scenario `sync_payment_with_handle_response`
...
date: Mon, 23 Mar 2026 18:44:09 GMT
x-request-id: get_sync_payment_with_handle_response_req
...
{
  "merchant_transaction_id": "mti_3fed4ca1b8384fff8e78d153",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Smith",
    "email": {
      "value": "morgan.2722@testmail.io"
    },
    "id": "cust_3ef9481ae76543a7a7474aee",
    "phone_number": "+17555047518"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.7399@sandbox.example.com"
      },
      "phone_number": {
        "value": "6144479776"
      },
