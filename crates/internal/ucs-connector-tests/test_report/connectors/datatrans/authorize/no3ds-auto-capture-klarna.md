# Connector `datatrans` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_9cbdbad453f64ea29def27bd",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "riley.9136@sandbox.example.com"
    },
    "id": "cust_e45f5c85784b494a98c7c7c8",
    "phone_number": "+14760404748"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:41:50 GMT
x-request-id: authorize_no3ds_auto_capture_klarna_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Only card payments are supported for Datatrans"
    }
  },
  "statusCode": 501
}
