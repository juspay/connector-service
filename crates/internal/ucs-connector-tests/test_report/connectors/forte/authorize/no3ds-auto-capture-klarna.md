# Connector `forte` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_e6a8d6373ec74f15b99a32c4",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Miller",
    "email": {
      "value": "jordan.6125@sandbox.example.com"
    },
    "id": "cust_d8b115e783a34f42a7bcd0b1",
    "phone_number": "+442835658300"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:17 GMT
x-request-id: authorize_no3ds_auto_capture_klarna_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Selected payment method through Forte"
    }
  },
  "statusCode": 501
}
