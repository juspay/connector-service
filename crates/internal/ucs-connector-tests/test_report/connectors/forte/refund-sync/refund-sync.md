# Connector `forte` / Suite `refund_sync` / Scenario `refund_sync`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"connectorDetails":{"code":"No error code","message":"The field transaction_id or action is specified in the route, but is invalid.","reason":"The field transaction_id or action is specified in the route, but is invalid."}}
```
...
date: Mon, 23 Mar 2026 18:49:27 GMT
x-request-id: create_customer_create_customer_req
...
{
  "merchant_customer_id": "mcui_cfebb6af0c4947f7b107bc01",
  "customer_name": "Liam Brown",
  "email": {
    "value": "alex.1137@testmail.io"
  },
  "phone_number": "+16109866453",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Liam"
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.9868@sandbox.example.com"
      },
      "phone_number": {
        "value": "3588880646"
      },
...
{
  "merchant_transaction_id": "mti_94521c6a839042648b094739",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "jordan.9842@testmail.io"
    },
    "id": "cust_461359da3ec640d6b7470c11",
    "phone_number": "+447999723565"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:28 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_82e5647ff6f74832932b3006",
...
Response contents:
{
  "error": {
    "connectorDetails": {
      "code": "No error code",
      "message": "The field transaction_id or action is specified in the route, but is invalid.",
      "reason": "The field transaction_id or action is specified in the route, but is invalid."
    }
  },
  "statusCode": 400,
  "responseHeaders": {
    ...
    "date": "Mon, 23 Mar 2026 18:49:28 GMT",
    "server": "Kestrel",
    "www-authenticate": "Basic realm=\"https://sandbox.forte.net/api/v3/organizations/org_438530/locations/loc_316671/transactions/auto_generate\"",
    "x-api-mode": "modern"
  },
  "rawConnectorResponse": "***MASKED***"
  },
