# Connector `forte` / Suite `capture` / Scenario `capture_partial_amount`
...
date: Mon, 23 Mar 2026 18:49:21 GMT
x-request-id: capture_capture_partial_amount_req
...
Response trailers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:49:20 GMT
x-request-id: create_customer_create_customer_req
Sent 1 request and received 0 responses
...
{
  "merchant_customer_id": "mcui_79a599111305489f89702968",
  "customer_name": "Mia Smith",
  "email": {
    "value": "alex.2401@sandbox.example.com"
  },
  "phone_number": "+12237938350",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ethan"
      ...
      "line2": {
        "value": "5045 Pine Blvd"
      },
      "line3": {
        "value": "8257 Sunset Blvd"
      },
      "city": {
        "value": "San Francisco"
      },
      ...
      "email": {
        "value": "alex.4461@sandbox.example.com"
      },
      "phone_number": {
        "value": "8035674189"
      },
...
{
  "merchant_transaction_id": "mti_113261ac754a4d2f95123098",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "casey.4440@sandbox.example.com"
    },
    "id": "cust_ccaaafa8363a42718a7fc162",
    "phone_number": "+12795351101"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_5b041d4c56534676bf8414f7",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
