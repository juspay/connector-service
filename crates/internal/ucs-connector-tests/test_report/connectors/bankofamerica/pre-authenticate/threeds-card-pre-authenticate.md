# Connector `bankofamerica` / Suite `pre_authenticate` / Scenario `threeds_card_pre_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ava Wilson",
    "email": {
      "value": "morgan.3870@sandbox.example.com"
    },
    "id": "cust_749691a8247942d8bdc92d13",
    "phone_number": "+17123642301"
  },
  "address": {
    "shipping_address": {
      "first_name": {
      ...
      "email": {
        "value": "riley.9555@sandbox.example.com"
      },
      "phone_number": {
        "value": "1358232837"
      },
