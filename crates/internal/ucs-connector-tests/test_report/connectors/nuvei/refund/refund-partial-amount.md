# Connector `nuvei` / Suite `refund` / Scenario `refund_partial_amount`
...
{
  "merchant_customer_id": "mcui_a8765f57c7dd47b09764a5aa",
  "customer_name": "Ava Wilson",
  "email": {
    "value": "jordan.7075@example.com"
  },
  "phone_number": "+449984430756",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Liam"
      ...
      "line2": {
        "value": "6952 Sunset Ln"
      },
      "line3": {
        "value": "6719 Sunset Rd"
      },
      "city": {
        "value": "New York"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.1374@sandbox.example.com"
      },
      "phone_number": {
        "value": "1427334562"
      },
...
{
  "merchant_transaction_id": "mti_ea66d614e07e4a60975c1149",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Brown",
    "email": {
      "value": "casey.3157@testmail.io"
    },
    "id": "cust_0e1805c613ad4f59a3b3808a",
    "phone_number": "+449056852977"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 01:49:02 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_da16ed5ba1ab4b85b695a72a",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "server": "nginx",
    "set-cookie": "JSESSIONID=d87f5be5cdc33f6191d569e365ad; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
