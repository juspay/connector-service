# Connector `nuvei` / Suite `get` / Scenario `sync_payment_with_handle_response`
...
{
  "merchant_customer_id": "mcui_a40cca5568ee4746b6c6ad3f",
  "customer_name": "Noah Johnson",
  "email": {
    "value": "casey.3059@sandbox.example.com"
  },
  "phone_number": "+915841323431",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
...
{
  "merchant_transaction_id": "mti_7ba8da5da5b44023820fecdf",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Brown",
    "email": {
      "value": "casey.7462@sandbox.example.com"
    },
    "id": "cust_9abcebdc5bf34f3ea3312de6",
    "phone_number": "+448932158245"
  },
  "browser_info": {
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "server": "nginx",
    "set-cookie": "JSESSIONID=d87e47d51b963b7eb529b63f6a4c; Path=/ppp; Secure; HttpOnly; SameSite=None"
  },
