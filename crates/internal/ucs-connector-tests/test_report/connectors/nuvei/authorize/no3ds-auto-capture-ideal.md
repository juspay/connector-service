# Connector `nuvei` / Suite `authorize` / Scenario `no3ds_auto_capture_ideal`
...
{
  "merchant_transaction_id": "mti_f0a47dbd14d14078aab99f8e",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "casey.9535@sandbox.example.com"
    },
    "id": "cust_3297c88767c84d17ae9a31c9",
    "phone_number": "+447055855953"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 01:48:47 GMT
x-request-id: authorize_no3ds_auto_capture_ideal_req
