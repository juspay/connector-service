# Connector `billwerk` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_c104a8b4217a4d21a07ca4f5",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "jordan.3236@sandbox.example.com"
    },
    "id": "cust_716ec867cdb04cddbebadb52",
    "phone_number": "+913760808386"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.6095@sandbox.example.com"
      },
      "phone_number": {
        "value": "6597225375"
      },
