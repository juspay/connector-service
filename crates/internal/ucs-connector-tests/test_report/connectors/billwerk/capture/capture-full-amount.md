# Connector `billwerk` / Suite `capture` / Scenario `capture_full_amount`
...
{
  "merchant_transaction_id": "mti_c7054fb57e224a0f8d1bbac3",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Wilson",
    "email": {
      "value": "jordan.5842@sandbox.example.com"
    },
    "id": "cust_c4d42d674563456590a88dd0",
    "phone_number": "+447328589469"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.5016@sandbox.example.com"
      },
      "phone_number": {
        "value": "3576425238"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.7202@sandbox.example.com"
      },
      "phone_number": {
        "value": "3078941091"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Capture <<'JSON'
{
  ...
  "merchant_capture_id": "mci_4d33d62849ac41619aea1cec",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 06:58:44 GMT
x-request-id: capture_capture_full_amount_req
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 06:58:44 GMT",
    "request-id": "4b1ce0bd53c3397b0b70abb6337d5995",
