# Connector `billwerk` / Suite `refund_sync` / Scenario `refund_sync`
...
{
  "merchant_transaction_id": "mti_ccea568baf93406c9b151c29",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Smith",
    "email": {
      "value": "morgan.4670@sandbox.example.com"
    },
    "id": "cust_422375fa180a468580e3e72e",
    "phone_number": "+914381085607"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.7940@sandbox.example.com"
      },
      "phone_number": {
        "value": "5652937204"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.4061@sandbox.example.com"
      },
      "phone_number": {
        "value": "5720992663"
      },
...
date: Tue, 24 Mar 2026 06:58:49 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_2230413cc1a44b0ba2903532",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 06:58:49 GMT",
    "request-id": "e914df904072f3ea10618005ec7c532d",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "content-type": "application/json",
    "date": "Tue, 24 Mar 2026 06:58:50 GMT",
    "request-id": "1639fd568d63e10b1b00588c978543e8",
    "strict-transport-security": "max-age=31536000; includeSubDomains",
    "vary": "Accept-Encoding",
    "x-content-type-options": "nosniff"
  },
