# Connector `billwerk` / Suite `void` / Scenario `void_with_amount`
...
{
  "merchant_transaction_id": "mti_9759f2d6761444f68018c89d",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Wilson",
    "email": {
      "value": "alex.1783@testmail.io"
    },
    "id": "cust_f3b442e073054041b81069da",
    "phone_number": "+445504416390"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "1148 Market Blvd"
      },
      "line2": {
        "value": "6382 Oak St"
      },
      "line3": {
        "value": "3673 Pine Blvd"
      },
      "city": {
        "value": "San Francisco"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.3825@sandbox.example.com"
      },
      "phone_number": {
        "value": "3525303927"
      },
...
date: Tue, 24 Mar 2026 06:58:46 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_a5323c3af4124585b3a972ec",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_901930",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response contents:
{
  ...
  "responseHeaders": {
    ...
    "date": "Tue, 24 Mar 2026 06:58:46 GMT",
    "request-id": "74430674a808683d61097280ec58be77",
