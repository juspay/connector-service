# Connector `novalnet` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_d732d51ac4a8448e9af1ca24",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Brown",
    "email": {
      "value": "casey.4753@testmail.io"
    },
    "id": "cust_ded26b575c824f5aa1a6330e",
    "phone_number": "+16641430621"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.7632@sandbox.example.com"
      },
      "phone_number": {
        "value": "9576847477"
      },
