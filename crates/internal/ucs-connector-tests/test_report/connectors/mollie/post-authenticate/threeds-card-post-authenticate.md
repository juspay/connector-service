# Connector `mollie` / Suite `post_authenticate` / Scenario `threeds_card_post_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/Authenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Liam Brown",
    "email": {
      "value": "alex.7670@sandbox.example.com"
    },
    "id": "cust_ab22667a8c094a02b7845ea6",
    "phone_number": "+441997848908"
  },
  "address": {
    "shipping_address": {
      "first_name": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "6579 Sunset Blvd"
      },
      "line2": {
        "value": "8114 Sunset Ln"
      },
      "line3": {
        "value": "5728 Lake Rd"
      },
  ...
  "authentication_data": {
    "connector_transaction_id": "cti_e1ee9f9e8b7545bcb7db99f2"
  },
  "metadata": {
    "value": "{}"
  },
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PostAuthenticate <<'JSON'
{
  ...
  "connector_order_reference_id": "gen_631173",
  "metadata": {
    "value": "{}"
  },
  "connector_feature_data": {
