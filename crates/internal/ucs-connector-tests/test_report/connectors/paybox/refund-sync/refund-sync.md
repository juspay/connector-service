# Connector `paybox` / Suite `refund_sync` / Scenario `refund_sync`
...
Response trailers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:05:02 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
Sent 1 request and received 0 responses
...
{
  "merchant_transaction_id": "mti_94c635a4107b4439934defbe",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Johnson",
    "email": {
      "value": "casey.7481@example.com"
    },
    "id": "cust_258365a552c249c4bf3ce730",
    "phone_number": "+919654174912"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.1814@sandbox.example.com"
      },
      "phone_number": {
        "value": "5706848806"
      },
...
{
  "merchant_refund_id": "mri_fafc8dd7ec194c1fabc901e6",
