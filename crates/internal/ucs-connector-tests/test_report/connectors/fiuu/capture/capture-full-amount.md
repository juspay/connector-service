# Connector `fiuu` / Suite `capture` / Scenario `capture_full_amount`
...
{
  "merchant_transaction_id": "mti_699a628919544399baa22888",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    ...
    "id": "cust_e5c1f714373c406b9df21633",
    "phone_number": "+446907131955"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "3437 Sunset Ln"
      },
      "line2": {
        "value": "1948 Sunset Blvd"
      },
      "line3": {
        "value": "7126 Pine Blvd"
      },
      "city": {
        "value": "Austin"
      },
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.8843@sandbox.example.com"
      },
      "phone_number": {
        "value": "3618518719"
      },
...
Response contents:
{
  "connectorTransactionId": "31270182",
  "status": "AUTHORIZED",
  "statusCode": 200,
  "responseHeaders": {
    "cache-control": "max-age=600",
    "cf-cache-status": "DYNAMIC",
    "cf-ray": "9e0f99ccc99bff64-BOM",
...
{
  "connector_transaction_id": "31270182",
  "amount_to_capture": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_capture_id": "mci_f0a9c6fbb40248ce990a00c0",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
