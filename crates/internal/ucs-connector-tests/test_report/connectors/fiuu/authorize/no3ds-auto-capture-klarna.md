# Connector `fiuu` / Suite `authorize` / Scenario `no3ds_auto_capture_klarna`
...
{
  "merchant_transaction_id": "mti_e68feabb6bba4933a288c69f",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "riley.4023@sandbox.example.com"
    },
    "id": "cust_0e72c8d38bf146a1bc942b27",
    "phone_number": "+13071370605"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "9470 Pine Blvd"
      },
      "line2": {
        "value": "5671 Market Rd"
      },
      "line3": {
        "value": "8257 Market St"
      },
      "city": {
        "value": "San Francisco"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.3878@sandbox.example.com"
      },
      "phone_number": {
        "value": "1304693103"
      },
