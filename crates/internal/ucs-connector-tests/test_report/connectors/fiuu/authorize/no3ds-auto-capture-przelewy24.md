# Connector `fiuu` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_78728d58181e4f168eb887ea",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Brown",
    "email": {
      "value": "casey.8217@testmail.io"
    },
    "id": "cust_6ec515aa00a34b7bbbea7af2",
    "phone_number": "+915242293133"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.3543@sandbox.example.com"
      },
      "phone_number": {
        "value": "6870081442"
      },
