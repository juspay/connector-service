# Connector `worldpayxml` / Suite `void` / Scenario `void_with_amount`
...
{
  "merchant_transaction_id": "mti_9f6a428abc43415dbef28714",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Ethan Taylor",
    "email": {
      "value": "riley.3231@sandbox.example.com"
    },
    "id": "cust_008f1d48e924467eb1789023",
    "phone_number": "+444193414276"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "riley.3193@sandbox.example.com"
      },
      "phone_number": {
        "value": "1849520889"
      },
...
date: Tue, 24 Mar 2026 07:11:29 GMT
x-request-id: authorize_no3ds_manual_capture_credit_card_req

Response contents:
{
  "merchantTransactionId": "mti_9f6a428abc43415dbef28714",
  "connectorTransactionId": "mti_9f6a428abc43415dbef28714",
  "status": "AUTHORIZED",
  "statusCode": 200,
  "responseHeaders": {
...
{
  "connector_transaction_id": "mti_9f6a428abc43415dbef28714",
  "merchant_void_id": "mvi_e01f795f9ec6478d82534edd",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_910799",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
...
Response contents:
{
  ...
  "merchantVoidId": "mti_9f6a428abc43415dbef28714",
  "rawConnectorRequest": "***MASKED***"
  }
}
