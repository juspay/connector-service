# Connector `bluesnap` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_4f78fbdda5a24cc19ad22053",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "morgan.1803@example.com"
    },
    "id": "cust_8ce2716c0e6e4d4e931582f1",
    "phone_number": "+449811830515"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "7388 Pine Blvd"
      },
      "line3": {
        "value": "9868 Market Dr"
      },
      "city": {
        "value": "Seattle"
      },
