# Connector `trustpay` / Suite `get` / Scenario `sync_payment`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"issuerDetails":{"networkDetails":{}},"connectorDetails":{"code":"1","message":"unspecified error","reason":"the provided instance id has invalid format & unspecified error"}}
```
...
{
  "merchant_customer_id": "mcui_75626bfb6b4a48549699661d3db47777",
  "customer_name": "Ava Smith",
  "email": {
    "value": "sam.8765@sandbox.example.com"
  },
  "phone_number": "+446180603288",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Noah"
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "1023 Sunset Ln"
      },
      "line3": {
        "value": "7119 Sunset Ln"
      },
      "city": {
        "value": "Chicago"
      },
...
{
  "merchant_transaction_id": "mti_9a395e87d2734935a39471a54381e1c2",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Taylor",
    "email": {
      "value": "morgan.7797@testmail.io"
    },
    "id": "cust_b16b010b45ba4330843430fb20562b3d",
    "phone_number": "+14019045558"
  },
  "browser_info": {
