# Connector `trustpay` / Suite `get` / Scenario `sync_payment_with_handle_response`
...
{
  "merchant_customer_id": "mcui_454ac10a75474535b3ab718f7f9f7e6f",
  "customer_name": "Mia Wilson",
  "email": {
    "value": "casey.3188@testmail.io"
  },
  "phone_number": "+16055489345",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Mia"
      ...
      "email": {
        "value": "riley.6170@sandbox.example.com"
      },
      "phone_number": {
        "value": "2726198321"
      },
...
{
  "merchant_transaction_id": "mti_3c6efe2190904c4fa449df13f740cebe",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Wilson",
    "email": {
      "value": "alex.1428@testmail.io"
    },
    "id": "cust_667cc74a56be46d0851d8d2198555e9a",
    "phone_number": "+913891740311"
  },
  "browser_info": {
...
Response contents:
{
  "error": {
    ...
    "connectorDetails": {
      ...
      "reason": "the provided instance id has invalid format \u0026 unspecified error"
    }
  },
  "statusCode": 400,
  "responseHeaders": {
