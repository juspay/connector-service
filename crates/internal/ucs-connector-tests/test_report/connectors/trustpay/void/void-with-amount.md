# Connector `trustpay` / Suite `void` / Scenario `void_with_amount`
...
{
  "merchant_customer_id": "mcui_e5cb53b3150e4fc89763204dc823d96d",
  "customer_name": "Ava Smith",
  "email": {
    "value": "alex.2777@example.com"
  },
  "phone_number": "+912481722521",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Emma"
      ...
      "line1": {
        "value": "3090 Market St"
      },
      "line2": {
        "value": "3913 Sunset Rd"
      },
      "line3": {
        "value": "4799 Lake St"
      },
...
{
  "merchant_transaction_id": "mti_752db3a2d77c49648018fcd8eaa59b72",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "jordan.2733@sandbox.example.com"
    },
    "id": "cust_3360197e301b433ba05fa91170468889",
    "phone_number": "+912628661597"
  },
  "browser_info": {
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_950c6f8639e6494dbaac290a88041f5b",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_896305",
