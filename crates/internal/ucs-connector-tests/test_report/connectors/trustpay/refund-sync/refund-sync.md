# Connector `trustpay` / Suite `refund_sync` / Scenario `refund_sync`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"connectorDetails":{"code":"No error code","message":"No error message","reason":"action not supported"}}
```
...
date: Mon, 23 Mar 2026 16:36:31 GMT
x-request-id: create_customer_create_customer_req
...
{
  "merchant_customer_id": "mcui_586e10cca4ed49a9911dbb3921e03cae",
  "customer_name": "Liam Wilson",
  "email": {
    "value": "morgan.6408@example.com"
  },
  "phone_number": "+441503224723",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ethan"
      ...
      "line1": {
        "value": "7255 Sunset St"
      },
      "line2": {
        "value": "1412 Oak Blvd"
      },
      "line3": {
        "value": "7176 Market St"
      },
      "city": {
        "value": "Chicago"
      },
...
{
  "merchant_transaction_id": "mti_8a642666a67c43deab808631d70b51f0",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Noah Brown",
    "email": {
      "value": "alex.2063@example.com"
    },
    "id": "cust_dba8e290f21949ee810e7139dda2d432",
    "phone_number": "+17109041411"
  },
  "browser_info": {
...
{
  "merchant_refund_id": "mri_7ef4ec3636734fefa0ad19b1f7471546",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:36:32 GMT
x-request-id: refund_refund_full_amount_req
