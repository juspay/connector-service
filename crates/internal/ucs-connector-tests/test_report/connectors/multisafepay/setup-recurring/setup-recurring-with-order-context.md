# Connector `multisafepay` / Suite `setup_recurring` / Scenario `setup_recurring_with_order_context`
...
{
  "merchant_customer_id": "mcui_3c597e6d1b004618bdb2c68b",
  "customer_name": "Noah Wilson",
  "email": {
    "value": "alex.9471@example.com"
  },
  "phone_number": "+447010126080",
  "address": {
    "shipping_address": {
      "first_name": {
        "value": "Ava"
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "morgan.3088@sandbox.example.com"
      },
      "phone_number": {
        "value": "9637316590"
      },
...
{
  "merchant_recurring_payment_id": "mrpi_ac02cebc64cf40c198de473c",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "casey.1902@sandbox.example.com"
    },
    "id": "cust_be89d02e440f4f04b0a91b63",
    "phone_number": "+17468749014"
  },
  "browser_info": {
