# Connector `multisafepay` / Suite `authorize` / Scenario `no3ds_auto_capture_bancontact`
...
{
  "merchant_transaction_id": "mti_f2adec038a9b4329954f0f03",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 03:42:04 GMT
x-request-id: authorize_no3ds_auto_capture_bancontact_req
