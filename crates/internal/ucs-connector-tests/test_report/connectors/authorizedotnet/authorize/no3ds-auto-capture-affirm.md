# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_affirm`
...
{
  "merchant_transaction_id": "mti_358f7c36f0164122b79948b7",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "jordan.6557@sandbox.example.com"
    },
    "id": "cust_e049f613dbe94fae8bc4a92a",
    "phone_number": "+445494359950",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method PayLater(AffirmRedirect)"
    }
  },
  "statusCode": 501,
  "state": {
