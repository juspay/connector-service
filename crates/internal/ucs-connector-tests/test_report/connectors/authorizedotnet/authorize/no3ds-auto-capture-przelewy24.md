# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_ce6e17cf799f455c8a56f39c",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "riley.9988@sandbox.example.com"
    },
    "id": "cust_0e4ae01976ec49f0b111f093",
    "phone_number": "+11585634474",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:27:23 GMT
x-request-id: authorize_no3ds_auto_capture_przelewy24_req
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankRedirect(Przelewy24 { bank_name: None })"
    }
  },
  "statusCode": 501,
  "state": {
