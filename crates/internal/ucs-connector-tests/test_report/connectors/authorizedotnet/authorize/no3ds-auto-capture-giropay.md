# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_giropay`
...
{
  "merchant_transaction_id": "mti_c553577c6448496c8f8389b3",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Liam Smith",
    "email": {
      "value": "casey.1852@testmail.io"
    },
    "id": "cust_d35d50451f4c40bd899d79d9",
    "phone_number": "+12748974698",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankRedirect(Giropay { bank_account_bic: None, bank_account_iban: None, country: None })"
    }
  },
  "statusCode": 501,
  "state": {
