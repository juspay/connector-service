# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_eps`
...
{
  "merchant_transaction_id": "mti_710d5be2e7534704a6d7ea3b",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Wilson",
    "email": {
      "value": "jordan.3887@testmail.io"
    },
    "id": "cust_d6b70d8e2132436e8629fe24",
    "phone_number": "+449498776708",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankRedirect(Eps { bank_name: None, country: None })"
    }
  },
  "statusCode": 501,
  "state": {
