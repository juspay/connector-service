# Connector `authorizedotnet` / Suite `authorize` / Scenario `no3ds_auto_capture_bacs_bank_transfer`
...
{
  "merchant_transaction_id": "mti_c0cec73f3fb4400d910f8bfc",
  "amount": {
    "minor_amount": 6000,
    "currency": "GBP"
  },
  ...
  "customer": {
    "name": "Noah Taylor",
    "email": {
      "value": "morgan.7706@example.com"
    },
    "id": "cust_df6995a3a7a64101b038781c",
    "phone_number": "+442974369198",
...
Response contents:
{
  ...
  "error": {
    ...
    "connectorDetails": {
      ...
      "message": "This step has not been implemented for: Payment method BankTransfer(BacsBankTransfer)"
    }
  },
  "statusCode": 501,
  "state": {
