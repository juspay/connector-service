# Connector `adyen` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_6ad42b14ccf0424a8c79be99",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    ...
    "id": "cust_74e0dda560084dc69fae2d87",
    "phone_number": "+443450005436"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "morgan.1785@sandbox.example.com"
      },
      "phone_number": {
        "value": "3180632699"
      },
