# Connector `adyen` / Suite `authorize` / Scenario `no3ds_auto_capture_giropay`
...
{
  "merchant_transaction_id": "mti_bb355cf1e59e419b96861c23",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Taylor",
    "email": {
      "value": "jordan.5088@example.com"
    },
    "id": "cust_b9bf6b6556db48b1a6961c18",
    "phone_number": "+15725745507"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "morgan.7529@sandbox.example.com"
      },
      "phone_number": {
        "value": "1499434707"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "DE",
      "email": {
        "value": "alex.4165@sandbox.example.com"
      },
      "phone_number": {
        "value": "8151518244"
      },
