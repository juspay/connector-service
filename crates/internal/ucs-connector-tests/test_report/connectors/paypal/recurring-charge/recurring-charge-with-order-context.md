...
{
  "merchant_charge_id": "mchi_f582c0ed82354063b2be4b4d4be93e03",
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 16:27:39 GMT
x-request-id: recurring_charge_recurring_charge_with_order_context_req

Response contents:
{
  "connectorTransactionId": "18X003843T0885817",
  "status": "CHARGED",
  "statusCode": 201,
  "responseHeaders": {
    "accept-ranges": "bytes",
    ...
    "edge-control": "max-age=0",
    "http_x_pp_az_locator": "ccg18.slc",
    "paypal-debug-id": "f7173098ee481",
    "server": "nginx",
    "server-timing": "traceparent;desc=\"00-0000000000000000000f7173098ee481-9eafe390b76a3646-01\"",
    "strict-transport-security": "max-age=31536000; includeSubDomains",
    "vary": "Accept-Encoding",
    "via": "1.1 varnish, 1.1 varnish",
    ...
    "x-cache": "MISS, MISS, MISS",
    "x-cache-hits": "0, 0, 0",
    "x-served-by": "cache-sin-wsss1830064-SIN, cache-sin-wsss1830033-SIN, cache-bom-vanm7210065-BOM",
    "x-timer": "S1774283256.923468,VS0,VE3143"
  },
  "connectorFeatureData": {
    "value": "{\"authorize_id\":null,\"capture_id\":\"4KD465349Y3176234\",\"incremental_authorization_id\":null,\"psync_flow\":\"CAPTURE\",\"next_action\":null,\"order_id\":null}"
  },
  "merchantChargeId": "mchi_f582c0ed82354063b2be4b4d4be93e03",
  "mandateReference": {
    "connectorMandateId": {}
  },
  "state": {
