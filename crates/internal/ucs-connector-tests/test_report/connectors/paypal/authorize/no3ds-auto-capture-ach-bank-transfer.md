# Connector `paypal` / Suite `authorize` / Scenario `no3ds_auto_capture_ach_bank_transfer`
...
{
  "merchant_transaction_id": "mti_0acb0f655c194d50850c368372d85814",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Smith",
    "email": {
      "value": "morgan.6248@testmail.io"
    },
    "id": "cust_47dded944ff6477c8aaff4f022877fb1",
    "phone_number": "+16243104160"
  },
  "state": {
    "access_token": ***MASKED***
      "token": ***MASKED***
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "2637 Market Rd"
      },
      "line2": {
        "value": "7538 Pine Ln"
      },
      "line3": {
        "value": "2929 Market Rd"
      },
      "city": {
        "value": "Seattle"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "alex.4181@sandbox.example.com"
      },
      "phone_number": {
        "value": "7150342588"
      },
