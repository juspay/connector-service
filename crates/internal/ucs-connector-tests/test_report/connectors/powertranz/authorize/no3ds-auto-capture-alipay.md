# Connector `powertranz` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_3dd2126674b44992a6487e8d",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Wilson",
    "email": {
      "value": "morgan.6794@testmail.io"
    },
    "id": "cust_ce2121f4ae4b48059b396c10",
    "phone_number": "+448117124538"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "jordan.5082@sandbox.example.com"
      },
      "phone_number": {
        "value": "6259553898"
      },
    ...
    "billing_address": {
      ...
      "line2": {
        "value": "6111 Pine Blvd"
      },
      "line3": {
        "value": "8139 Main Blvd"
      },
      "city": {
        "value": "San Francisco"
      },
