# Connector `globalpay` / Suite `authorize` / Scenario `no3ds_auto_capture_debit_card`
...
{
  "merchant_transaction_id": "mti_567b6d69012849788498ee08",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Smith",
    "email": {
      "value": "casey.5652@example.com"
    },
    "id": "cust_d817fc89dc96492d8e0fe47c",
    "phone_number": "+15133237766"
  },
  "browser_info": {
...
Response headers received:
content-type: application/grpc
date: Mon, 23 Mar 2026 18:51:40 GMT
x-request-id: authorize_no3ds_auto_capture_debit_card_req
