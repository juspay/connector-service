# Connector `redsys` / Suite `void` / Scenario `void_with_amount`
...
date: Tue, 24 Mar 2026 07:10:17 GMT
x-request-id: void_void_with_amount_req
...
{
  "merchant_transaction_id": "mti_c80dd413196f4cd68ccc6e09",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "morgan.5076@testmail.io"
    },
    "id": "cust_12767fd45a834be78f04a114",
    "phone_number": "+441221925581"
  },
  "browser_info": {
  ...
  "address": {
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "jordan.8227@sandbox.example.com"
      },
      "phone_number": {
        "value": "8972824978"
      },
  ...
  -d @ localhost:50051 types.PaymentService/Void <<'JSON'
{
  ...
  "merchant_void_id": "mvi_2214f67ff2474922b1eef403",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  "merchant_order_id": "gen_595671",
  "browser_info": {
    "ip_address": "127.0.0.1",
    "accept_header": "application/json",
    "user_agent": "Mozilla/5.0 (ucs-connector-tests)",
