# Connector `redsys` / Suite `refund_sync` / Scenario `refund_sync_with_reason`
...
```text
assertion failed for field 'error': expected field to be absent or null, got {"connectorDetails":{"code":"xml0024","message":"xml0024","reason":"xml0024"}}
```
...
{
  "merchant_transaction_id": "mti_49b1a3b9ee484f1091ec1759",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Emma Johnson",
    "email": {
      "value": "sam.7332@testmail.io"
    },
    "id": "cust_a2bfe9dc39a14c8d906f8995",
    "phone_number": "+919708834045"
  },
  "browser_info": {
...
date: Tue, 24 Mar 2026 07:10:25 GMT
x-request-id: authorize_no3ds_auto_capture_credit_card_req
...
{
  "merchant_refund_id": "mri_38faf00900884403a3b13e55",
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:10:26 GMT
x-request-id: refund_sync_refund_sync_with_reason_req
