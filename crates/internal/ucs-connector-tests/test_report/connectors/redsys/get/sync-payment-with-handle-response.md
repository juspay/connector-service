# Connector `redsys` / Suite `get` / Scenario `sync_payment_with_handle_response`
...
{
  "merchant_transaction_id": "mti_6d8402f40b124b2088eaa420",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Mia Johnson",
    "email": {
      "value": "jordan.9011@sandbox.example.com"
    },
    "id": "cust_94ea91943f5347e09841acb7",
    "phone_number": "+447087436559"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "alex.8986@sandbox.example.com"
      },
      "phone_number": {
        "value": "3837425499"
      },
...
Response headers received:
content-type: application/grpc
date: Tue, 24 Mar 2026 07:10:23 GMT
x-request-id: get_sync_payment_with_handle_response_req
