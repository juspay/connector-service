# Connector `shift4` / Suite `pre_authenticate` / Scenario `threeds_card_pre_authenticate`
  ...
  -d @ localhost:50051 types.PaymentMethodAuthenticationService/PreAuthenticate <<'JSON'
{
  ...
  "customer": {
    "name": "Ethan Miller",
    "email": {
      "value": "casey.8967@testmail.io"
    },
    "id": "cust_78557d6077a1457bad22a7f5bbc15072",
    "phone_number": "+16899708656"
  },
  "address": {
    "shipping_address": {
      "first_name": {
      ...
      "line1": {
        "value": "2487 Market Ave"
      },
      "line2": {
        "value": "2819 Sunset Ln"
      },
      "line3": {
        "value": "9883 Lake Blvd"
      },
      "city": {
        "value": "New York"
      },
      ...
      "email": {
        "value": "morgan.3276@sandbox.example.com"
      },
      "phone_number": {
        "value": "4798828861"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "casey.1027@sandbox.example.com"
      },
      "phone_number": {
        "value": "6998969772"
      },
