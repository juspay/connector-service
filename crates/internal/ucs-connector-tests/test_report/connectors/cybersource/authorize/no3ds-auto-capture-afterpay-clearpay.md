# Connector `cybersource` / Suite `authorize` / Scenario `no3ds_auto_capture_afterpay_clearpay`
...
{
  "merchant_transaction_id": "mti_fd3b6e7a62334286a2242b68",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "sam.1695@example.com"
    },
    "id": "cust_b512c1a520fe41a086bbb922",
    "phone_number": "+13310033053"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "riley.1444@sandbox.example.com"
      },
      "phone_number": {
        "value": "8834521410"
      },
    ...
    "billing_address": {
      ...
      "line1": {
        "value": "8357 Market St"
      },
      "line2": {
        "value": "6658 Sunset Blvd"
      },
      "line3": {
        "value": "9819 Oak Blvd"
      },
