# Connector `cybersource` / Suite `authorize` / Scenario `no3ds_auto_capture_przelewy24`
...
{
  "merchant_transaction_id": "mti_5871ffeae32046579696efc7",
  "amount": {
    "minor_amount": 6000,
    "currency": "EUR"
  },
  ...
  "customer": {
    "name": "Emma Miller",
    "email": {
      "value": "casey.1159@example.com"
    },
    "id": "cust_94bdc957fa4b401fbc9db6b7",
    "phone_number": "+918241505527"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "email": {
        "value": "sam.2718@sandbox.example.com"
      },
      "phone_number": {
        "value": "3751769649"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "PL",
      "email": {
        "value": "sam.2494@sandbox.example.com"
      },
      "phone_number": {
        "value": "6480026042"
      },
