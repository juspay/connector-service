# Connector `cybersource` / Suite `authorize` / Scenario `no3ds_auto_capture_alipay`
...
{
  "merchant_transaction_id": "mti_c4bbeb1728db4ec1a0a35a54",
  "amount": {
    "minor_amount": 6000,
    "currency": "USD"
  },
  ...
  "customer": {
    "name": "Liam Johnson",
    "email": {
      "value": "casey.8483@testmail.io"
    },
    "id": "cust_ae5cceb6fd974a12a61f035f",
    "phone_number": "+448681858601"
  },
  "browser_info": {
  ...
  "address": {
    "shipping_address": {
      ...
      "line1": {
        "value": "1672 Sunset St"
      },
      "line2": {
        "value": "4360 Market Blvd"
      },
      "line3": {
        "value": "5661 Market Blvd"
      },
      "city": {
        "value": "Austin"
      },
    ...
    "billing_address": {
      ...
      "country_alpha2_code": "US",
      "email": {
        "value": "sam.2250@sandbox.example.com"
      },
      "phone_number": {
        "value": "6465533151"
      },
