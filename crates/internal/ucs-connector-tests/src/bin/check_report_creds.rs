...
//!
//! Usage:
//!   cargo run -p ucs-connector-tests --bin check_report_creds
//!   cargo run -p ucs-connector-tests --bin check_report_creds -- --path <report_dir>
//!
...
use ucs_connector_tests::harness::cred_masking::detect_unmasked_cred;
use ucs_connector_tests::harness::report::report_path;
...
fn main() {
    ...
    if violations.is_empty() {
        ...
        eprintln!("  cargo run -p ucs-connector-tests --bin mask_report_creds");
        std::process::exit(1);
    }
}
