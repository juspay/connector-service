...
impl ConnectorRequestReference for domain_types::payouts::payouts_types::CreditToWalletFlowData {
    fn get_connector_request_reference_id(&self) -> &str {
        &self.connector_request_reference_id
    }
}

impl AdditionalHeaders for domain_types::payouts::payouts_types::CreditToWalletFlowData {
    fn get_vault_headers(&self) -> Option<&HashMap<String, Secret<String>>> {
        None
    }
}
