    ...
    if ds_response.0.starts_with("00") && ds_response.0.as_str() != "0002" {
        match capture_method {
            ...
            _ => Err(report_request_as_response(
                ConnectorRequestError::CaptureMethodNotSupported.into(),
            )),
        }
    } else {
...
fn to_connector_response_data<T>(connector_response: &str) -> Result<T, ResponseError>
where
    ...
    T::Inner: Clone,
{
    ...
    fn try_from(
        ...
        let ds_merchant_order = if connector_request_reference_id.len() <= 12 {
            ...
            Err(ConnectorRequestError::MaxFieldLengthViolated {
    ...
    T::Inner: Clone,
{
    ...
    fn try_from(
            ...
            <= 12
        {
            ...
            Err(ConnectorRequestError::RequestEncodingFailed).attach_printable(
