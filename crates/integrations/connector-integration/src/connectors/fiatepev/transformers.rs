...
#[derive(Debug, Clone)]
pub struct FiatepevAuthType {
    pub api_key: Secret<String>,
}

impl TryFrom<&ConnectorSpecificConfig> for FiatepevAuthType {
    type Error = error_stack::Report<errors::IntegrationError>;

    fn try_from(auth_type: &ConnectorSpecificConfig) -> Result<Self, Self::Error> {
        match auth_type {
            ConnectorSpecificConfig::Fiatepev { api_key, .. } => Ok(Self {
...
pub struct FiatepevErrorResponse {
    pub code: String,
    pub message: String,
}

#[derive(Debug, Serialize)]
pub struct FiatepevPaymentsRequest {
    pub amount: i64,
    pub currency: String,
...
pub struct FiatepevPaymentsResponse {
    pub id: String,
    pub status: String,
    pub amount: i64,
    pub currency: String,
