...
// ============================================================
// CLIENT AUTHENTICATION TOKEN FLOW
// ============================================================

/// Card network values for the Wellsfargo Flex Microform allowedCardNetworks field.
#[derive(Debug, Serialize)]
...
/// Request payload for the Wellsfargo Flex Microform v2 session creation endpoint
/// POST /microform/v2/sessions. Returns a capture_context JWT for client-side
...
/// Wellsfargo Flex Microform v2 session response.
/// The /microform/v2/sessions endpoint returns a raw JWT string (Content-Type: application/jwt),
/// not JSON. Custom Deserialize handles both raw string and legacy JSON {keyId} shapes.
#[derive(Debug, Serialize)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for WellsfargoClientAuthVisitor {
            ...
            fn visit_map<A: serde::de::MapAccess<'de>>(
                ...
                Ok(WellsfargoClientAuthResponse { capture_context })
            }
        }
