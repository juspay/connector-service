...
#[derive(Debug, Clone)]
pub struct Abcdv2AuthType {
    pub api_key: Secret<String>,
}

impl TryFrom<&ConnectorSpecificConfig> for Abcdv2AuthType {
    type Error = error_stack::Report<errors::IntegrationError>;

    fn try_from(auth_type: &ConnectorSpecificConfig) -> Result<Self, Self::Error> {
        match auth_type {
            ConnectorSpecificConfig::Abcdv2 { api_key, .. } => Ok(Self {
...
pub struct Abcdv2ErrorResponse {
    pub code: String,
    pub message: String,
}

#[derive(Debug, Serialize)]
pub struct Abcdv2PaymentsRequest {
    pub amount: i64,
    pub currency: String,
...
pub struct Abcdv2PaymentsResponse {
    pub id: String,
    pub status: String,
    pub amount: i64,
    pub currency: String,
