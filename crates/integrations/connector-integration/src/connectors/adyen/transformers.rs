    ...
    )> for AdyenPaymentMethod<T>
{
    ...
    fn try_from(
        ...
        match wallet_data {
            ...
            | WalletData::Wero(_)
            | WalletData::RedirectWalletDebit(_) => Err(errors::ConnectorError::NotImplemented(
                "payment_method".into(),
            ))?,
        }
    }
...
) -> CustomResult<(Option<String>, Option<common_enums::CountryAlpha2>), errors::ConnectorError> {
