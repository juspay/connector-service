...
// Card Process Transaction Request
#[derive(Debug, Serialize)]
...
pub struct PaytmCardProcessBodyTypes {
    ...
    pub card_info: Secret<String>, // Format: "|cardNo|cvv|expDate(MMYYYY)"
    #[serde(rename = "authMode", skip_serializing_if = "Option::is_none")]
    pub auth_mode: Option<String>, // "otp" for OTP-based auth
    #[serde(rename = "paymentFlow", skip_serializing_if = "Option::is_none")]
    pub payment_flow: Option<String>, // "NONE" for standard flow
