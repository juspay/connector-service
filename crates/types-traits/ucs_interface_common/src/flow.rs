...
use domain_types::connector_flow::{
    Accept, Authenticate, Authorize, Capture, CreateOrder, CreateSessionToken, CreateSubscription,
    DefendDispute, IncrementalAuthorization, MandateRevoke, PSync, PaymentMethodToken,
    PostAuthenticate, PreAuthenticate, RSync, Refund, RepeatPayment, SdkSessionToken, SetupMandate,
    ...
    F: 'static,
{
    ...
    } else if type_id == std::any::TypeId::of::<CreateSubscription>() {
